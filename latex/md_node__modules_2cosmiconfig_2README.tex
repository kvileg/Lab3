\chapter{cosmiconfig}
\hypertarget{md_node__modules_2cosmiconfig_2README}{}\label{md_node__modules_2cosmiconfig_2README}\index{cosmiconfig@{cosmiconfig}}
\label{md_node__modules_2cosmiconfig_2README_autotoc_md8296}%
\Hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8296}%
...
Cosmiconfig continues to search up the directory tree, checking each of these places in each directory, until it finds some acceptable configuration (or hits the home directory).\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8297}{}\doxysection{\texorpdfstring{Table of contents}{Table of contents}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8297}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8298}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8298}
...
Tested in Node 10+.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8299}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8299}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8300}{}\doxysection{\texorpdfstring{Result}{Result}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8300}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8301}{}\doxysection{\texorpdfstring{Asynchronous API}{Asynchronous API}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8301}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8302}{}\doxysubsection{\texorpdfstring{cosmiconfig()}{cosmiconfig()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8302}
...
Creates a cosmiconfig instance ("{}explorer"{}) configured according to the arguments, and initializes its caches.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8303}{}\doxysubsubsection{\texorpdfstring{module\+Name}{moduleName}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8303}
...
\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\`{}cosmiconfig\+Options\`{} are documented below.\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*} You may not need them, and should first read about the functions you\textquotesingle{}ll use.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8304}{}\doxysubsection{\texorpdfstring{explorer.\+search()}{explorer.search()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8304}
...
{\bfseries{The search process is highly customizable.}} Use the cosmiconfig options \`{}search\+Places\`{} and \`{}loaders\`{} to precisely define where you want to look for configurations and how you want to load them.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8305}{}\doxysubsubsection{\texorpdfstring{search\+From}{searchFrom}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8305}
Type\+: {\ttfamily string}. Default\+: {\ttfamily process.\+cwd()}.

A filename. \`{}search()\`{} will start its search here.

If the value is a directory, that\textquotesingle{}s where the search starts. If it\textquotesingle{}s a file, the search starts in that file\textquotesingle{}s directory.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8306}{}\doxysubsection{\texorpdfstring{explorer.\+load()}{explorer.load()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8306}
...
You can do the same thing synchronously with \`{}explorer\+Sync.load()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8307}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Load\+Cache()}{explorer.clearLoadCache()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8307}
Clears the cache used in \`{}load()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8308}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Search\+Cache()}{explorer.clearSearchCache()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8308}
Clears the cache used in \`{}search()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8309}{}\doxysubsection{\texorpdfstring{explorer.\+clear\+Caches()}{explorer.clearCaches()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8309}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8310}{}\doxysection{\texorpdfstring{Synchronous API}{Synchronous API}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8310}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8311}{}\doxysubsection{\texorpdfstring{cosmiconfig\+Sync()}{cosmiconfigSync()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8311}
...
See \`{}cosmiconfig()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8312}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+search()}{explorerSync.search()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8312}
...
Returns a result or {\ttfamily null}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8313}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+load()}{explorerSync.load()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8313}
...
Returns a result.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8314}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Load\+Cache()}{explorerSync.clearLoadCache()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8314}
Clears the cache used in \`{}load()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8315}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Search\+Cache()}{explorerSync.clearSearchCache()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8315}
Clears the cache used in \`{}search()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8316}{}\doxysubsection{\texorpdfstring{explorer\+Sync.\+clear\+Caches()}{explorerSync.clearCaches()}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8316}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8317}{}\doxysection{\texorpdfstring{cosmiconfig\+Options}{cosmiconfigOptions}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8317}
Type\+: {\ttfamily Object}.

Possible options are documented below.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8318}{}\doxysubsection{\texorpdfstring{search\+Places}{searchPlaces}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8318}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8319}{}\doxysubsection{\texorpdfstring{loaders}{loaders}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8319}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8320}{}\doxysubsection{\texorpdfstring{package\+Prop}{packageProp}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8320}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8321}{}\doxysubsection{\texorpdfstring{stop\+Dir}{stopDir}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8321}
Type\+: {\ttfamily string}. Default\+: Absolute path to your home directory.

Directory where the search will stop.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8322}{}\doxysubsection{\texorpdfstring{cache}{cache}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8322}
Type\+: {\ttfamily boolean}. Default\+: {\ttfamily true}.

If {\ttfamily false}, no caches will be used. Read more about "{}Caching"{} below.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8323}{}\doxysubsection{\texorpdfstring{transform}{transform}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8323}
...
The reason you might use this option — instead of simply applying your transform function some other way — is that {\itshape the transformed result will be cached}. If your transformation involves additional filesystem I/O or other potentially slow processing, you can use this option to avoid repeating those steps every time a given configuration is searched or loaded.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8324}{}\doxysubsection{\texorpdfstring{ignore\+Empty\+Search\+Places}{ignoreEmptySearchPlaces}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8324}
Type\+: {\ttfamily boolean}. Default\+: {\ttfamily true}.
...
Why might you want to load empty configuration files? If you want to throw an error, or if an empty configuration file means something to your program.\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8325}{}\doxysection{\texorpdfstring{Caching}{Caching}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8325}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8326}{}\doxysection{\texorpdfstring{Differences from $<$a href="{}https\+://github.\+com/dominictarr/rc"{} $>$rc$<$/a$>$}{Differences from <a href="https://github.com/dominictarr/rc" >rc</a>}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8326}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2cosmiconfig_2README_autotoc_md8327}{}\doxysection{\texorpdfstring{Contributing \& Development}{Contributing \& Development}}\label{md_node__modules_2cosmiconfig_2README_autotoc_md8327}
