...
\hypertarget{md_node__modules_2ipaddr_8js_2README}{}\label{md_node__modules_2ipaddr_8js_2README}\index{ipaddr.js — an IPv6 and IPv4 address manipulation library@{ipaddr.js — an IPv6 and IPv4 address manipulation library}}
\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15504}%
\Hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15504}%
...
ipaddr.\+js allows you to verify and parse string representation of an IP address, match it against a CIDR range or range list, determine if it falls into some reserved ranges (examples include loopback and private ranges), and convert between IPv4 and IPv4-\/mapped IPv6 addresses.\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15505}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15505}
{\ttfamily npm install ipaddr.\+js}

or

{\ttfamily bower install ipaddr.\+js}\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15506}{}\doxysection{\texorpdfstring{Older Node support}{Older Node support}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15506}
Use 2.\+x release for nodejs versions 10+. Use the 1.\+x release for versions of nodejs older than 10.\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15507}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15507}
...
The API consists of several global methods and two classes\+: ipaddr.\+IPv6 and ipaddr.\+IPv4.\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15508}{}\doxysubsection{\texorpdfstring{Global methods}{Global methods}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15508}
There are four global methods defined\+: {\ttfamily ipaddr.\+is\+Valid}, {\ttfamily ipaddr.\+is\+Valid\+CIDR}, {\ttfamily ipaddr.\+parse}, and {\ttfamily ipaddr.\+process}. All of them receive a string as a single parameter.
...
The {\ttfamily ipaddr.\+is\+Valid\+CIDR} method returns {\ttfamily true} if the address is a valid IPv4 or IPv6 address in CIDR notation, and {\ttfamily false} otherwise. It does not throw any exceptions.
...
The {\ttfamily ipaddr.\+process} method works just like the {\ttfamily ipaddr.\+parse} one, but it automatically converts IPv4-\/mapped IPv6 addresses to their IPv4 counterparts before returning. It is useful when you have a Node.\+js instance listening on an IPv6 socket, and the {\ttfamily net.\+ivp6.\+bindv6only} sysctl parameter (or its equivalent on non-\/\+Linux OS) is set to 0. In this case, you can accept IPv4 connections on your IPv6-\/only socket, but the remote address will be mangled. Use {\ttfamily ipaddr.\+process} method to automatically demangle it.\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15509}{}\doxysubsection{\texorpdfstring{Object representation}{Object representation}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15509}
Parsing methods return an object which descends from {\ttfamily ipaddr.\+IPv6} or {\ttfamily ipaddr.\+IPv4}. These objects share some properties, but most of them differ.\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15510}{}\doxysubsubsection{\texorpdfstring{Shared properties}{Shared properties}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15510}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15512}{}\doxysubsubsection{\texorpdfstring{IPv4 properties}{IPv4 properties}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15512}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ipaddr_8js_2README_autotoc_md15513}{}\doxysubsubsection{\texorpdfstring{Conversion}{Conversion}}\label{md_node__modules_2ipaddr_8js_2README_autotoc_md15513}
