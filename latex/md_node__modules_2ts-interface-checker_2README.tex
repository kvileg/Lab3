...
\hypertarget{md_node__modules_2ts-interface-checker_2README}{}\label{md_node__modules_2ts-interface-checker_2README}\index{ts-\/interface-\/checker@{ts-\/interface-\/checker}}
\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28496}%
\Hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28496}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28498}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28498}
...
Note that {\ttfamily ts-\/interface-\/builder} is only needed for the build-\/time step, and {\ttfamily ts-\/interface-\/checker} is needed at runtime. That\textquotesingle{}s why the recommendation is to npm-\/install the former using {\ttfamily -\/-\/save-\/dev} flag and the latter using {\ttfamily -\/-\/save}.\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28499}{}\doxysection{\texorpdfstring{Checking method calls}{Checking method calls}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28499}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28500}{}\doxysection{\texorpdfstring{Type suites}{Type suites}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28500}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28501}{}\doxysection{\texorpdfstring{Strict checking}{Strict checking}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28501}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28502}{}\doxysection{\texorpdfstring{Type guards}{Type guards}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28502}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2ts-interface-checker_2README_autotoc_md28503}{}\doxysection{\texorpdfstring{Type assertions}{Type assertions}}\label{md_node__modules_2ts-interface-checker_2README_autotoc_md28503}
