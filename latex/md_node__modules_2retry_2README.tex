\chapter{README}
\hypertarget{md_node__modules_2retry_2README}{}\label{md_node__modules_2retry_2README}\index{README@{README}}
\href{http://travis-ci.org/tim-kos/node-retry}{\texttt{ }} \href{https://codecov.io/gh/tim-kos/node-retry}{\texttt{ }}\hypertarget{md_node__modules_2retry_2README_autotoc_md23449}{}\doxysection{\texorpdfstring{retry}{retry}}\label{md_node__modules_2retry_2README_autotoc_md23449}
Abstraction for exponential and custom retry strategies for failed operations.\hypertarget{md_node__modules_2retry_2README_autotoc_md23450}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2retry_2README_autotoc_md23450}
\begin{DoxyVerb}npm install retry
\end{DoxyVerb}
 \hypertarget{md_node__modules_2retry_2README_autotoc_md23451}{}\doxysubsection{\texorpdfstring{Current Status}{Current Status}}\label{md_node__modules_2retry_2README_autotoc_md23451}
This module has been tested and is ready to be used.\hypertarget{md_node__modules_2retry_2README_autotoc_md23452}{}\doxysubsection{\texorpdfstring{Tutorial}{Tutorial}}\label{md_node__modules_2retry_2README_autotoc_md23452}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2retry_2README_autotoc_md23453}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_node__modules_2retry_2README_autotoc_md23453}
\hypertarget{md_node__modules_2retry_2README_autotoc_md23454}{}\doxysubsubsection{\texorpdfstring{retry.\+operation(\mbox{[}options\mbox{]})}{retry.operation([options])}}\label{md_node__modules_2retry_2README_autotoc_md23454}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2retry_2README_autotoc_md23455}{}\doxysubsubsection{\texorpdfstring{retry.\+timeouts(\mbox{[}options\mbox{]})}{retry.timeouts([options])}}\label{md_node__modules_2retry_2README_autotoc_md23455}
...
\texorpdfstring{$<$}{<}\href{http://www.wolframalpha.com/input/?i=Sum\%5B1000}{\texttt{ http\+://www.\+wolframalpha.\+com/input/?i=\+Sum\%5\+B1000}}\texorpdfstring{$\ast$}{*}x\texorpdfstring{$^\wedge$}{\string^}k\%2C+\{k\%2C+0\%2C+9\}\%5D+\%3D+5+\texorpdfstring{$\ast$}{*}+60+\texorpdfstring{$\ast$}{*}+1000\texorpdfstring{$>$}{>}\hypertarget{md_node__modules_2retry_2README_autotoc_md23456}{}\doxysubsubsection{\texorpdfstring{retry.\+create\+Timeout(attempt, opts)}{retry.createTimeout(attempt, opts)}}\label{md_node__modules_2retry_2README_autotoc_md23456}
...
{\ttfamily retry.\+create\+Timeout()} is used internally by {\ttfamily retry.\+timeouts()} and is public for you to be able to create your own timeouts for reinserting an item, see \href{https://github.com/tim-kos/node-retry/issues/13}{\texttt{ issue \#13}}.\hypertarget{md_node__modules_2retry_2README_autotoc_md23457}{}\doxysubsubsection{\texorpdfstring{retry.\+wrap(obj, \mbox{[}options\mbox{]}, \mbox{[}method\+Names\mbox{]})}{retry.wrap(obj, [options], [methodNames])}}\label{md_node__modules_2retry_2README_autotoc_md23457}
...
\end{DoxyCode}
 The {\ttfamily options} object can take any options that the usual call to {\ttfamily retry.\+operation} can take.\hypertarget{md_node__modules_2retry_2README_autotoc_md23458}{}\doxysubsubsection{\texorpdfstring{new Retry\+Operation(timeouts, \mbox{[}options\mbox{]})}{new RetryOperation(timeouts, [options])}}\label{md_node__modules_2retry_2README_autotoc_md23458}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2retry_2README_autotoc_md23459}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+errors()}{retryOperation.errors()}}\label{md_node__modules_2retry_2README_autotoc_md23459}
Returns an array of all errors that have been passed to {\ttfamily retry\+Operation.\+retry()} so far. The returning array has the errors ordered chronologically based on when they were passed to {\ttfamily retry\+Operation.\+retry()}, which means the first passed error is at index zero and the last is at the last index.\hypertarget{md_node__modules_2retry_2README_autotoc_md23460}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+main\+Error()}{retryOperation.mainError()}}\label{md_node__modules_2retry_2README_autotoc_md23460}
...
If no errors occured so far, the value is {\ttfamily null}.\hypertarget{md_node__modules_2retry_2README_autotoc_md23461}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+attempt(fn, timeout\+Ops)}{retryOperation.attempt(fn, timeoutOps)}}\label{md_node__modules_2retry_2README_autotoc_md23461}
...
Optionally defines {\ttfamily timeout\+Ops} which is an object having a property {\ttfamily timeout} in miliseconds and a property {\ttfamily cb} callback function. Whenever your retry operation takes longer than {\ttfamily timeout} to execute, the timeout callback function {\ttfamily cb} is called.\hypertarget{md_node__modules_2retry_2README_autotoc_md23462}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+try(fn)}{retryOperation.try(fn)}}\label{md_node__modules_2retry_2README_autotoc_md23462}
This is an alias for {\ttfamily retry\+Operation.\+attempt(fn)}. This is deprecated. Please use {\ttfamily retry\+Operation.\+attempt(fn)} instead.\hypertarget{md_node__modules_2retry_2README_autotoc_md23463}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+start(fn)}{retryOperation.start(fn)}}\label{md_node__modules_2retry_2README_autotoc_md23463}
This is an alias for {\ttfamily retry\+Operation.\+attempt(fn)}. This is deprecated. Please use {\ttfamily retry\+Operation.\+attempt(fn)} instead.\hypertarget{md_node__modules_2retry_2README_autotoc_md23464}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+retry(error)}{retryOperation.retry(error)}}\label{md_node__modules_2retry_2README_autotoc_md23464}
Returns {\ttfamily false} when no {\ttfamily error} value is given, or the maximum amount of retries has been reached.

Otherwise it returns {\ttfamily true}, and retries the operation after the timeout for the current attempt number.\hypertarget{md_node__modules_2retry_2README_autotoc_md23465}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+stop()}{retryOperation.stop()}}\label{md_node__modules_2retry_2README_autotoc_md23465}
Allows you to stop the operation being retried. Useful for aborting the operation on a fatal error etc.\hypertarget{md_node__modules_2retry_2README_autotoc_md23466}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+reset()}{retryOperation.reset()}}\label{md_node__modules_2retry_2README_autotoc_md23466}
Resets the internal state of the operation object, so that you can call {\ttfamily attempt()} again as if this was a new operation object.\hypertarget{md_node__modules_2retry_2README_autotoc_md23467}{}\doxyparagraph{\texorpdfstring{retry\+Operation.\+attempts()}{retryOperation.attempts()}}\label{md_node__modules_2retry_2README_autotoc_md23467}
Returns an int representing the number of attempts it took to call {\ttfamily fn} before it was successful.\hypertarget{md_node__modules_2retry_2README_autotoc_md23468}{}\doxysubsection{\texorpdfstring{License}{License}}\label{md_node__modules_2retry_2README_autotoc_md23468}
retry is licensed under the MIT license.\hypertarget{md_node__modules_2retry_2README_autotoc_md23469}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2retry_2README_autotoc_md23469}
