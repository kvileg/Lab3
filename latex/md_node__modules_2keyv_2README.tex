\chapter{README}
\hypertarget{md_node__modules_2keyv_2README}{}\label{md_node__modules_2keyv_2README}\index{README@{README}}
\doxysection*{ ~\newline
 ~\newline
 }
...
Keyv provides a consistent interface for key-\/value storage across multiple backends via storage adapters. It supports TTL based expiry, making it suitable as a cache or a persistent key-\/value store.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18537}{}\doxysubsection{\texorpdfstring{Features}{Features}}\label{md_node__modules_2keyv_2README_autotoc_md18537}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2keyv_2README_autotoc_md18538}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2keyv_2README_autotoc_md18538}
Install Keyv.
...
\end{DoxyCode}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18539}{}\doxysubsubsection{\texorpdfstring{Namespaces}{Namespaces}}\label{md_node__modules_2keyv_2README_autotoc_md18539}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18540}{}\doxysubsubsection{\texorpdfstring{Custom Serializers}{Custom Serializers}}\label{md_node__modules_2keyv_2README_autotoc_md18540}
...
\end{longtabu}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18542}{}\doxysubsection{\texorpdfstring{Third-\/party Storage Adapters}{Third-party Storage Adapters}}\label{md_node__modules_2keyv_2README_autotoc_md18542}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2keyv_2README_autotoc_md18543}{}\doxysubsection{\texorpdfstring{Add Cache Support to your Module}{Add Cache Support to your Module}}\label{md_node__modules_2keyv_2README_autotoc_md18543}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18544}{}\doxysubsection{\texorpdfstring{Compression}{Compression}}\label{md_node__modules_2keyv_2README_autotoc_md18544}
...
You can also pass a custom compression function to the {\ttfamily compression} option. Following the pattern of the official compression adapters.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18545}{}\doxysubsubsection{\texorpdfstring{Want to build your own?}{Want to build your own?}}\label{md_node__modules_2keyv_2README_autotoc_md18545}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18546}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_node__modules_2keyv_2README_autotoc_md18546}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18547}{}\doxysubsubsection{\texorpdfstring{new Keyv(\mbox{[}uri\mbox{]}, \mbox{[}options\mbox{]})}{new Keyv([uri], [options])}}\label{md_node__modules_2keyv_2README_autotoc_md18547}
Returns a new Keyv instance.

The Keyv instance is also an {\ttfamily Event\+Emitter} that will emit an `\textquotesingle{}error'\`{} event if the storage adapter connection fails.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18548}{}\doxysubsubsection{\texorpdfstring{uri}{uri}}\label{md_node__modules_2keyv_2README_autotoc_md18548}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

The connection string URI.

Merged into the options object as options.\+uri.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18549}{}\doxysubsubsection{\texorpdfstring{options}{options}}\label{md_node__modules_2keyv_2README_autotoc_md18549}
Type\+: {\ttfamily Object}

The options object is also passed through to the storage adapter. Check your storage adapter docs for any extra options.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18550}{}\doxyparagraph{\texorpdfstring{options.\+namespace}{options.namespace}}\label{md_node__modules_2keyv_2README_autotoc_md18550}
Type\+: {\ttfamily String}~\newline
 Default\+: `\textquotesingle{}keyv'\`{}

Namespace for the current instance.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18551}{}\doxyparagraph{\texorpdfstring{options.\+ttl}{options.ttl}}\label{md_node__modules_2keyv_2README_autotoc_md18551}
Type\+: {\ttfamily Number}~\newline
 Default\+: {\ttfamily undefined}

Default TTL. Can be overridden by specififying a TTL on {\ttfamily .set()}.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18552}{}\doxyparagraph{\texorpdfstring{options.\+compression}{options.compression}}\label{md_node__modules_2keyv_2README_autotoc_md18552}
Type\+: {\ttfamily @keyv/compress-\/\texorpdfstring{$<$}{<}compression\+\_\+package\+\_\+name\texorpdfstring{$>$}{>}}~\newline
 Default\+: {\ttfamily undefined}

Compression package to use. See Compression for more details.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18553}{}\doxyparagraph{\texorpdfstring{options.\+serialize}{options.serialize}}\label{md_node__modules_2keyv_2README_autotoc_md18553}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily JSONB.\+stringify}

A custom serialization function.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18554}{}\doxyparagraph{\texorpdfstring{options.\+deserialize}{options.deserialize}}\label{md_node__modules_2keyv_2README_autotoc_md18554}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily JSONB.\+parse}

A custom deserialization function.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18555}{}\doxyparagraph{\texorpdfstring{options.\+store}{options.store}}\label{md_node__modules_2keyv_2README_autotoc_md18555}
Type\+: {\ttfamily Storage adapter instance}~\newline
 Default\+: {\ttfamily new Map()}

The storage adapter instance to be used by Keyv.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18556}{}\doxyparagraph{\texorpdfstring{options.\+adapter}{options.adapter}}\label{md_node__modules_2keyv_2README_autotoc_md18556}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

Specify an adapter to use. e.\+g `\textquotesingle{}redis'{\ttfamily or}\textquotesingle{}mongodb\textquotesingle{}\`{}.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18557}{}\doxysubsubsection{\texorpdfstring{Instance}{Instance}}\label{md_node__modules_2keyv_2README_autotoc_md18557}
Keys must always be strings. Values can be of any type.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18558}{}\doxyparagraph{\texorpdfstring{.\+set(key, value, \mbox{[}ttl\mbox{]})}{.set(key, value, [ttl])}}\label{md_node__modules_2keyv_2README_autotoc_md18558}
Set a value.

By default keys are persistent. You can set an expiry TTL in milliseconds.

Returns a promise which resolves to {\ttfamily true}.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18559}{}\doxyparagraph{\texorpdfstring{.\+get(key, \mbox{[}options\mbox{]})}{.get(key, [options])}}\label{md_node__modules_2keyv_2README_autotoc_md18559}
Returns a promise which resolves to the retrieved value.

\label{md_node__modules_2keyv_2README_autotoc_md18560}%
\Hypertarget{md_node__modules_2keyv_2README_autotoc_md18560}%
...
This contains the TTL timestamp.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18561}{}\doxyparagraph{\texorpdfstring{.\+delete(key)}{.delete(key)}}\label{md_node__modules_2keyv_2README_autotoc_md18561}
Deletes an entry.

Returns a promise which resolves to {\ttfamily true} if the key existed, {\ttfamily false} if not.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18562}{}\doxyparagraph{\texorpdfstring{.\+clear()}{.clear()}}\label{md_node__modules_2keyv_2README_autotoc_md18562}
Delete all entries in the current namespace.

Returns a promise which is resolved when the entries have been cleared.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18563}{}\doxyparagraph{\texorpdfstring{.\+iterator()}{.iterator()}}\label{md_node__modules_2keyv_2README_autotoc_md18563}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2keyv_2README_autotoc_md18564}{}\doxysection{\texorpdfstring{How to Contribute}{How to Contribute}}\label{md_node__modules_2keyv_2README_autotoc_md18564}
In this section of the documentation we will cover\+:

1) How to set up this repository locally 2) How to get started with running commands 3) How to contribute changes using Pull Requests\hypertarget{md_node__modules_2keyv_2README_autotoc_md18565}{}\doxysubsection{\texorpdfstring{Dependencies}{Dependencies}}\label{md_node__modules_2keyv_2README_autotoc_md18565}
This package requires the following dependencies to run\+:

1) \href{https://yarnpkg.com/getting-started/install}{\texttt{ Yarn V1}} 3) \href{https://docs.docker.com/get-docker/}{\texttt{ Docker}}\hypertarget{md_node__modules_2keyv_2README_autotoc_md18566}{}\doxysubsection{\texorpdfstring{Setting up your workspace}{Setting up your workspace}}\label{md_node__modules_2keyv_2README_autotoc_md18566}
To contribute to this repository, start by setting up this project locally\+:

1) Fork this repository into your Git account 2) Clone the forked repository to your local directory using {\ttfamily git clone} 3) Install any of the above missing dependencies\hypertarget{md_node__modules_2keyv_2README_autotoc_md18567}{}\doxysubsection{\texorpdfstring{Launching the project}{Launching the project}}\label{md_node__modules_2keyv_2README_autotoc_md18567}
Once the project is installed locally, you are ready to start up its services\+:

1) Ensure that your Docker service is running. 2) From the root directory of your project, run the {\ttfamily yarn} command in the command prompt to install yarn. 3) Run the {\ttfamily yarn bootstrap} command to install any necessary dependencies. 4) Run {\ttfamily yarn test\+:services\+:start} to start up this project\textquotesingle{}s Docker container. The container will launch all services within your workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18568}{}\doxysubsection{\texorpdfstring{Available Commands}{Available Commands}}\label{md_node__modules_2keyv_2README_autotoc_md18568}
...
Here, we\textquotesingle{}ll cover the primary commands that can be executed from the root directory. Unless otherwise noted, these commands can also be executed from a subpackage. If executed from a subpackage, they will only affect that subpackage, rather than the entire workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18569}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn$<$/tt$>$}{<tt>yarn</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18569}
The {\ttfamily yarn} command installs yarn in the workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18570}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn bootstrap$<$/tt$>$}{<tt>yarn bootstrap</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18570}
The {\ttfamily yarn bootstrap} command installs all dependencies in the workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18571}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn test\+:services\+:start$<$/tt$>$}{<tt>yarn test:services:start</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18571}
The {\ttfamily yarn test\+:services\+:start} command starts up the project\textquotesingle{}s Docker container, launching all services in the workspace. This command must be executed from the root directory.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18572}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn test\+:services\+:stop$<$/tt$>$}{<tt>yarn test:services:stop</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18572}
The {\ttfamily yarn test\+:services\+:stop} command brings down the project\textquotesingle{}s Docker container, halting all services. This command must be executed from the root directory.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18573}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn test$<$/tt$>$}{<tt>yarn test</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18573}
The {\ttfamily yarn test} command runs all tests in the workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18574}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$yarn clean$<$/tt$>$}{<tt>yarn clean</tt>}}\label{md_node__modules_2keyv_2README_autotoc_md18574}
The {\ttfamily yarn clean} command removes yarn and all dependencies installed by yarn. After executing this command, you must repeat the steps in {\itshape Setting up your workspace} to rebuild your workspace.\hypertarget{md_node__modules_2keyv_2README_autotoc_md18575}{}\doxysubsection{\texorpdfstring{Contributing Changes}{Contributing Changes}}\label{md_node__modules_2keyv_2README_autotoc_md18575}
...
If you need more information on the steps to create a pull request, you can find a detailed walkthrough in the \href{https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork}{\texttt{ Github documentation}}\hypertarget{md_node__modules_2keyv_2README_autotoc_md18576}{}\doxysubsection{\texorpdfstring{License}{License}}\label{md_node__modules_2keyv_2README_autotoc_md18576}
MIT © Jared Wray 