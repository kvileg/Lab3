\chapter{Forge}
\hypertarget{md_node__modules_2node-forge_2README}{}\label{md_node__modules_2node-forge_2README}\index{Forge@{Forge}}
\label{md_node__modules_2node-forge_2README_autotoc_md19598}%
\Hypertarget{md_node__modules_2node-forge_2README_autotoc_md19598}%
...
A native implementation of \href{https://en.wikipedia.org/wiki/Transport_Layer_Security}{\texttt{ TLS}} (and various other cryptographic tools) in \href{https://en.wikipedia.org/wiki/JavaScript}{\texttt{ Java\+Script}}.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19599}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{md_node__modules_2node-forge_2README_autotoc_md19599}
The Forge software is a fully native implementation of the \href{https://en.wikipedia.org/wiki/Transport_Layer_Security}{\texttt{ TLS}} protocol in Java\+Script, a set of cryptography utilities, and a set of tools for developing Web Apps that utilize many network resources.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19600}{}\doxysection{\texorpdfstring{Performance}{Performance}}\label{md_node__modules_2node-forge_2README_autotoc_md19600}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19601}{}\doxysection{\texorpdfstring{Documentation}{Documentation}}\label{md_node__modules_2node-forge_2README_autotoc_md19601}
...
\item Testing
\item Contributing
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19602}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_node__modules_2node-forge_2README_autotoc_md19602}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_options}{Options}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19603}{}\doxysubsection{\texorpdfstring{Transports}{Transports}}\label{md_node__modules_2node-forge_2README_autotoc_md19603}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_tls}{TLS}
\item \doxylink{md_node__modules_2node-forge_2README_http}{HTTP}
\item \doxylink{md_node__modules_2node-forge_2README_ssh}{SSH}
\item \doxylink{md_node__modules_2node-forge_2README_xhr}{XHR}
\item \doxylink{md_node__modules_2node-forge_2README_socket}{Sockets}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19604}{}\doxysubsection{\texorpdfstring{Ciphers}{Ciphers}}\label{md_node__modules_2node-forge_2README_autotoc_md19604}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_cipher}{CIPHER}
\item \doxylink{md_node__modules_2node-forge_2README_aes}{AES}
\item \doxylink{md_node__modules_2node-forge_2README_des}{DES}
\item \doxylink{md_node__modules_2node-forge_2README_rc2}{RC2}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19605}{}\doxysubsection{\texorpdfstring{PKI}{PKI}}\label{md_node__modules_2node-forge_2README_autotoc_md19605}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_ed25519}{ED25519}
\item \doxylink{md_node__modules_2node-forge_2README_rsa}{RSA}
\item \doxylink{md_node__modules_2node-forge_2README_rsakem}{RSA-\/\+KEM}
\item \doxylink{md_node__modules_2node-forge_2README_x509}{X.509}
\item \doxylink{md_node__modules_2node-forge_2README_pkcs5}{PKCS\#5}
\item \doxylink{md_node__modules_2node-forge_2README_pkcs7}{PKCS\#7}
\item \doxylink{md_node__modules_2node-forge_2README_pkcs8}{PKCS\#8}
\item \doxylink{md_node__modules_2node-forge_2README_pkcs10}{PKCS\#10}
\item \doxylink{md_node__modules_2node-forge_2README_pkcs12}{PKCS\#12}
\item \doxylink{md_node__modules_2node-forge_2README_asn}{ASN.1}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19606}{}\doxysubsection{\texorpdfstring{Message Digests}{Message Digests}}\label{md_node__modules_2node-forge_2README_autotoc_md19606}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_sha1}{SHA1}
\item \doxylink{md_node__modules_2node-forge_2README_sha256}{SHA256}
\item \doxylink{md_node__modules_2node-forge_2README_sha384}{SHA384}
\item \doxylink{md_node__modules_2node-forge_2README_sha512}{SHA512}
\item \doxylink{md_node__modules_2node-forge_2README_md5}{MD5}
\item \doxylink{md_node__modules_2node-forge_2README_hmac}{HMAC}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19607}{}\doxysubsection{\texorpdfstring{Utilities}{Utilities}}\label{md_node__modules_2node-forge_2README_autotoc_md19607}

\begin{DoxyItemize}
\item \doxylink{md_node__modules_2node-forge_2README_prime}{Prime}
\item \doxylink{md_node__modules_2node-forge_2README_prng}{PRNG}
\item \doxylink{md_node__modules_2node-forge_2README_task}{Tasks}
\item \doxylink{md_node__modules_2node-forge_2README_util}{Utilities}
\item \doxylink{md_node__modules_2node-forge_2README_log}{Logging}
\item \doxylink{md_node__modules_2node-forge_2README_flash}{Flash Networking Support}
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19608}{}\doxysubsection{\texorpdfstring{Other}{Other}}\label{md_node__modules_2node-forge_2README_autotoc_md19608}
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19610}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2node-forge_2README_autotoc_md19610}
{\bfseries{Note}}\+: Please see the Security Considerations section before using packaging systems and pre-\/built files.

Forge uses a \href{https://en.wikipedia.org/wiki/CommonJS}{\texttt{ Common\+JS}} module structure with a build process for browser bundles. The older \href{https://github.com/digitalbazaar/forge/tree/0.6.x}{\texttt{ 0.\+6.\+x}} branch with standalone files is available but will not be regularly updated.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19611}{}\doxysubsection{\texorpdfstring{Node.\+js}{Node.js}}\label{md_node__modules_2node-forge_2README_autotoc_md19611}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19613}{}\doxysubsection{\texorpdfstring{unpkg CDN}{unpkg CDN}}\label{md_node__modules_2node-forge_2README_autotoc_md19613}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19614}{}\doxysubsection{\texorpdfstring{Development Requirements}{Development Requirements}}\label{md_node__modules_2node-forge_2README_autotoc_md19614}
...
Some special networking features can optionally use a Flash component. See the \doxysectlink{md_node__modules_2node-forge_2flash_2README}{Flash README}{0} for details.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19615}{}\doxysubsection{\texorpdfstring{Building for a web browser}{Building for a web browser}}\label{md_node__modules_2node-forge_2README_autotoc_md19615}
...
{\bfseries{Note}}\+: These bundles will not include any Web\+Worker scripts (eg\+: {\ttfamily dist/prime.\+worker.\+js}), so these will need to be accessible from the browser if any Web\+Workers are used.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19616}{}\doxysubsection{\texorpdfstring{Building a custom browser bundle}{Building a custom browser bundle}}\label{md_node__modules_2node-forge_2README_autotoc_md19616}
...
\href{http://browserify.org/}{\texttt{ Browserify}} override support is also present in {\ttfamily package.\+json}.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19617}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2node-forge_2README_autotoc_md19617}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19618}{}\doxysubsection{\texorpdfstring{Prepare to run tests}{Prepare to run tests}}\label{md_node__modules_2node-forge_2README_autotoc_md19618}
\begin{DoxyVerb}npm install
\end{DoxyVerb}
 \hypertarget{md_node__modules_2node-forge_2README_autotoc_md19619}{}\doxysubsection{\texorpdfstring{Running automated tests with Node.\+js}{Running automated tests with Node.js}}\label{md_node__modules_2node-forge_2README_autotoc_md19619}
Forge natively runs in a \href{https://nodejs.org/}{\texttt{ Node.\+js}} environment\+: \begin{DoxyVerb}npm test
\end{DoxyVerb}
 \hypertarget{md_node__modules_2node-forge_2README_autotoc_md19620}{}\doxysubsection{\texorpdfstring{Running automated tests with Headless Chrome}{Running automated tests with Headless Chrome}}\label{md_node__modules_2node-forge_2README_autotoc_md19620}
...
\end{DoxyVerb}
 \hypertarget{md_node__modules_2node-forge_2README_autotoc_md19621}{}\doxysubsection{\texorpdfstring{Running automated tests with one or more browsers}{Running automated tests with one or more browsers}}\label{md_node__modules_2node-forge_2README_autotoc_md19621}
...
\end{DoxyVerb}
 The reporter option and {\ttfamily BUNDLER} environment variable can also be used.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19622}{}\doxysubsection{\texorpdfstring{Running manual tests in a browser}{Running manual tests in a browser}}\label{md_node__modules_2node-forge_2README_autotoc_md19622}
...
\end{DoxyVerb}
 \hypertarget{md_node__modules_2node-forge_2README_autotoc_md19623}{}\doxysubsection{\texorpdfstring{Running other tests}{Running other tests}}\label{md_node__modules_2node-forge_2README_autotoc_md19623}
There are some other random tests and benchmarks available in the tests directory.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19624}{}\doxysubsection{\texorpdfstring{Coverage testing}{Coverage testing}}\label{md_node__modules_2node-forge_2README_autotoc_md19624}
...
npm run coverage
\end{DoxyVerb}
 \hypertarget{md_node__modules_2node-forge_2README_autotoc_md19625}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{md_node__modules_2node-forge_2README_autotoc_md19625}
...
If a contribution contains 3rd party source code with its own license, it may retain it, so long as that license is compatible with the Forge license.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19626}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2node-forge_2README_autotoc_md19626}
\label{md_node__modules_2node-forge_2README_options}%
\Hypertarget{md_node__modules_2node-forge_2README_options}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19627}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2node-forge_2README_autotoc_md19627}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19628}{}\doxysection{\texorpdfstring{Transports}{Transports}}\label{md_node__modules_2node-forge_2README_autotoc_md19628}
\label{md_node__modules_2node-forge_2README_tls}%
\Hypertarget{md_node__modules_2node-forge_2README_tls}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19629}{}\doxysubsection{\texorpdfstring{TLS}{TLS}}\label{md_node__modules_2node-forge_2README_autotoc_md19629}
...
\label{md_node__modules_2node-forge_2README_http}%
\Hypertarget{md_node__modules_2node-forge_2README_http}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19630}{}\doxysubsection{\texorpdfstring{HTTP}{HTTP}}\label{md_node__modules_2node-forge_2README_autotoc_md19630}
...
\label{md_node__modules_2node-forge_2README_ssh}%
\Hypertarget{md_node__modules_2node-forge_2README_ssh}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19631}{}\doxysubsection{\texorpdfstring{SSH}{SSH}}\label{md_node__modules_2node-forge_2README_autotoc_md19631}
...
\label{md_node__modules_2node-forge_2README_xhr}%
\Hypertarget{md_node__modules_2node-forge_2README_xhr}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19632}{}\doxysubsection{\texorpdfstring{XHR}{XHR}}\label{md_node__modules_2node-forge_2README_autotoc_md19632}
...
\label{md_node__modules_2node-forge_2README_socket}%
\Hypertarget{md_node__modules_2node-forge_2README_socket}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19633}{}\doxysubsection{\texorpdfstring{Sockets}{Sockets}}\label{md_node__modules_2node-forge_2README_autotoc_md19633}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19634}{}\doxysection{\texorpdfstring{Ciphers}{Ciphers}}\label{md_node__modules_2node-forge_2README_autotoc_md19634}
\label{md_node__modules_2node-forge_2README_cipher}%
\Hypertarget{md_node__modules_2node-forge_2README_cipher}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19635}{}\doxysubsection{\texorpdfstring{CIPHER}{CIPHER}}\label{md_node__modules_2node-forge_2README_autotoc_md19635}
...
\label{md_node__modules_2node-forge_2README_aes}%
\Hypertarget{md_node__modules_2node-forge_2README_aes}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19636}{}\doxysubsection{\texorpdfstring{AES}{AES}}\label{md_node__modules_2node-forge_2README_autotoc_md19636}
Provides \href{https://en.wikipedia.org/wiki/Advanced_Encryption_Standard}{\texttt{ AES}} encryption and decryption in \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ CBC}}, \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ CFB}}, \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ OFB}}, \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ CTR}}, and \href{https://en.wikipedia.org/wiki/GCM_mode}{\texttt{ GCM}} modes. See \doxylink{md_node__modules_2node-forge_2README_cipher}{CIPHER} for examples.

\label{md_node__modules_2node-forge_2README_des}%
\Hypertarget{md_node__modules_2node-forge_2README_des}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19637}{}\doxysubsection{\texorpdfstring{DES}{DES}}\label{md_node__modules_2node-forge_2README_autotoc_md19637}
Provides \href{https://en.wikipedia.org/wiki/Triple_DES}{\texttt{ 3DES}} and \href{https://en.wikipedia.org/wiki/Data_Encryption_Standard}{\texttt{ DES}} encryption and decryption in \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ ECB}} and \href{https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation}{\texttt{ CBC}} modes. See \doxylink{md_node__modules_2node-forge_2README_cipher}{CIPHER} for examples.

\label{md_node__modules_2node-forge_2README_rc2}%
\Hypertarget{md_node__modules_2node-forge_2README_rc2}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19638}{}\doxysubsection{\texorpdfstring{RC2}{RC2}}\label{md_node__modules_2node-forge_2README_autotoc_md19638}
{\bfseries{Examples}}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19639}{}\doxysection{\texorpdfstring{PKI}{PKI}}\label{md_node__modules_2node-forge_2README_autotoc_md19639}
...
\label{md_node__modules_2node-forge_2README_ed25519}%
\Hypertarget{md_node__modules_2node-forge_2README_ed25519}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19640}{}\doxysubsection{\texorpdfstring{ED25519}{ED25519}}\label{md_node__modules_2node-forge_2README_autotoc_md19640}
...
\label{md_node__modules_2node-forge_2README_rsa}%
\Hypertarget{md_node__modules_2node-forge_2README_rsa}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19641}{}\doxysubsection{\texorpdfstring{RSA}{RSA}}\label{md_node__modules_2node-forge_2README_autotoc_md19641}
{\bfseries{Examples}}
...
\label{md_node__modules_2node-forge_2README_rsakem}%
\Hypertarget{md_node__modules_2node-forge_2README_rsakem}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19642}{}\doxysubsection{\texorpdfstring{RSA-\/\+KEM}{RSA-KEM}}\label{md_node__modules_2node-forge_2README_autotoc_md19642}
{\bfseries{Examples}}
...
\label{md_node__modules_2node-forge_2README_x509}%
\Hypertarget{md_node__modules_2node-forge_2README_x509}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19643}{}\doxysubsection{\texorpdfstring{X.\+509}{X.509}}\label{md_node__modules_2node-forge_2README_autotoc_md19643}
{\bfseries{Examples}}
...
\label{md_node__modules_2node-forge_2README_pkcs5}%
\Hypertarget{md_node__modules_2node-forge_2README_pkcs5}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19644}{}\doxysubsection{\texorpdfstring{PKCS\#5}{PKCS\#5}}\label{md_node__modules_2node-forge_2README_autotoc_md19644}
...
\label{md_node__modules_2node-forge_2README_pkcs7}%
\Hypertarget{md_node__modules_2node-forge_2README_pkcs7}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19645}{}\doxysubsection{\texorpdfstring{PKCS\#7}{PKCS\#7}}\label{md_node__modules_2node-forge_2README_autotoc_md19645}
...
\label{md_node__modules_2node-forge_2README_pkcs8}%
\Hypertarget{md_node__modules_2node-forge_2README_pkcs8}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19646}{}\doxysubsection{\texorpdfstring{PKCS\#8}{PKCS\#8}}\label{md_node__modules_2node-forge_2README_autotoc_md19646}
{\bfseries{Examples}}
...
\label{md_node__modules_2node-forge_2README_pkcs10}%
\Hypertarget{md_node__modules_2node-forge_2README_pkcs10}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19647}{}\doxysubsection{\texorpdfstring{PKCS\#10}{PKCS\#10}}\label{md_node__modules_2node-forge_2README_autotoc_md19647}
...
\label{md_node__modules_2node-forge_2README_pkcs12}%
\Hypertarget{md_node__modules_2node-forge_2README_pkcs12}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19648}{}\doxysubsection{\texorpdfstring{PKCS\#12}{PKCS\#12}}\label{md_node__modules_2node-forge_2README_autotoc_md19648}
...
\label{md_node__modules_2node-forge_2README_asn}%
\Hypertarget{md_node__modules_2node-forge_2README_asn}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19649}{}\doxysubsection{\texorpdfstring{ASN.\+1}{ASN.1}}\label{md_node__modules_2node-forge_2README_autotoc_md19649}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19650}{}\doxysection{\texorpdfstring{Message Digests}{Message Digests}}\label{md_node__modules_2node-forge_2README_autotoc_md19650}
\label{md_node__modules_2node-forge_2README_sha1}%
\Hypertarget{md_node__modules_2node-forge_2README_sha1}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19651}{}\doxysubsection{\texorpdfstring{SHA1}{SHA1}}\label{md_node__modules_2node-forge_2README_autotoc_md19651}
...
\label{md_node__modules_2node-forge_2README_sha256}%
\Hypertarget{md_node__modules_2node-forge_2README_sha256}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19652}{}\doxysubsection{\texorpdfstring{SHA256}{SHA256}}\label{md_node__modules_2node-forge_2README_autotoc_md19652}
...
\label{md_node__modules_2node-forge_2README_sha384}%
\Hypertarget{md_node__modules_2node-forge_2README_sha384}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19653}{}\doxysubsection{\texorpdfstring{SHA384}{SHA384}}\label{md_node__modules_2node-forge_2README_autotoc_md19653}
...
\label{md_node__modules_2node-forge_2README_sha512}%
\Hypertarget{md_node__modules_2node-forge_2README_sha512}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19654}{}\doxysubsection{\texorpdfstring{SHA512}{SHA512}}\label{md_node__modules_2node-forge_2README_autotoc_md19654}
...
\label{md_node__modules_2node-forge_2README_md5}%
\Hypertarget{md_node__modules_2node-forge_2README_md5}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19655}{}\doxysubsection{\texorpdfstring{MD5}{MD5}}\label{md_node__modules_2node-forge_2README_autotoc_md19655}
...
\label{md_node__modules_2node-forge_2README_hmac}%
\Hypertarget{md_node__modules_2node-forge_2README_hmac}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19656}{}\doxysubsection{\texorpdfstring{HMAC}{HMAC}}\label{md_node__modules_2node-forge_2README_autotoc_md19656}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19657}{}\doxysection{\texorpdfstring{Utilities}{Utilities}}\label{md_node__modules_2node-forge_2README_autotoc_md19657}
\label{md_node__modules_2node-forge_2README_prime}%
\Hypertarget{md_node__modules_2node-forge_2README_prime}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19658}{}\doxysubsection{\texorpdfstring{Prime}{Prime}}\label{md_node__modules_2node-forge_2README_autotoc_md19658}
...
\label{md_node__modules_2node-forge_2README_prng}%
\Hypertarget{md_node__modules_2node-forge_2README_prng}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19659}{}\doxysubsection{\texorpdfstring{PRNG}{PRNG}}\label{md_node__modules_2node-forge_2README_autotoc_md19659}
...
\label{md_node__modules_2node-forge_2README_task}%
\Hypertarget{md_node__modules_2node-forge_2README_task}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19660}{}\doxysubsection{\texorpdfstring{Tasks}{Tasks}}\label{md_node__modules_2node-forge_2README_autotoc_md19660}
...
\label{md_node__modules_2node-forge_2README_util}%
\Hypertarget{md_node__modules_2node-forge_2README_util}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19661}{}\doxysubsection{\texorpdfstring{Utilities}{Utilities}}\label{md_node__modules_2node-forge_2README_autotoc_md19661}
...
\label{md_node__modules_2node-forge_2README_log}%
\Hypertarget{md_node__modules_2node-forge_2README_log}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19662}{}\doxysubsection{\texorpdfstring{Logging}{Logging}}\label{md_node__modules_2node-forge_2README_autotoc_md19662}
...
\label{md_node__modules_2node-forge_2README_flash}%
\Hypertarget{md_node__modules_2node-forge_2README_flash}%
\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19663}{}\doxysubsection{\texorpdfstring{Flash Networking Support}{Flash Networking Support}}\label{md_node__modules_2node-forge_2README_autotoc_md19663}
The \doxysectlink{md_node__modules_2node-forge_2flash_2README}{flash README}{0} provides details on rebuilding the optional Flash component used for networking. It also provides details on Policy Server support.\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19664}{}\doxysection{\texorpdfstring{Security Considerations}{Security Considerations}}\label{md_node__modules_2node-forge_2README_autotoc_md19664}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19665}{}\doxysection{\texorpdfstring{Library Background}{Library Background}}\label{md_node__modules_2node-forge_2README_autotoc_md19665}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19666}{}\doxysection{\texorpdfstring{Contact}{Contact}}\label{md_node__modules_2node-forge_2README_autotoc_md19666}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2node-forge_2README_autotoc_md19667}{}\doxysection{\texorpdfstring{Donations}{Donations}}\label{md_node__modules_2node-forge_2README_autotoc_md19667}
