\chapter{signal-\/exit}
\hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README}{}\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README}\index{signal-\/exit@{signal-\/exit}}
\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13771}%
\Hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13771}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13772}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13772}
...
If the global {\ttfamily process} object is not suitable for this purpose (ie, it\textquotesingle{}s unset, or doesn\textquotesingle{}t have an {\ttfamily emit} method, etc.) then the {\ttfamily on\+Exit} function is a no-\/op that returns a no-\/op {\ttfamily remove} method.\hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13773}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13773}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13774}{}\doxysubsection{\texorpdfstring{Capturing Signal Exits}{Capturing Signal Exits}}\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13774}
...
Note that numeric code exits may indicate that the process is already committed to exiting, for example due to a fatal exception or unhandled promise rejection, and so there is no way to prevent it safely.\hypertarget{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13775}{}\doxysubsection{\texorpdfstring{Browser Fallback}{Browser Fallback}}\label{md_node__modules_2foreground-child_2node__modules_2signal-exit_2README_autotoc_md13775}
