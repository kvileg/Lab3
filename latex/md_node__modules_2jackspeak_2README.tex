\chapter{jackspeak}
\hypertarget{md_node__modules_2jackspeak_2README}{}\label{md_node__modules_2jackspeak_2README}\index{jackspeak@{jackspeak}}
\label{md_node__modules_2jackspeak_2README_autotoc_md16592}%
\Hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16592}%
...
Unless otherwise noted, all methods return the object itself.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16593}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_node__modules_2jackspeak_2README_autotoc_md16593}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16594}{}\doxysection{\texorpdfstring{$<$tt$>$jack(options\+: Jack\+Options = \{\}) =$>$ Jack$<$/tt$>$}{<tt>jack(options: JackOptions = \{\}) => Jack</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16594}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16595}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+heading(text\+: string, level?\+: 1 \texorpdfstring{$\vert$}{|} 2 \texorpdfstring{$\vert$}{|} 3 \texorpdfstring{$\vert$}{|} 4 \texorpdfstring{$\vert$}{|} 5 \texorpdfstring{$\vert$}{|} 6)$<$/tt$>$}{<tt>Jack.heading(text: string, level?: 1 | 2 | 3 | 4 | 5 | 6)</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16595}
...
Headings level 1 and 2 will have a line of padding underneath them. Headings level 3 through 6 will not.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16596}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+description(text\+: string, \{ pre?\+: boolean \} = \{\})$<$/tt$>$}{<tt>Jack.description(text: string, \{ pre?: boolean \} = \{\})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16596}
Define a long string description, used in the {\ttfamily usage()} output.

If the {\ttfamily pre} option is set to {\ttfamily true}, then whitespace will not be normalized. However, if any line is too long for the width allotted, it will still be wrapped.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16597}{}\doxysection{\texorpdfstring{Option Definitions}{Option Definitions}}\label{md_node__modules_2jackspeak_2README_autotoc_md16597}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16598}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+flag(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.flag(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16598}
...
If a boolean option named {\ttfamily no-\/\$\{option\+Name\}} with the same {\ttfamily multiple} setting is in the configuration, then that will be treated as a negating flag.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16599}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+flag\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.flagList(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16599}
Define one or more boolean array fields.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16600}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+num(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.num(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16600}
Define one or more number fields. These will be set in the environment as a stringified number, and included in the {\ttfamily values} object as a number.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16601}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+num\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.numList(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16601}
Define one or more number list fields. These will be set in the environment as a delimited set of stringified numbers, and included in the {\ttfamily values} as a number array.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16602}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+opt(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.opt(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16602}
Define one or more string option fields.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16603}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+opt\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.optList(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16603}
Define one or more string list fields.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16604}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+add\+Fields(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})$<$/tt$>$}{<tt>Jack.addFields(\{ [option: string]: definition, ... \})</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16604}
Define one or more fields of any type. Note that {\ttfamily type} and {\ttfamily multiple} must be set explicitly on each definition when using this method.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16605}{}\doxysection{\texorpdfstring{Actions}{Actions}}\label{md_node__modules_2jackspeak_2README_autotoc_md16605}
Use these methods on a Jack object that\textquotesingle{}s already had its config fields defined.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16606}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+parse(args\+: string\mbox{[}$\,$\mbox{]} = process.\+argv)\+: \{ positionals\+: string\mbox{[}$\,$\mbox{]}, values\+: Options\+Results \}$<$/tt$>$}{<tt>Jack.parse(args: string[] = process.argv): \{ positionals: string[], values: OptionsResults \}</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16606}
Parse the arguments list, write to the environment if {\ttfamily env\+Prefix} is set, and returned the parsed values and remaining positional arguments.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16607}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+validate(o\+: any)\+: asserts o is Options\+Results$<$/tt$>$}{<tt>Jack.validate(o: any): asserts o is OptionsResults</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16607}
Throws an error if the object provided is not a valid result set, for the configurations defined thusfar.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16608}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+usage()\+: string$<$/tt$>$}{<tt>Jack.usage(): string</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16608}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, wrapped to the appropriate width for the terminal.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16609}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+set\+Config\+Values(options\+: Options\+Results, src?\+: string)$<$/tt$>$}{<tt>Jack.setConfigValues(options: OptionsResults, src?: string)</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16609}
Validate the {\ttfamily options} argument, and set the default value for each field that appears in the options.

Values provided will be overridden by environment variables or command line arguments.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16610}{}\doxysubsection{\texorpdfstring{$<$tt$>$\+Jack.\+usage\+Markdown()\+: string$<$/tt$>$}{<tt>Jack.usageMarkdown(): string</tt>}}\label{md_node__modules_2jackspeak_2README_autotoc_md16610}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, but as markdown instead of formatted for a terminal, for generating HTML documentation for your CLI.\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16611}{}\doxysection{\texorpdfstring{Some Example Code}{Some Example Code}}\label{md_node__modules_2jackspeak_2README_autotoc_md16611}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jackspeak_2README_autotoc_md16612}{}\doxysection{\texorpdfstring{Name}{Name}}\label{md_node__modules_2jackspeak_2README_autotoc_md16612}
