...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18309}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2jsesc_2README_autotoc_md18309}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18310}{}\doxysubsection{\texorpdfstring{$<$tt$>$jsesc(value, options)$<$/tt$>$}{<tt>jsesc(value, options)</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18310}
...
The optional {\ttfamily options} argument accepts an object with the following options\+:\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18311}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$quotes$<$/tt$>$}{<tt>quotes</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18311}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18312}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$numbers$<$/tt$>$}{<tt>numbers</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18312}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18313}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$wrap$<$/tt$>$}{<tt>wrap</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18313}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18314}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$es6$<$/tt$>$}{<tt>es6</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18314}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18315}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$escape\+Everything$<$/tt$>$}{<tt>escapeEverything</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18315}
...
This setting also affects the output for string literals within arrays and objects.\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18316}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$minimal$<$/tt$>$}{<tt>minimal</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18316}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18317}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$is\+Script\+Context$<$/tt$>$}{<tt>isScriptContext</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18317}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18318}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$compact$<$/tt$>$}{<tt>compact</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18318}
...
This setting has no effect on the output for strings.\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18319}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$indent$<$/tt$>$}{<tt>indent</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18319}
...
This setting has no effect on the output for strings.\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18320}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$indent\+Level$<$/tt$>$}{<tt>indentLevel</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18320}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18321}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$json$<$/tt$>$}{<tt>json</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18321}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18323}{}\doxysubsection{\texorpdfstring{$<$tt$>$jsesc.\+version$<$/tt$>$}{<tt>jsesc.version</tt>}}\label{md_node__modules_2jsesc_2README_autotoc_md18323}
A string representing the semantic version number.\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18324}{}\doxysubsection{\texorpdfstring{Using the $<$tt$>$jsesc$<$/tt$>$ binary}{Using the <tt>jsesc</tt> binary}}\label{md_node__modules_2jsesc_2README_autotoc_md18324}
...
\end{longtabu}
\hypertarget{md_node__modules_2jsesc_2README_autotoc_md18327}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2jsesc_2README_autotoc_md18327}
