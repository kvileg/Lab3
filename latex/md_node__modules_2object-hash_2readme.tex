...
\label{md_node__modules_2object-hash_2readme_autotoc_md19776}%
\Hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19776}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19777}{}\doxysection{\texorpdfstring{Versioning Disclaimer}{Versioning Disclaimer}}\label{md_node__modules_2object-hash_2readme_autotoc_md19777}
...
For more information, see \href{https://github.com/puleos/object-hash/issues/30}{\texttt{ this discussion}}.\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19778}{}\doxysection{\texorpdfstring{hash(value, options)}{hash(value, options)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19778}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19779}{}\doxysection{\texorpdfstring{hash.\+sha1(value)}{hash.sha1(value)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19779}
...
{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}sha1'\})\`{}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19780}{}\doxysection{\texorpdfstring{hash.\+keys(value)}{hash.keys(value)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19780}
Hash object keys using the sha1 algorithm, values ignored.

{\itshape Sugar method, equivalent to} {\ttfamily hash(value, \{exclude\+Values\+: true\})}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19781}{}\doxysection{\texorpdfstring{hash.\+MD5(value)}{hash.MD5(value)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19781}
...
{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5'\})\`{}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19782}{}\doxysection{\texorpdfstring{hash.\+keys\+MD5(value)}{hash.keysMD5(value)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19782}
Hash object keys using the md5 algorithm, values ignored.

Note that the MD5 algorithm is not considered secure, and a stronger algorithm should be used if a cryptographical hash is desired.

{\itshape Sugar method, equivalent to} `hash(value, \{algorithm\+: \textquotesingle{}md5', exclude\+Values\+: true\})\`{}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19783}{}\doxysection{\texorpdfstring{hash.\+write\+To\+Stream(value, \mbox{[}options,\mbox{]} stream)}{hash.writeToStream(value, [options,] stream)}}\label{md_node__modules_2object-hash_2readme_autotoc_md19783}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19784}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2object-hash_2readme_autotoc_md19784}
node\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19785}{}\doxysection{\texorpdfstring{Example usage}{Example usage}}\label{md_node__modules_2object-hash_2readme_autotoc_md19785}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19786}{}\doxysection{\texorpdfstring{Legacy Browser Support}{Legacy Browser Support}}\label{md_node__modules_2object-hash_2readme_autotoc_md19786}
IE \texorpdfstring{$<$}{<}= 8 and Opera \texorpdfstring{$<$}{<}= 11 support dropped in version 0.\+3.\+0. If you require legacy browser support you must either use an ES5 shim or use version 0.\+2.\+5 of this module.\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19787}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md_node__modules_2object-hash_2readme_autotoc_md19787}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19788}{}\doxysection{\texorpdfstring{Node Docker Wrapper}{Node Docker Wrapper}}\label{md_node__modules_2object-hash_2readme_autotoc_md19788}
If you want to stand this up in a docker container, you should take at look at the \href{https://github.com/bean5/node-object-hash}{\texttt{ }} project.\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19789}{}\doxysubsection{\texorpdfstring{gulp tasks}{gulp tasks}}\label{md_node__modules_2object-hash_2readme_autotoc_md19789}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19790}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2object-hash_2readme_autotoc_md19790}
MIT\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19791}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2object-hash_2readme_autotoc_md19791}
\hypertarget{md_node__modules_2object-hash_2readme_autotoc_md19792}{}\doxysubsection{\texorpdfstring{v2.\+0.\+0}{v2.0.0}}\label{md_node__modules_2object-hash_2readme_autotoc_md19792}
