\chapter{Arg}
\hypertarget{md_node__modules_2arg_2README}{}\label{md_node__modules_2arg_2README}\index{Arg@{Arg}}
\label{md_node__modules_2arg_2README_autotoc_md5673}%
\Hypertarget{md_node__modules_2arg_2README_autotoc_md5673}%
 {\ttfamily arg} is an unopinionated, no-\/frills CLI argument parser.\hypertarget{md_node__modules_2arg_2README_autotoc_md5674}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2arg_2README_autotoc_md5674}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ arg}

\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5675}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2arg_2README_autotoc_md5675}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5676}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2arg_2README_autotoc_md5676}
If a second parameter is specified and is an object, it specifies parsing options to modify the behavior of {\ttfamily arg()}.\hypertarget{md_node__modules_2arg_2README_autotoc_md5677}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$argv$<$/tt$>$}{<tt>argv</tt>}}\label{md_node__modules_2arg_2README_autotoc_md5677}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5678}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$permissive$<$/tt$>$}{<tt>permissive</tt>}}\label{md_node__modules_2arg_2README_autotoc_md5678}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5679}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$stop\+At\+Positional$<$/tt$>$}{<tt>stopAtPositional</tt>}}\label{md_node__modules_2arg_2README_autotoc_md5679}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5680}{}\doxysubsection{\texorpdfstring{Errors}{Errors}}\label{md_node__modules_2arg_2README_autotoc_md5680}
Some errors that {\ttfamily arg} throws provide a {\ttfamily .code} property in order to aid in recovering from user error, or to differentiate between user error and developer error (bug).\hypertarget{md_node__modules_2arg_2README_autotoc_md5681}{}\doxyparagraph{\texorpdfstring{ARG\+\_\+\+UNKNOWN\+\_\+\+OPTION}{ARG\_UNKNOWN\_OPTION}}\label{md_node__modules_2arg_2README_autotoc_md5681}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5682}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_node__modules_2arg_2README_autotoc_md5682}
A few questions and answers that have been asked before\+:\hypertarget{md_node__modules_2arg_2README_autotoc_md5683}{}\doxysubsubsection{\texorpdfstring{How do I require an argument with $<$tt$>$arg$<$/tt$>$?}{How do I require an argument with <tt>arg</tt>?}}\label{md_node__modules_2arg_2README_autotoc_md5683}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2arg_2README_autotoc_md5684}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2arg_2README_autotoc_md5684}
Released under the \doxysectlink{md_node__modules_2arg_2LICENSE}{MIT License}{0}. 