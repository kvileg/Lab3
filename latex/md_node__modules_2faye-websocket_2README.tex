...
\hypertarget{md_node__modules_2faye-websocket_2README}{}\label{md_node__modules_2faye-websocket_2README}\index{faye-\/websocket@{faye-\/websocket}}
\label{md_node__modules_2faye-websocket_2README_autotoc_md13334}%
\Hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13334}%
...
It also provides an abstraction for handling \href{https://html.spec.whatwg.org/multipage/comms.html\#server-sent-events}{\texttt{ Event\+Source}} connections, which are one-\/way connections that allow the server to push data to the client. They are based on streaming HTTP responses and can be easier to access via proxies than Web\+Sockets.\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13335}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13335}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ faye-\/websocket}

\end{DoxyCode}
\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13336}{}\doxysection{\texorpdfstring{Handling Web\+Socket connections in Node}{Handling WebSocket connections in Node}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13336}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13337}{}\doxysection{\texorpdfstring{Using the Web\+Socket client}{Using the WebSocket client}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13337}
...
The {\ttfamily tls} value is an object that will be passed to \href{https://nodejs.org/api/tls.html\#tls_tls_connect_options_callback}{\texttt{ {\ttfamily tls.\+connect()}}}.\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13338}{}\doxysection{\texorpdfstring{Subprotocol negotiation}{Subprotocol negotiation}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13338}
...
If the client and server agree on a protocol, both the client-\/ and server-\/side socket objects expose the selected protocol through the {\ttfamily ws.\+protocol} property.\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13339}{}\doxysection{\texorpdfstring{Protocol extensions}{Protocol extensions}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13339}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13340}{}\doxysection{\texorpdfstring{Initialization options}{Initialization options}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13340}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13341}{}\doxysection{\texorpdfstring{Web\+Socket API}{WebSocket API}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13341}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2faye-websocket_2README_autotoc_md13342}{}\doxysection{\texorpdfstring{Handling Event\+Source connections in Node}{Handling EventSource connections in Node}}\label{md_node__modules_2faye-websocket_2README_autotoc_md13342}
