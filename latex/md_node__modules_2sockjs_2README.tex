\chapter{README}
\hypertarget{md_node__modules_2sockjs_2README}{}\label{md_node__modules_2sockjs_2README}\index{README@{README}}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26073}{}\doxysection{\texorpdfstring{What is Sock\+JS?}{What is SockJS?}}\label{md_node__modules_2sockjs_2README_autotoc_md26073}
Sock\+JS is a Java\+Script library (for browsers) that provides a Web\+Socket-\/like object. Sock\+JS gives you a coherent, cross-\/browser, Javascript API which creates a low latency, full duplex, cross-\/domain communication channel between the browser and the web server, with Web\+Sockets or without. This necessitates the use of a server, which this is one version of, for Node.\+js.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26074}{}\doxysection{\texorpdfstring{Sock\+JS-\/node server}{SockJS-node server}}\label{md_node__modules_2sockjs_2README_autotoc_md26074}
...
Subscribe to \href{https://groups.google.com/forum/\#!forum/sockjs}{\texttt{ Sock\+JS mailing list}} for discussions and support.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26075}{}\doxysubsection{\texorpdfstring{Sock\+JS-\/node API}{SockJS-node API}}\label{md_node__modules_2sockjs_2README_autotoc_md26075}
The API design is based on common Node APIs like the \href{http://nodejs.org/docs/v0.5.8/api/streams.html}{\texttt{ Streams API}} or the \href{http://nodejs.org/docs/v0.5.8/api/http.html\#http.Server}{\texttt{ Http.\+Server API}}.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26076}{}\doxysubsubsection{\texorpdfstring{Server class}{Server class}}\label{md_node__modules_2sockjs_2README_autotoc_md26076}
...
\end{DoxyDescription}\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26077}{}\doxysubsubsection{\texorpdfstring{Server instance}{Server instance}}\label{md_node__modules_2sockjs_2README_autotoc_md26077}
...
All http requests that don\textquotesingle{}t go under the path selected by {\ttfamily prefix} will remain unanswered and will be passed to previously registered handlers. You must install your custom http handlers before calling {\ttfamily install\+Handlers}.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26078}{}\doxysubsubsection{\texorpdfstring{Connection instance}{Connection instance}}\label{md_node__modules_2sockjs_2README_autotoc_md26078}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26079}{}\doxysubsubsection{\texorpdfstring{Footnote}{Footnote}}\label{md_node__modules_2sockjs_2README_autotoc_md26079}
A fully working echo server does need a bit more boilerplate (to handle requests unanswered by Sock\+JS), see the \href{https://github.com/sockjs/sockjs-node/tree/master/examples/echo}{\texttt{ {\ttfamily echo} example}} for a complete code.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26080}{}\doxysubsubsection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2sockjs_2README_autotoc_md26080}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26081}{}\doxysubsection{\texorpdfstring{Connecting to Sock\+JS-\/node without the client}{Connecting to SockJS-node without the client}}\label{md_node__modules_2sockjs_2README_autotoc_md26081}
...
Note\+: This endpoint will {\itshape not send any heartbeat packets}.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26082}{}\doxysubsection{\texorpdfstring{Deployment and load balancing}{Deployment and load balancing}}\label{md_node__modules_2sockjs_2README_autotoc_md26082}
There are two issues that need to be considered when planning a non-\/trivial Sock\+JS-\/node deployment\+: Web\+Socket-\/compatible load balancer and sticky sessions (aka session affinity).\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26083}{}\doxysubsubsection{\texorpdfstring{Web\+Socket compatible load balancer}{WebSocket compatible load balancer}}\label{md_node__modules_2sockjs_2README_autotoc_md26083}
...
The config also shows how to use HAproxy balancing to split traffic between multiple Node.\+js servers. You can also do balancing using dns names.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26084}{}\doxysubsubsection{\texorpdfstring{Sticky sessions}{Sticky sessions}}\label{md_node__modules_2sockjs_2README_autotoc_md26084}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26085}{}\doxysubsection{\texorpdfstring{Development and testing}{Development and testing}}\label{md_node__modules_2sockjs_2README_autotoc_md26085}
...
\end{DoxyVerb}
 \hypertarget{md_node__modules_2sockjs_2README_autotoc_md26086}{}\doxysubsubsection{\texorpdfstring{Sock\+JS-\/protocol Python tests}{SockJS-protocol Python tests}}\label{md_node__modules_2sockjs_2README_autotoc_md26086}
To run it run something like\+: \begin{DoxyVerb}cd sockjs-protocol
make test_deps
./venv/bin/python sockjs-protocol.py
\end{DoxyVerb}
 For details see \href{https://github.com/sockjs/sockjs-protocol\#readme}{\texttt{ Sock\+JS-\/protocol README}}.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26087}{}\doxysubsubsection{\texorpdfstring{Sock\+JS-\/client QUnit tests}{SockJS-client QUnit tests}}\label{md_node__modules_2sockjs_2README_autotoc_md26087}
...
Additionally, if you\textquotesingle{}re doing more serious development consider using {\ttfamily make serve}, which will automatically the server when you modify the source code.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26088}{}\doxysubsection{\texorpdfstring{Various issues and design considerations}{Various issues and design considerations}}\label{md_node__modules_2sockjs_2README_autotoc_md26088}
\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26089}{}\doxysubsubsection{\texorpdfstring{Authorisation}{Authorisation}}\label{md_node__modules_2sockjs_2README_autotoc_md26089}
...
Basically -\/ cookies are not suited for Sock\+JS model. If you want to authorise a session -\/ provide a unique token on a page, send it as a first thing over Sock\+JS connection and validate it on the server side. In essence, this is how cookies work.\hypertarget{md_node__modules_2sockjs_2README_autotoc_md26090}{}\doxysubsubsection{\texorpdfstring{Deploying Sock\+JS on Heroku}{Deploying SockJS on Heroku}}\label{md_node__modules_2sockjs_2README_autotoc_md26090}
