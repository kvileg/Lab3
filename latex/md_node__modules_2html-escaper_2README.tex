...
\hypertarget{md_node__modules_2html-escaper_2README}{}\label{md_node__modules_2html-escaper_2README}\index{html-\/escaper $<$a href="{}https://travis-\/ci.org/WebReflection/html-\/escaper"{} $>$$<$img src="{}https://travis-\/ci.org/WebReflection/html-\/escaper.svg?branch=master"{} alt="{}Build Status"{}/$>$$<$/a$>$ $<$a href="{}https://coveralls.io/github/WebReflection/html-\/escaper?branch=master"{} $>$$<$img src="{}https://coveralls.io/repos/github/WebReflection/html-\/escaper/badge.svg?branch=master"{} alt="{}Coverage Status"{}/$>$$<$/a$>$@{html-\/escaper $<$a href=""https://travis-\/ci.org/WebReflection/html-\/escaper"" $>$$<$img src=""https://travis-\/ci.org/WebReflection/html-\/escaper.svg?branch=master"" alt=""Build Status""/$>$$<$/a$>$ $<$a href=""https://coveralls.io/github/WebReflection/html-\/escaper?branch=master"" $>$$<$img src=""https://coveralls.io/repos/github/WebReflection/html-\/escaper/badge.svg?branch=master"" alt=""Coverage Status""/$>$$<$/a$>$}}
\label{md_node__modules_2html-escaper_2README_autotoc_md14851}%
\Hypertarget{md_node__modules_2html-escaper_2README_autotoc_md14851}%
A simple module to escape/unescape common problematic entities.\hypertarget{md_node__modules_2html-escaper_2README_autotoc_md14852}{}\doxysubsection{\texorpdfstring{How}{How}}\label{md_node__modules_2html-escaper_2README_autotoc_md14852}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2html-escaper_2README_autotoc_md14853}{}\doxysubsection{\texorpdfstring{Why}{Why}}\label{md_node__modules_2html-escaper_2README_autotoc_md14853}
...
We have proofs this approach can fail already so ... why should we risk? Just avoid and grab all chars at once or simply use this tiny utility.\hypertarget{md_node__modules_2html-escaper_2README_autotoc_md14854}{}\doxysubsection{\texorpdfstring{Backtick}{Backtick}}\label{md_node__modules_2html-escaper_2README_autotoc_md14854}
