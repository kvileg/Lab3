...
\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README}{}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README}\index{json-\/schema-\/traverse@{json-\/schema-\/traverse}}
\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8522}%
\Hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8522}%
Traverse JSON Schema passing each schema object to callback

\href{https://github.com/epoberezkin/json-schema-traverse/actions?query=workflow\%3Abuild}{\texttt{ }} \href{https://www.npmjs.com/package/json-schema-traverse}{\texttt{ }} \href{https://coveralls.io/github/epoberezkin/json-schema-traverse?branch=master}{\texttt{ }}\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8523}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8523}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ json-\/schema-\/traverse}

\end{DoxyCode}
\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8524}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8524}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8525}{}\doxysection{\texorpdfstring{Traverse objects in all unknown keywords}{Traverse objects in all unknown keywords}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8525}
...
Without option {\ttfamily all\+Keys\+: true} callback will be called only with root schema.\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8526}{}\doxysection{\texorpdfstring{Enterprise support}{Enterprise support}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8526}
json-\/schema-\/traverse package is a part of \href{https://tidelift.com/subscription/pkg/npm-json-schema-traverse?utm_source=npm-json-schema-traverse&utm_medium=referral&utm_campaign=enterprise&utm_term=repo}{\texttt{ Tidelift enterprise subscription}} -\/ it provides a centralised commercial support to open-\/source software users, in addition to the support provided by software maintainers.\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8527}{}\doxysection{\texorpdfstring{Security contact}{Security contact}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8527}
To report a security vulnerability, please use the \href{https://tidelift.com/security}{\texttt{ Tidelift security contact}}. Tidelift will coordinate the fix and disclosure. Please do NOT report security vulnerability via Git\+Hub issues.\hypertarget{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8528}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2css-minimizer-webpack-plugin_2node__modules_2json-schema-traverse_2README_autotoc_md8528}
