...
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme}{}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme}\index{Commander.js@{Commander.js}}
\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27031}%
\Hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27031}%
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27032}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27032}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ commander}

\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27033}{}\doxysection{\texorpdfstring{Declaring $<$em$>$program$<$/em$>$ variable}{Declaring <em>program</em> variable}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27033}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27034}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27034}
...
See also optional new behaviour to avoid name clashes.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27035}{}\doxysubsection{\texorpdfstring{Common option types, boolean and value}{Common option types, boolean and value}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27035}
...
{\ttfamily program.\+parse(arguments)} processes the arguments, leaving any args not consumed by the options as the {\ttfamily program.\+args} array.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27036}{}\doxysubsection{\texorpdfstring{Default option value}{Default option value}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27036}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27037}{}\doxysubsection{\texorpdfstring{Other option types, negatable boolean and flag\texorpdfstring{$\vert$}{|}value}{Other option types, negatable boolean and flag|value}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27037}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27038}{}\doxysubsection{\texorpdfstring{Custom option processing}{Custom option processing}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27038}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27039}{}\doxysubsection{\texorpdfstring{Required option}{Required option}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27039}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27040}{}\doxysubsection{\texorpdfstring{Version option}{Version option}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27040}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27041}{}\doxysection{\texorpdfstring{Commands}{Commands}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27041}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27042}{}\doxysubsection{\texorpdfstring{Specify the argument syntax}{Specify the argument syntax}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27042}
...
The variadic argument is passed to the action handler as an array. (And this also applies to {\ttfamily program.\+args}.)\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27043}{}\doxysubsection{\texorpdfstring{Action handler (sub)commands}{Action handler (sub)commands}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27043}
...
Configuration options can be passed with the call to {\ttfamily .command()}. Specifying {\ttfamily true} for {\ttfamily opts.\+no\+Help} will remove the command from the generated help output.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27044}{}\doxysubsection{\texorpdfstring{Git-\/style executable (sub)commands}{Git-style executable (sub)commands}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27044}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27045}{}\doxysection{\texorpdfstring{Automated –help}{Automated –help}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27045}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27046}{}\doxysubsection{\texorpdfstring{Custom help}{Custom help}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27046}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27047}{}\doxysubsection{\texorpdfstring{.\+usage and .\+name}{.usage and .name}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27047}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27048}{}\doxysubsection{\texorpdfstring{.\+output\+Help(cb)}{.outputHelp(cb)}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27048}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27049}{}\doxysubsection{\texorpdfstring{.\+help\+Option(flags, description)}{.helpOption(flags, description)}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27049}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27050}{}\doxysubsection{\texorpdfstring{.\+help(cb)}{.help(cb)}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27050}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27051}{}\doxysection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27051}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27052}{}\doxysection{\texorpdfstring{Bits and pieces}{Bits and pieces}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27052}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27053}{}\doxysubsection{\texorpdfstring{Avoiding option name clashes}{Avoiding option name clashes}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27053}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27054}{}\doxysubsection{\texorpdfstring{Type\+Script}{TypeScript}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27054}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27055}{}\doxysubsection{\texorpdfstring{Node options such as $<$tt$>$-\/-\/harmony$<$/tt$>$}{Node options such as <tt>--harmony</tt>}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27055}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27056}{}\doxysubsection{\texorpdfstring{Node debugging}{Node debugging}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27056}
If you are using the node inspector for \href{https://nodejs.org/en/docs/guides/debugging-getting-started/}{\texttt{ debugging}} git-\/style executable (sub)commands using {\ttfamily node -\/-\/inspect} et al, the inspector port is incremented by 1 for the spawned subcommand.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27057}{}\doxysubsection{\texorpdfstring{Override exit handling}{Override exit handling}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27057}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27058}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27058}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27059}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27059}
\href{https://github.com/tj/commander.js/blob/master/LICENSE}{\texttt{ MIT}}\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27060}{}\doxysection{\texorpdfstring{Support}{Support}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27060}
...
The main forum for free and community support is the project \href{https://github.com/tj/commander.js/issues}{\texttt{ Issues}} on Git\+Hub.\hypertarget{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27061}{}\doxysubsection{\texorpdfstring{Commander for enterprise}{Commander for enterprise}}\label{md_node__modules_2sucrase_2node__modules_2commander_2Readme_autotoc_md27061}
