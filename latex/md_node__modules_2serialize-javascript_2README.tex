...
\hypertarget{md_node__modules_2serialize-javascript_2README}{}\label{md_node__modules_2serialize-javascript_2README}\index{Serialize JavaScript@{Serialize JavaScript}}
Serialize Java\+Script to a {\itshape superset} of JSON that includes regular expressions, dates and functions.

\href{https://www.npmjs.org/package/serialize-javascript}{\texttt{ }} \href{https://david-dm.org/yahoo/serialize-javascript}{\texttt{ }} \hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25610}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25610}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25612}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25612}
...
Note\+: to produce a beautified string, you can pass an optional second argument to {\ttfamily serialize()} to define the number of spaces to be used for the indentation.\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25613}{}\doxysubsection{\texorpdfstring{Automatic Escaping of HTML Characters}{Automatic Escaping of HTML Characters}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25613}
...
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25614}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25614}
The {\ttfamily serialize()} function accepts an {\ttfamily options} object as its second argument. All options are being defaulted to {\ttfamily undefined}\+:\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25615}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$options.\+space$<$/tt$>$}{<tt>options.space</tt>}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25615}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25616}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$options.\+is\+JSON$<$/tt$>$}{<tt>options.isJSON</tt>}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25616}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25617}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$options.\+unsafe$<$/tt$>$}{<tt>options.unsafe</tt>}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25617}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25618}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$options.\+ignore\+Function$<$/tt$>$}{<tt>options.ignoreFunction</tt>}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25618}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25619}{}\doxysection{\texorpdfstring{Deserializing}{Deserializing}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25619}
...
{\bfseries{Note\+:}} Don\textquotesingle{}t forget the parentheses around the serialized javascript, as the opening bracket {\ttfamily \{} will be considered to be the start of a body.\hypertarget{md_node__modules_2serialize-javascript_2README_autotoc_md25620}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2serialize-javascript_2README_autotoc_md25620}
