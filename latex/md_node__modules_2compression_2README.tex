\chapter{compression}
\hypertarget{md_node__modules_2compression_2README}{}\label{md_node__modules_2compression_2README}\index{compression@{compression}}
\label{md_node__modules_2compression_2README_autotoc_md8125}%
\Hypertarget{md_node__modules_2compression_2README_autotoc_md8125}%
...
\item deflate
\item gzip
\end{DoxyItemize}\hypertarget{md_node__modules_2compression_2README_autotoc_md8126}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2compression_2README_autotoc_md8126}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8127}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2compression_2README_autotoc_md8127}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ compression\ =\ require('compression')}

\end{DoxyCode}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8128}{}\doxysubsection{\texorpdfstring{compression(\mbox{[}options\mbox{]})}{compression([options])}}\label{md_node__modules_2compression_2README_autotoc_md8128}
...
This middleware will never compress responses that include a {\ttfamily Cache-\/\+Control} header with the \href{https://tools.ietf.org/html/rfc7234\#section-5.2.2.4}{\texttt{ {\ttfamily no-\/transform} directive}}, as compressing will transform the body.\hypertarget{md_node__modules_2compression_2README_autotoc_md8129}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2compression_2README_autotoc_md8129}
{\ttfamily compression()} accepts these properties in the options object. In addition to those listed below, \href{http://nodejs.org/api/zlib.html}{\texttt{ zlib}} options may be passed in to the options object.\hypertarget{md_node__modules_2compression_2README_autotoc_md8130}{}\doxyparagraph{\texorpdfstring{chunk\+Size}{chunkSize}}\label{md_node__modules_2compression_2README_autotoc_md8130}
The default value is {\ttfamily zlib.\+Z\+\_\+\+DEFAULT\+\_\+\+CHUNK}, or {\ttfamily 16384}.

See \href{http://nodejs.org/api/zlib.html\#zlib_memory_usage_tuning}{\texttt{ Node.\+js documentation}} regarding the usage.\hypertarget{md_node__modules_2compression_2README_autotoc_md8131}{}\doxyparagraph{\texorpdfstring{filter}{filter}}\label{md_node__modules_2compression_2README_autotoc_md8131}
...
The default filter function uses the \href{https://www.npmjs.com/package/compressible}{\texttt{ compressible}} module to determine if `res.\+get\+Header(\textquotesingle{}Content-\/\+Type')\`{} is compressible.\hypertarget{md_node__modules_2compression_2README_autotoc_md8132}{}\doxyparagraph{\texorpdfstring{level}{level}}\label{md_node__modules_2compression_2README_autotoc_md8132}
...
{\bfseries{Note}} in the list above, {\ttfamily zlib} is from `zlib = require(\textquotesingle{}zlib')\`{}.\hypertarget{md_node__modules_2compression_2README_autotoc_md8133}{}\doxyparagraph{\texorpdfstring{mem\+Level}{memLevel}}\label{md_node__modules_2compression_2README_autotoc_md8133}
...
See \href{http://nodejs.org/api/zlib.html\#zlib_memory_usage_tuning}{\texttt{ Node.\+js documentation}} regarding the usage.\hypertarget{md_node__modules_2compression_2README_autotoc_md8134}{}\doxyparagraph{\texorpdfstring{strategy}{strategy}}\label{md_node__modules_2compression_2README_autotoc_md8134}
...
{\bfseries{Note}} in the list above, {\ttfamily zlib} is from `zlib = require(\textquotesingle{}zlib')\`{}.\hypertarget{md_node__modules_2compression_2README_autotoc_md8135}{}\doxyparagraph{\texorpdfstring{threshold}{threshold}}\label{md_node__modules_2compression_2README_autotoc_md8135}
...
{\bfseries{Note}} this is only an advisory setting; if the response size cannot be determined at the time the response headers are written, then it is assumed the response is {\itshape over} the threshold. To guarantee the response size can be determined, be sure set a {\ttfamily Content-\/\+Length} response header.\hypertarget{md_node__modules_2compression_2README_autotoc_md8136}{}\doxyparagraph{\texorpdfstring{window\+Bits}{windowBits}}\label{md_node__modules_2compression_2README_autotoc_md8136}
The default value is {\ttfamily zlib.\+Z\+\_\+\+DEFAULT\+\_\+\+WINDOWBITS}, or {\ttfamily 15}.

See \href{http://nodejs.org/api/zlib.html\#zlib_memory_usage_tuning}{\texttt{ Node.\+js documentation}} regarding the usage.\hypertarget{md_node__modules_2compression_2README_autotoc_md8137}{}\doxysubsubsection{\texorpdfstring{.\+filter}{.filter}}\label{md_node__modules_2compression_2README_autotoc_md8137}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8138}{}\doxysubsection{\texorpdfstring{res.\+flush}{res.flush}}\label{md_node__modules_2compression_2README_autotoc_md8138}
This module adds a {\ttfamily res.\+flush()} method to force the partially-\/compressed response to be flushed to the client.\hypertarget{md_node__modules_2compression_2README_autotoc_md8139}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2compression_2README_autotoc_md8139}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8140}{}\doxysubsection{\texorpdfstring{express/connect}{express/connect}}\label{md_node__modules_2compression_2README_autotoc_md8140}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8141}{}\doxysubsection{\texorpdfstring{Server-\/\+Sent Events}{Server-Sent Events}}\label{md_node__modules_2compression_2README_autotoc_md8141}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2compression_2README_autotoc_md8142}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2compression_2README_autotoc_md8142}
