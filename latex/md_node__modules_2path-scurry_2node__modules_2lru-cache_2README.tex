\chapter{lru-\/cache}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README}{}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README}\index{lru-\/cache@{lru-\/cache}}
\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20361}%
\Hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20361}%
...
As of version 7, this is one of the most performant LRU implementations available in Java\+Script, and supports a wide diversity of use cases. However, note that using some of the features will necessarily impact performance, by causing the cache to have to do more work. See the "{}\+Performance"{} section below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20362}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20362}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ lru-\/cache\ -\/-\/save}

\end{DoxyCode}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20363}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20363}
...
If you put more stuff in the cache, then less recently used items will fall out. That\textquotesingle{}s what an LRU cache is.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20364}{}\doxysection{\texorpdfstring{$<$tt$>$class LRUCache$<$\+K, V, FC = unknown$>$(options)$<$/tt$>$}{<tt>class LRUCache<K, V, FC = unknown>(options)</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20364}
...
Some options are marked read-\/only because changing them after instantiation is not safe. Changing any of the other options will of course only have an effect on subsequent method calls.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20366}{}\doxysubsection{\texorpdfstring{$<$tt$>$max$<$/tt$>$ (read only)}{<tt>max</tt> (read only)}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20366}
...
{\bfseries{It is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20367}{}\doxysubsection{\texorpdfstring{$<$tt$>$max\+Size$<$/tt$>$ (read only)}{<tt>maxSize</tt> (read only)}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20367}
...
Even if size tracking is enabled, {\bfseries{it is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20368}{}\doxysubsection{\texorpdfstring{$<$tt$>$max\+Entry\+Size$<$/tt$>$}{<tt>maxEntrySize</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20368}
...
Optional, must be a positive integer if provided. Defaults to the value of {\ttfamily max\+Size} if provided.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20369}{}\doxysubsection{\texorpdfstring{$<$tt$>$size\+Calculation$<$/tt$>$}{<tt>sizeCalculation</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20369}
...
If the {\ttfamily size} (or return value of {\ttfamily size\+Calculation}) for a given entry is greater than {\ttfamily max\+Entry\+Size}, then the item will not be added to the cache.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20370}{}\doxysubsection{\texorpdfstring{$<$tt$>$fetch\+Method$<$/tt$>$ (read only)}{<tt>fetchMethod</tt> (read only)}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20370}
...
For example, a DNS cache may update the TTL based on the value returned from a remote DNS server by changing {\ttfamily options.\+ttl} in the {\ttfamily fetch\+Method}.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20371}{}\doxysubsection{\texorpdfstring{$<$tt$>$no\+Delete\+On\+Fetch\+Rejection$<$/tt$>$}{<tt>noDeleteOnFetchRejection</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20371}
...
This may be set in calls to {\ttfamily fetch()}, or defaulted on the constructor, or overridden by modifying the options object in the {\ttfamily fetch\+Method}.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20372}{}\doxysubsection{\texorpdfstring{$<$tt$>$allow\+Stale\+On\+Fetch\+Rejection$<$/tt$>$}{<tt>allowStaleOnFetchRejection</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20372}
...
This may be set in calls to {\ttfamily fetch()}, or defaulted on the constructor, or overridden by modifying the options object in the {\ttfamily fetch\+Method}.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20373}{}\doxysubsection{\texorpdfstring{$<$tt$>$allow\+Stale\+On\+Fetch\+Abort$<$/tt$>$}{<tt>allowStaleOnFetchAbort</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20373}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20374}{}\doxysubsection{\texorpdfstring{$<$tt$>$ignore\+Fetch\+Abort$<$/tt$>$}{<tt>ignoreFetchAbort</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20374}
...
This may be overridden on the {\ttfamily fetch()} call or in the {\ttfamily fetch\+Method} itself.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20375}{}\doxysubsection{\texorpdfstring{$<$tt$>$dispose$<$/tt$>$ (read only)}{<tt>dispose</tt> (read only)}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20375}
...
Optional, must be a function.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20376}{}\doxysubsection{\texorpdfstring{$<$tt$>$dispose\+After$<$/tt$>$ (read only)}{<tt>disposeAfter</tt> (read only)}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20376}
...
The {\ttfamily dispose\+After()} method is {\itshape not} called for canceled calls to {\ttfamily fetch\+Method()}. If you wish to handle evictions, overwrites, and deletes of in-\/flight asynchronous fetches, you must use the {\ttfamily Abort\+Signal} provided.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20377}{}\doxysubsection{\texorpdfstring{$<$tt$>$no\+Dispose\+On\+Set$<$/tt$>$}{<tt>noDisposeOnSet</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20377}
...
Boolean, default {\ttfamily false}. Only relevant if {\ttfamily dispose} or {\ttfamily dispose\+After} options are set.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20378}{}\doxysubsection{\texorpdfstring{$<$tt$>$ttl$<$/tt$>$}{<tt>ttl</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20378}
...
Boolean, default false.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20380}{}\doxysubsection{\texorpdfstring{$<$tt$>$ttl\+Resolution$<$/tt$>$}{<tt>ttlResolution</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20380}
...
Note that setting this to a higher value {\itshape will} improve performance somewhat while using ttl tracking, albeit at the expense of keeping stale items around a bit longer than intended.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20381}{}\doxysubsection{\texorpdfstring{$<$tt$>$ttl\+Autopurge$<$/tt$>$}{<tt>ttlAutopurge</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20381}
...
Boolean, default {\ttfamily false}\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20382}{}\doxysubsection{\texorpdfstring{$<$tt$>$allow\+Stale$<$/tt$>$}{<tt>allowStale</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20382}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20383}{}\doxysubsection{\texorpdfstring{$<$tt$>$no\+Delete\+On\+Stale\+Get$<$/tt$>$}{<tt>noDeleteOnStaleGet</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20383}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20384}{}\doxysubsection{\texorpdfstring{$<$tt$>$update\+Age\+On\+Get$<$/tt$>$}{<tt>updateAgeOnGet</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20384}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20385}{}\doxysubsection{\texorpdfstring{$<$tt$>$update\+Age\+On\+Has$<$/tt$>$}{<tt>updateAgeOnHas</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20385}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20386}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20386}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20387}{}\doxysubsection{\texorpdfstring{$<$tt$>$new LRUCache$<$\+K, V, FC = unknown$>$(options)$<$/tt$>$}{<tt>new LRUCache<K, V, FC = unknown>(options)</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20387}
...
Keys and values {\bfseries{must not}} be {\ttfamily null} or {\ttfamily undefined}.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20388}{}\doxysubsection{\texorpdfstring{$<$tt$>$cache.\+max$<$/tt$>$, $<$tt$>$cache.\+max\+Size$<$/tt$>$, $<$tt$>$cache.\+allow\+Stale$<$/tt$>$,}{<tt>cache.max</tt>, <tt>cache.maxSize</tt>, <tt>cache.allowStale</tt>,}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20388}
...
These are intended for read access only. Changing them during program operation can cause undefined behavior.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20389}{}\doxysubsection{\texorpdfstring{$<$tt$>$cache.\+size$<$/tt$>$}{<tt>cache.size</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20389}
The total number of items held in the cache at the current moment.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20390}{}\doxysubsection{\texorpdfstring{$<$tt$>$cache.\+calculated\+Size$<$/tt$>$}{<tt>cache.calculatedSize</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20390}
The total size of items in cache when using size tracking.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20391}{}\doxysubsection{\texorpdfstring{$<$tt$>$set(key, value, \mbox{[}\{ size, size\+Calculation, ttl, no\+Dispose\+On\+Set, start, status \}\mbox{]})$<$/tt$>$}{<tt>set(key, value, [\{ size, sizeCalculation, ttl, noDisposeOnSet, start, status \}])</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20391}
...
If the value is {\ttfamily undefined}, then this is an alias for {\ttfamily cache.\+delete(key)}. {\ttfamily undefined} is never stored in the cache. See {\bfseries{Storing Undefined Values}} below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20392}{}\doxysubsection{\texorpdfstring{$<$tt$>$get(key, \{ update\+Age\+On\+Get, allow\+Stale, status \} = \{\}) =$>$ value$<$/tt$>$}{<tt>get(key, \{ updateAgeOnGet, allowStale, status \} = \{\}) => value</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20392}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20393}{}\doxysubsection{\texorpdfstring{$<$tt$>$info(key) =$>$ Entry \texorpdfstring{$\vert$}{|} undefined$<$/tt$>$}{<tt>info(key) => Entry | undefined</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20393}
...
Note that stale values are always returned, rather than being pruned and treated as if they were not in the cache. If you wish to exclude stale entries, guard against a negative {\ttfamily ttl} value.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20394}{}\doxysubsection{\texorpdfstring{$<$tt$>$async fetch(key, options = \{\}) =$>$ Promise$<$/tt$>$}{<tt>async fetch(key, options = \{\}) => Promise</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20394}
...
If a {\ttfamily signal} is passed to the {\ttfamily fetch()} call, then aborting the signal will abort the fetch and cause the {\ttfamily fetch()} promise to reject with the reason provided.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20395}{}\doxysubsubsection{\texorpdfstring{Setting $<$tt$>$context$<$/tt$>$}{Setting <tt>context</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20395}
...
The {\ttfamily context} param allows you to provide arbitrary data that might be relevant in the course of fetching the data. It is only relevant for the course of a single {\ttfamily fetch()} operation, and discarded afterwards.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20396}{}\doxysubsubsection{\texorpdfstring{Note\+: $<$tt$>$fetch()$<$/tt$>$ calls are inflight-\/unique}{Note: <tt>fetch()</tt> calls are inflight-unique}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20396}
...
{\bfseries{1}}\+: Ie, they\textquotesingle{}re not the "{}same Promise"{}, but they resolve at the same time, because they\textquotesingle{}re both waiting on the same underlying fetch\+Method response.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20397}{}\doxysubsection{\texorpdfstring{$<$tt$>$peek(key, \{ allow\+Stale \} = \{\}) =$>$ value$<$/tt$>$}{<tt>peek(key, \{ allowStale \} = \{\}) => value</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20397}
Like {\ttfamily get()} but doesn\textquotesingle{}t update recency or delete stale items.

Returns {\ttfamily undefined} if the item is stale, unless {\ttfamily allow\+Stale} is set either on the cache or in the options object.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20398}{}\doxysubsection{\texorpdfstring{$<$tt$>$has(key, \{ update\+Age\+On\+Has, status \} = \{\}) =$>$ Boolean$<$/tt$>$}{<tt>has(key, \{ updateAgeOnHas, status \} = \{\}) => Boolean</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20398}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20399}{}\doxysubsection{\texorpdfstring{$<$tt$>$delete(key)$<$/tt$>$}{<tt>delete(key)</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20399}
Deletes a key out of the cache.

Returns {\ttfamily true} if the key was deleted, {\ttfamily false} otherwise.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20400}{}\doxysubsection{\texorpdfstring{$<$tt$>$clear()$<$/tt$>$}{<tt>clear()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20400}
Clear the cache entirely, throwing away all values.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20401}{}\doxysubsection{\texorpdfstring{$<$tt$>$keys()$<$/tt$>$}{<tt>keys()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20401}
Return a generator yielding the keys in the cache, in order from most recently used to least recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20402}{}\doxysubsection{\texorpdfstring{$<$tt$>$rkeys()$<$/tt$>$}{<tt>rkeys()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20402}
Return a generator yielding the keys in the cache, in order from least recently used to most recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20403}{}\doxysubsection{\texorpdfstring{$<$tt$>$values()$<$/tt$>$}{<tt>values()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20403}
Return a generator yielding the values in the cache, in order from most recently used to least recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20404}{}\doxysubsection{\texorpdfstring{$<$tt$>$rvalues()$<$/tt$>$}{<tt>rvalues()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20404}
Return a generator yielding the values in the cache, in order from least recently used to most recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20405}{}\doxysubsection{\texorpdfstring{$<$tt$>$entries()$<$/tt$>$}{<tt>entries()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20405}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from most recently used to least recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20406}{}\doxysubsection{\texorpdfstring{$<$tt$>$rentries()$<$/tt$>$}{<tt>rentries()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20406}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from least recently used to most recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20407}{}\doxysubsection{\texorpdfstring{$<$tt$>$find(fn, \mbox{[}get\+Options\mbox{]})$<$/tt$>$}{<tt>find(fn, [getOptions])</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20407}
...
The optional {\ttfamily get\+Options} are applied to the resulting {\ttfamily get()} of the item found.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20408}{}\doxysubsection{\texorpdfstring{$<$tt$>$dump()$<$/tt$>$}{<tt>dump()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20408}
...
Note\+: this returns an actual array, not a generator, so it can be more easily passed around.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20409}{}\doxysubsection{\texorpdfstring{$<$tt$>$load(entries)$<$/tt$>$}{<tt>load(entries)</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20409}
...
The {\ttfamily start} fields are assumed to be calculated relative to a portable {\ttfamily Date.\+now()} timestamp, even if {\ttfamily performance.\+now()} is available.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20410}{}\doxysubsection{\texorpdfstring{$<$tt$>$purge\+Stale()$<$/tt$>$}{<tt>purgeStale()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20410}
Delete any stale entries. Returns {\ttfamily true} if anything was removed, {\ttfamily false} otherwise.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20411}{}\doxysubsection{\texorpdfstring{$<$tt$>$get\+Remaining\+TTL(key)$<$/tt$>$}{<tt>getRemainingTTL(key)</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20411}
Return the number of ms left in the item\textquotesingle{}s TTL. If item is not in cache, returns {\ttfamily 0}. Returns {\ttfamily Infinity} if item is in cache without a defined TTL.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20412}{}\doxysubsection{\texorpdfstring{$<$tt$>$for\+Each(fn, \mbox{[}thisp\mbox{]})$<$/tt$>$}{<tt>forEach(fn, [thisp])</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20412}
...
If {\ttfamily thisp} is provided, function will be called in the {\ttfamily this}-\/context of the provided object.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20413}{}\doxysubsection{\texorpdfstring{$<$tt$>$rfor\+Each(fn, \mbox{[}thisp\mbox{]})$<$/tt$>$}{<tt>rforEach(fn, [thisp])</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20413}
Same as {\ttfamily cache.\+for\+Each(fn, thisp)}, but in order from least recently used to most recently used.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20414}{}\doxysubsection{\texorpdfstring{$<$tt$>$pop()$<$/tt$>$}{<tt>pop()</tt>}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20414}
Evict the least recently used item, returning its value.

Returns {\ttfamily undefined} if cache is empty.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20415}{}\doxysection{\texorpdfstring{Status Tracking}{Status Tracking}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20415}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20416}{}\doxysection{\texorpdfstring{Storage Bounds Safety}{Storage Bounds Safety}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20416}
...
If that isn\textquotesingle{}t to your liking, check out \href{http://npm.im/@isaacs/ttlcache}{\texttt{ @isaacs/ttlcache}}.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20417}{}\doxysection{\texorpdfstring{Storing Undefined Values}{Storing Undefined Values}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20417}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20418}{}\doxysection{\texorpdfstring{Performance}{Performance}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20418}
...
\end{DoxyEnumerate}\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20419}{}\doxysection{\texorpdfstring{Breaking Changes in Version 7}{Breaking Changes in Version 7}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20419}
...
If you were relying on the internals of LRUCache in version 6 or before, it probably will not work in version 7 and above.\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20420}{}\doxysection{\texorpdfstring{Breaking Changes in Version 8}{Breaking Changes in Version 8}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20420}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20421}{}\doxysection{\texorpdfstring{Changes in Version 9}{Changes in Version 9}}\label{md_node__modules_2path-scurry_2node__modules_2lru-cache_2README_autotoc_md20421}
...
For more info, see the \doxylink{yargs_2CHANGELOG_8md}{change log}. 