...
\hypertarget{md_node__modules_2write-file-atomic_2README}{}\label{md_node__modules_2write-file-atomic_2README}\index{write-\/file-\/atomic@{write-\/file-\/atomic}}
This is an extension for node\textquotesingle{}s {\ttfamily fs.\+write\+File} that makes its operation atomic and allows you set ownership (uid/gid of the file).\hypertarget{md_node__modules_2write-file-atomic_2README_autotoc_md30538}{}\doxysubsection{\texorpdfstring{var write\+File\+Atomic = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{})$<$br$>$write\+File\+Atomic(filename, data, \mbox{[}options\mbox{]}, \mbox{[}callback\mbox{]})}{var writeFileAtomic = require('write-file-atomic')<br>writeFileAtomic(filename, data, [options], [callback])}}\label{md_node__modules_2write-file-atomic_2README_autotoc_md30538}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2write-file-atomic_2README_autotoc_md30539}{}\doxysubsection{\texorpdfstring{var write\+File\+Atomic\+Sync = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{}).\+sync$<$br$>$write\+File\+Atomic\+Sync(filename, data, \mbox{[}options\mbox{]})}{var writeFileAtomicSync = require('write-file-atomic').sync<br>writeFileAtomicSync(filename, data, [options])}}\label{md_node__modules_2write-file-atomic_2README_autotoc_md30539}
