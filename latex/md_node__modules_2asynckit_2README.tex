...
\hypertarget{md_node__modules_2asynckit_2README}{}\label{md_node__modules_2asynckit_2README}\index{asynckit $<$a href="{}https://www.npmjs.com/package/asynckit"{} $>$$<$img src="{}https://img.shields.io/npm/v/asynckit.svg?style=flat"{} alt="{}NPM Module"{}/$>$$<$/a$>$@{asynckit $<$a href=""https://www.npmjs.com/package/asynckit"" $>$$<$img src=""https://img.shields.io/npm/v/asynckit.svg?style=flat"" alt=""NPM Module""/$>$$<$/a$>$}}
\label{md_node__modules_2asynckit_2README_autotoc_md6001}%
\Hypertarget{md_node__modules_2asynckit_2README_autotoc_md6001}%
...
\end{longtabu}
\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6002}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2asynckit_2README_autotoc_md6002}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save\ asynckit}

\end{DoxyCode}
\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6003}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2asynckit_2README_autotoc_md6003}
\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6004}{}\doxysubsection{\texorpdfstring{Parallel Jobs}{Parallel Jobs}}\label{md_node__modules_2asynckit_2README_autotoc_md6004}
Runs iterator over provided array in parallel. Stores output in the {\ttfamily result} array, on the matching positions. In unlikely event of an error from one of the jobs, will terminate rest of the active jobs (if abort function is provided) and return error along with salvaged data to the main callback function.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6005}{}\doxysubsubsection{\texorpdfstring{Input Array}{Input Array}}\label{md_node__modules_2asynckit_2README_autotoc_md6005}
...
More examples could be found in \href{test/test-parallel-array.js}{\texttt{ test/test-\/parallel-\/array.\+js}}.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6006}{}\doxysubsubsection{\texorpdfstring{Input Object}{Input Object}}\label{md_node__modules_2asynckit_2README_autotoc_md6006}
...
More examples could be found in \href{test/test-parallel-object.js}{\texttt{ test/test-\/parallel-\/object.\+js}}.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6007}{}\doxysubsection{\texorpdfstring{Serial Jobs}{Serial Jobs}}\label{md_node__modules_2asynckit_2README_autotoc_md6007}
Runs iterator over provided array sequentially. Stores output in the {\ttfamily result} array, on the matching positions. In unlikely event of an error from one of the jobs, will not proceed to the rest of the items in the list and return error along with salvaged data to the main callback function.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6008}{}\doxysubsubsection{\texorpdfstring{Input Array}{Input Array}}\label{md_node__modules_2asynckit_2README_autotoc_md6008}
...
More examples could be found in \href{test/test-serial-array.js}{\texttt{ test/test-\/serial-\/array.\+js}}.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6009}{}\doxysubsubsection{\texorpdfstring{Input Object}{Input Object}}\label{md_node__modules_2asynckit_2README_autotoc_md6009}
Also it supports named jobs, listed via object.
...
{\itshape Note\+: Since \+\_\+object} is an {\itshape unordered} collection of properties, it may produce unexpected results with sequential iterations. Whenever order of the jobs\textquotesingle{} execution is important please use {\ttfamily serial\+Ordered} method.\+\_\+\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6010}{}\doxysubsection{\texorpdfstring{Ordered Serial Iterations}{Ordered Serial Iterations}}\label{md_node__modules_2asynckit_2README_autotoc_md6010}
TBD

For example \mbox{[}compare-\/property\mbox{]}(compare-\/property) package.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6011}{}\doxysubsection{\texorpdfstring{Streaming interface}{Streaming interface}}\label{md_node__modules_2asynckit_2README_autotoc_md6011}
TBD\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6012}{}\doxysection{\texorpdfstring{Want to Know More?}{Want to Know More?}}\label{md_node__modules_2asynckit_2README_autotoc_md6012}
More examples can be found in \href{test/}{\texttt{ test folder}}.

Or open an \href{https://github.com/alexindigo/asynckit/issues}{\texttt{ issue}} with questions and/or suggestions.\hypertarget{md_node__modules_2asynckit_2README_autotoc_md6013}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2asynckit_2README_autotoc_md6013}
