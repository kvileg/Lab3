...
\hypertarget{md_node__modules_2qs_2README}{}\label{md_node__modules_2qs_2README}\index{qs $<$sup$>$$<$a href="{}https://npmjs.org/package/qs"{} $>$$<$img src="{}https://versionbadg.es/ljharb/qs.svg"{} alt="{}Version Badge"{}/$>$$<$/a$>$$<$/sup$>$@{qs $<$sup$>$$<$a href=""https://npmjs.org/package/qs"" $>$$<$img src=""https://versionbadg.es/ljharb/qs.svg"" alt=""Version Badge""/$>$$<$/a$>$$<$/sup$>$}}
\label{md_node__modules_2qs_2README_autotoc_md22621}%
\Hypertarget{md_node__modules_2qs_2README_autotoc_md22621}%
...
The {\bfseries{qs}} module was originally created and maintained by \href{https://github.com/visionmedia/node-querystring}{\texttt{ TJ Holowaychuk}}.\hypertarget{md_node__modules_2qs_2README_autotoc_md22622}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2qs_2README_autotoc_md22622}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2qs_2README_autotoc_md22623}{}\doxysubsection{\texorpdfstring{Parsing Objects}{Parsing Objects}}\label{md_node__modules_2qs_2README_autotoc_md22623}
...
It also works when the charset has been detected in {\ttfamily charset\+Sentinel} mode.\hypertarget{md_node__modules_2qs_2README_autotoc_md22624}{}\doxysubsection{\texorpdfstring{Parsing Arrays}{Parsing Arrays}}\label{md_node__modules_2qs_2README_autotoc_md22624}
...
\end{DoxyCode}
 ({\itshape this cannot convert nested objects, such as {\ttfamily a=\{b\+:1\},\{c\+:d\}}})\hypertarget{md_node__modules_2qs_2README_autotoc_md22625}{}\doxysubsection{\texorpdfstring{Parsing primitive/scalar values (numbers, booleans, null, etc)}{Parsing primitive/scalar values (numbers, booleans, null, etc)}}\label{md_node__modules_2qs_2README_autotoc_md22625}
...
If you wish to auto-\/convert values which look like numbers, booleans, and other values into their primitive counterparts, you can use the \href{https://github.com/xpepermint/query-types}{\texttt{ query-\/types Express JS middleware}} which will auto-\/convert all request query parameters.\hypertarget{md_node__modules_2qs_2README_autotoc_md22626}{}\doxysubsection{\texorpdfstring{Stringifying}{Stringifying}}\label{md_node__modules_2qs_2README_autotoc_md22626}
\mbox{[}\mbox{]}(\#prevent\+Eval) 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2qs_2README_autotoc_md22627}{}\doxysubsection{\texorpdfstring{Handling of $<$tt$>$null$<$/tt$>$ values}{Handling of <tt>null</tt> values}}\label{md_node__modules_2qs_2README_autotoc_md22627}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2qs_2README_autotoc_md22628}{}\doxysubsection{\texorpdfstring{Dealing with special character sets}{Dealing with special character sets}}\label{md_node__modules_2qs_2README_autotoc_md22628}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2qs_2README_autotoc_md22629}{}\doxysubsection{\texorpdfstring{RFC 3986 and RFC 1738 space encoding}{RFC 3986 and RFC 1738 space encoding}}\label{md_node__modules_2qs_2README_autotoc_md22629}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2qs_2README_autotoc_md22630}{}\doxysection{\texorpdfstring{Security}{Security}}\label{md_node__modules_2qs_2README_autotoc_md22630}
Please email \href{https://github.com/ljharb}{\texttt{ @ljharb}} or see \href{https://tidelift.com/security}{\texttt{ https\+://tidelift.\+com/security}} if you have a potential security vulnerability to report.\hypertarget{md_node__modules_2qs_2README_autotoc_md22631}{}\doxysection{\texorpdfstring{qs for enterprise}{qs for enterprise}}\label{md_node__modules_2qs_2README_autotoc_md22631}
