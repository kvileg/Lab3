...
\hypertarget{md_node__modules_2jsonfile_2README}{}\label{md_node__modules_2jsonfile_2README}\index{Node.js -\/ jsonfile@{Node.js -\/ jsonfile}}
...
\href{https://github.com/feross/standard}{\texttt{ }}\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18429}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_node__modules_2jsonfile_2README_autotoc_md18429}
Writing {\ttfamily JSON.\+stringify()} and then {\ttfamily fs.\+write\+File()} and {\ttfamily JSON.\+parse()} with {\ttfamily fs.\+read\+File()} enclosed in {\ttfamily try/catch} blocks became annoying.\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18430}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2jsonfile_2README_autotoc_md18430}
\begin{DoxyVerb}npm install --save jsonfile
\end{DoxyVerb}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18431}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2jsonfile_2README_autotoc_md18431}
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18433}{}\doxysubsection{\texorpdfstring{read\+File(filename, \mbox{[}options\mbox{]}, callback)}{readFile(filename, [options], callback)}}\label{md_node__modules_2jsonfile_2README_autotoc_md18433}
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18435}{}\doxysubsection{\texorpdfstring{read\+File\+Sync(filename, \mbox{[}options\mbox{]})}{readFileSync(filename, [options])}}\label{md_node__modules_2jsonfile_2README_autotoc_md18435}
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18437}{}\doxysubsection{\texorpdfstring{write\+File(filename, obj, \mbox{[}options\mbox{]}, callback)}{writeFile(filename, obj, [options], callback)}}\label{md_node__modules_2jsonfile_2README_autotoc_md18437}
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18439}{}\doxysubsection{\texorpdfstring{write\+File\+Sync(filename, obj, \mbox{[}options\mbox{]})}{writeFileSync(filename, obj, [options])}}\label{md_node__modules_2jsonfile_2README_autotoc_md18439}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2jsonfile_2README_autotoc_md18440}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2jsonfile_2README_autotoc_md18440}
(MIT License)
