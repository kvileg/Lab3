\chapter{etag}
\hypertarget{md_node__modules_2etag_2README}{}\label{md_node__modules_2etag_2README}\index{etag@{etag}}
\label{md_node__modules_2etag_2README_autotoc_md12649}%
\Hypertarget{md_node__modules_2etag_2README_autotoc_md12649}%
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{md_node__modules_2etag_2README_autotoc_md12650}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2etag_2README_autotoc_md12650}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2README_autotoc_md12651}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2etag_2README_autotoc_md12651}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ etag\ =\ require('etag')}

\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2README_autotoc_md12652}{}\doxysubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, [options])}}\label{md_node__modules_2etag_2README_autotoc_md12652}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2README_autotoc_md12653}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2etag_2README_autotoc_md12653}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md_node__modules_2etag_2README_autotoc_md12654}{}\doxyparagraph{\texorpdfstring{weak}{weak}}\label{md_node__modules_2etag_2README_autotoc_md12654}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md_node__modules_2etag_2README_autotoc_md12655}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2etag_2README_autotoc_md12655}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2README_autotoc_md12656}{}\doxysection{\texorpdfstring{Benchmark}{Benchmark}}\label{md_node__modules_2etag_2README_autotoc_md12656}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2etag_2README_autotoc_md12657}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2etag_2README_autotoc_md12657}
