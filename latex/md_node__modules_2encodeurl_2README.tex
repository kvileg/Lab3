\chapter{encodeurl}
\hypertarget{md_node__modules_2encodeurl_2README}{}\label{md_node__modules_2encodeurl_2README}\index{encodeurl@{encodeurl}}
\label{md_node__modules_2encodeurl_2README_autotoc_md9864}%
\Hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9864}%
...
Encode a URL to a percent-\/encoded form, excluding already-\/encoded sequences\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9865}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2encodeurl_2README_autotoc_md9865}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9866}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2encodeurl_2README_autotoc_md9866}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ encodeUrl\ =\ require('encodeurl')}

\end{DoxyCode}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9867}{}\doxysubsection{\texorpdfstring{encode\+Url(url)}{encodeUrl(url)}}\label{md_node__modules_2encodeurl_2README_autotoc_md9867}
...
This function is {\itshape similar} to the intrinsic function {\ttfamily encode\+URI}, except it will not encode the {\ttfamily \%} character if that is part of a valid sequence, will not encode {\ttfamily \mbox{[}} and {\ttfamily \mbox{]}} (for IPv6 hostnames) and will replace raw, unpaired surrogate pairs with the Unicode replacement character (instead of throwing).\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9868}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2encodeurl_2README_autotoc_md9868}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9869}{}\doxysubsection{\texorpdfstring{Encode a URL containing user-\/controled data}{Encode a URL containing user-controled data}}\label{md_node__modules_2encodeurl_2README_autotoc_md9869}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9870}{}\doxysubsection{\texorpdfstring{Encode a URL for use in a header field}{Encode a URL for use in a header field}}\label{md_node__modules_2encodeurl_2README_autotoc_md9870}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9871}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2encodeurl_2README_autotoc_md9871}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9872}{}\doxysection{\texorpdfstring{References}{References}}\label{md_node__modules_2encodeurl_2README_autotoc_md9872}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2encodeurl_2README_autotoc_md9873}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2encodeurl_2README_autotoc_md9873}
