...
\hypertarget{md_node__modules_2whatwg-mimetype_2README}{}\label{md_node__modules_2whatwg-mimetype_2README}\index{Parse, serialize, and manipulate MIME types@{Parse, serialize, and manipulate MIME types}}
\label{md_node__modules_2whatwg-mimetype_2README_autotoc_md29917}%
\Hypertarget{md_node__modules_2whatwg-mimetype_2README_autotoc_md29917}%
...
{\ttfamily parameters} is also a getter, but the contents of the {\ttfamily MIMEType\+Parameters} object are mutable, as described below.\hypertarget{md_node__modules_2whatwg-mimetype_2README_autotoc_md29921}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_node__modules_2whatwg-mimetype_2README_autotoc_md29921}
...
{\itshape Note\+: the {\ttfamily is\+HTML()}, {\ttfamily is\+XML()}, and {\ttfamily is\+Java\+Script()} methods are speculative, and may be removed or changed in future major versions. See \href{https://github.com/whatwg/mimesniff/issues/48}{\texttt{ whatwg/mimesniff\#48}} for brainstorming in this area. Currently we implement these mainly because they are useful in jsdom.}\hypertarget{md_node__modules_2whatwg-mimetype_2README_autotoc_md29922}{}\doxysection{\texorpdfstring{$<$tt$>$\+MIMEType\+Parameters$<$/tt$>$ API}{<tt>MIMETypeParameters</tt> API}}\label{md_node__modules_2whatwg-mimetype_2README_autotoc_md29922}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2whatwg-mimetype_2README_autotoc_md29923}{}\doxysection{\texorpdfstring{Raw parsing/serialization APIs}{Raw parsing/serialization APIs}}\label{md_node__modules_2whatwg-mimetype_2README_autotoc_md29923}
