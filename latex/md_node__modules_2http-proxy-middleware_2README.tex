...
\hypertarget{md_node__modules_2http-proxy-middleware_2README}{}\label{md_node__modules_2http-proxy-middleware_2README}\index{http-\/proxy-\/middleware@{http-\/proxy-\/middleware}}
\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14947}%
\Hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14947}%
...
Powered by the popular Nodejitsu \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ {\ttfamily http-\/proxy}}}. \href{https://github.com/nodejitsu/node-http-proxy}{\texttt{ }}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14948}{}\doxysection{\texorpdfstring{⚠️ Note $<$!-\/-\/ omit in toc -\/-\/$>$}{⚠️ Note <!-- omit in toc -->}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14948}
...
If you\textquotesingle{}re looking for v0.\+x documentation. Go to\+: \href{https://github.com/chimurai/http-proxy-middleware/tree/v0.21.0\#readme}{\texttt{ https\+://github.\+com/chimurai/http-\/proxy-\/middleware/tree/v0.\+21.\+0\#readme}}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14949}{}\doxysection{\texorpdfstring{TL;\+DR $<$!-\/-\/ omit in toc -\/-\/$>$}{TL;DR <!-- omit in toc -->}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14949}
...
{\itshape All} {\ttfamily http-\/proxy} \href{https://github.com/nodejitsu/node-http-proxy\#options}{\texttt{ options}} can be used, along with some extra {\ttfamily http-\/proxy-\/middleware} \doxylink{md_node__modules_2node-forge_2README_options}{options}.

\+:bulb\+: {\bfseries{Tip\+:}} Set the option {\ttfamily change\+Origin} to {\ttfamily true} for \href{http://en.wikipedia.org/wiki/Virtual_hosting\#Name-based}{\texttt{ name-\/based virtual hosted sites}}.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14950}{}\doxysection{\texorpdfstring{Table of Contents $<$!-\/-\/ omit in toc -\/-\/$>$}{Table of Contents <!-- omit in toc -->}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14950}
...
\item Changelog
\item License
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14951}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14951}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ -\/-\/save-\/dev\ http-\/proxy-\/middleware}

\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14952}{}\doxysection{\texorpdfstring{Core concept}{Core concept}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14952}
Proxy middleware configuration.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14953}{}\doxysubsubsection{\texorpdfstring{create\+Proxy\+Middleware(\mbox{[}context,\mbox{]} config)}{createProxyMiddleware([context,] config)}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14953}
...
(full list of \doxylink{md_node__modules_2node-forge_2README_options}{\`{}http-\/proxy-\/middleware\`{} configuration options})\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14954}{}\doxysubsubsection{\texorpdfstring{create\+Proxy\+Middleware(uri \mbox{[}, config\mbox{]})}{createProxyMiddleware(uri [, config])}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14954}
...
More about the shorthand configuration.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14955}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14955}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14956}{}\doxysection{\texorpdfstring{Context matching}{Context matching}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14956}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14957}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14957}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14958}{}\doxysubsection{\texorpdfstring{http-\/proxy-\/middleware options}{http-proxy-middleware options}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14958}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14959}{}\doxysubsection{\texorpdfstring{http-\/proxy events}{http-proxy events}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14959}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14960}{}\doxysubsection{\texorpdfstring{http-\/proxy options}{http-proxy options}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14960}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14961}{}\doxysection{\texorpdfstring{Shorthand}{Shorthand}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14961}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14962}{}\doxysubsection{\texorpdfstring{app.\+use(path, proxy)}{app.use(path, proxy)}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14962}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14963}{}\doxysection{\texorpdfstring{Web\+Socket}{WebSocket}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14963}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14964}{}\doxysubsection{\texorpdfstring{External Web\+Socket upgrade}{External WebSocket upgrade}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14964}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14965}{}\doxysection{\texorpdfstring{Intercept and manipulate requests}{Intercept and manipulate requests}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14965}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14966}{}\doxysection{\texorpdfstring{Intercept and manipulate responses}{Intercept and manipulate responses}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14966}
...
Check out \href{https://github.com/chimurai/http-proxy-middleware/blob/master/recipes/response-interceptor.md\#readme}{\texttt{ interception recipes}} for more examples.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14967}{}\doxysection{\texorpdfstring{Working examples}{Working examples}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14967}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14968}{}\doxysection{\texorpdfstring{Recipes}{Recipes}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14968}
View the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes}{\texttt{ recipes}} for common use cases.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14969}{}\doxysection{\texorpdfstring{Compatible servers}{Compatible servers}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14969}
...
Sample implementations can be found in the \href{https://github.com/chimurai/http-proxy-middleware/tree/master/recipes/servers.md}{\texttt{ server recipes}}.\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14970}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14970}
Run the test suite\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14971}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14971}

\begin{DoxyItemize}
\item \href{https://github.com/chimurai/http-proxy-middleware/blob/master/CHANGELOG.md}{\texttt{ View changelog}}
\end{DoxyItemize}\hypertarget{md_node__modules_2http-proxy-middleware_2README_autotoc_md14972}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2http-proxy-middleware_2README_autotoc_md14972}
The MIT License (MIT)
