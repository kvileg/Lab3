...
\hypertarget{md_node__modules_2diff-sequences_2README}{}\label{md_node__modules_2diff-sequences_2README}\index{diff-\/sequences@{diff-\/sequences}}
\label{md_node__modules_2diff-sequences_2README_autotoc_md9546}%
\Hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9546}%
...
This package implements the {\bfseries{linear space}} variation with optimizations so it is fast even when sequences have {\bfseries{many}} differences.\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9547}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9547}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9548}{}\doxysection{\texorpdfstring{Example of longest common subsequence}{Example of longest common subsequence}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9548}
...
Various packages which implement the Myers algorithm will {\bfseries{always agree}} on the {\bfseries{length}} of a longest common subsequence, but might {\bfseries{sometimes disagree}} on which {\bfseries{items}} are in it.\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9549}{}\doxysection{\texorpdfstring{Example of callback functions to count common items}{Example of callback functions to count common items}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9549}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9550}{}\doxysection{\texorpdfstring{Example of callback functions to find common items}{Example of callback functions to find common items}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9550}
...
\end{longtabu}
\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9551}{}\doxysection{\texorpdfstring{Example of callback functions to diff index intervals}{Example of callback functions to diff index intervals}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9551}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9552}{}\doxysection{\texorpdfstring{Example of callback functions to emulate diff command}{Example of callback functions to emulate diff command}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9552}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9553}{}\doxysection{\texorpdfstring{Example of callback functions to format diff lines}{Example of callback functions to format diff lines}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9553}
...
\end{longtabu}
\hypertarget{md_node__modules_2diff-sequences_2README_autotoc_md9554}{}\doxysection{\texorpdfstring{Example of callback functions to find diff items}{Example of callback functions to find diff items}}\label{md_node__modules_2diff-sequences_2README_autotoc_md9554}
