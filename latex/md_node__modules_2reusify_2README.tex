\chapter{reusify}
\hypertarget{md_node__modules_2reusify_2README}{}\label{md_node__modules_2reusify_2README}\index{reusify@{reusify}}
\label{md_node__modules_2reusify_2README_autotoc_md23470}%
\Hypertarget{md_node__modules_2reusify_2README_autotoc_md23470}%
...
This library was extracted from \href{http://npm.im/fastparallel}{\texttt{ fastparallel}}.\hypertarget{md_node__modules_2reusify_2README_autotoc_md23471}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_node__modules_2reusify_2README_autotoc_md23471}
...
Also note how in the above examples, the code, that consumes an istance of {\ttfamily My\+Object}, reset the state to initial condition, just before storing it in the cache. That\textquotesingle{}s needed so that every subsequent request for an instance from the cache, could get a clean instance.\hypertarget{md_node__modules_2reusify_2README_autotoc_md23472}{}\doxysection{\texorpdfstring{Why}{Why}}\label{md_node__modules_2reusify_2README_autotoc_md23472}
It is faster because V8 doesn\textquotesingle{}t have to collect all the functions you create. On a short-\/lived benchmark, it is as fast as creating the nested function, but on a longer time frame it creates less pressure on the garbage collector.\hypertarget{md_node__modules_2reusify_2README_autotoc_md23473}{}\doxysection{\texorpdfstring{Other examples}{Other examples}}\label{md_node__modules_2reusify_2README_autotoc_md23473}
If you want to see some complex example, checkout \href{https://github.com/fastify/middie}{\texttt{ middie}} and \href{https://github.com/mcollina/steed}{\texttt{ steed}}.\hypertarget{md_node__modules_2reusify_2README_autotoc_md23474}{}\doxysection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{md_node__modules_2reusify_2README_autotoc_md23474}
Thanks to \href{https://github.com/trevnorris}{\texttt{ Trevor Norris}} for getting me down the rabbit hole of performance, and thanks to \href{http://github.com/mafintosh}{\texttt{ Mathias Buss}} for suggesting me to share this trick.\hypertarget{md_node__modules_2reusify_2README_autotoc_md23475}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2reusify_2README_autotoc_md23475}
MIT 