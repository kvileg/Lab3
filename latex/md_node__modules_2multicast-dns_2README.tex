...
\hypertarget{md_node__modules_2multicast-dns_2README}{}\label{md_node__modules_2multicast-dns_2README}\index{multicast-\/dns@{multicast-\/dns}}
\label{md_node__modules_2multicast-dns_2README_autotoc_md19408}%
\Hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19408}%
...
\href{http://travis-ci.org/mafintosh/multicast-dns}{\texttt{ }}\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19409}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19409}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19410}{}\doxysection{\texorpdfstring{CLI}{CLI}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19410}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19411}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19411}
...
Currently data from {\ttfamily SRV}, {\ttfamily A}, {\ttfamily PTR}, {\ttfamily TXT}, {\ttfamily AAAA} and {\ttfamily HINFO} records is passed\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19412}{}\doxyparagraph{\texorpdfstring{$<$tt$>$mdns = multicastdns(\mbox{[}options\mbox{]})$<$/tt$>$}{<tt>mdns = multicastdns([options])</tt>}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19412}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19413}{}\doxyparagraph{\texorpdfstring{‘mdns.\+on(\textquotesingle{}query’, (packet, rinfo))\`{}}{‘mdns.on('query’, (packet, rinfo))`}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19413}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19414}{}\doxyparagraph{\texorpdfstring{‘mdns.\+on(\textquotesingle{}response’, (packet, rinfo))\`{}}{‘mdns.on('response’, (packet, rinfo))`}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19414}
Emitted when a response packet is received.

The response might not be a response to a query you send as this is the result of someone multicasting a response.\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19415}{}\doxyparagraph{\texorpdfstring{$<$tt$>$mdns.\+query(packet, \mbox{[}cb\mbox{]})$<$/tt$>$}{<tt>mdns.query(packet, [cb])</tt>}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19415}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19416}{}\doxyparagraph{\texorpdfstring{$<$tt$>$mdns.\+respond(packet, \mbox{[}cb\mbox{]})$<$/tt$>$}{<tt>mdns.respond(packet, [cb])</tt>}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19416}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19417}{}\doxyparagraph{\texorpdfstring{$<$tt$>$mdns.\+destroy()$<$/tt$>$}{<tt>mdns.destroy()</tt>}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19417}
Destroy the mdns instance. Closes the udp socket.\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19418}{}\doxysection{\texorpdfstring{Development}{Development}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19418}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2multicast-dns_2README_autotoc_md19419}{}\doxysubsection{\texorpdfstring{License}{License}}\label{md_node__modules_2multicast-dns_2README_autotoc_md19419}
MIT 