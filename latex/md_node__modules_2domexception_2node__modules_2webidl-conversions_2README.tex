...
\hypertarget{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README}{}\label{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README}\index{Web IDL Type Conversions on JavaScript Values@{Web IDL Type Conversions on JavaScript Values}}
\label{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9637}%
\Hypertarget{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9637}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9638}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9638}
...
Derived types, such as nullable types, promise types, sequences, records, etc. are not handled by this library. You may wish to investigate the \href{https://github.com/jsdom/webidl2js}{\texttt{ webidl2js}} project.\hypertarget{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9640}{}\doxysubsection{\texorpdfstring{A note on the $<$tt$>$long long$<$/tt$>$ types}{A note on the <tt>long long</tt> types}}\label{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9640}
...
This library actually doesn\textquotesingle{}t even get that far. Producing those results would require doing accurate modular arithmetic on 64-\/bit intermediate values, but Java\+Script does not make this easy. We could pull in a big-\/integer library as a dependency, but in lieu of that, we for now have decided to just produce inaccurate results if you pass in numbers that are not strictly between {\ttfamily Number.\+MIN\+\_\+\+SAFE\+\_\+\+INTEGER} and {\ttfamily Number.\+MAX\+\_\+\+SAFE\+\_\+\+INTEGER}.\hypertarget{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9641}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_node__modules_2domexception_2node__modules_2webidl-conversions_2README_autotoc_md9641}
