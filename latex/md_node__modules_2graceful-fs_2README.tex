\chapter{graceful-\/fs}
\hypertarget{md_node__modules_2graceful-fs_2README}{}\label{md_node__modules_2graceful-fs_2README}\index{graceful-\/fs@{graceful-\/fs}}
\label{md_node__modules_2graceful-fs_2README_autotoc_md14599}%
\Hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14599}%
 graceful-\/fs functions as a drop-\/in replacement for the fs module, making various improvements.

The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14600}{}\doxysection{\texorpdfstring{Improvements over $<$a href="{}https\+://nodejs.\+org/api/fs.\+html"{} $>$fs module$<$/a$>$}{Improvements over <a href="https://nodejs.org/api/fs.html" >fs module</a>}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14600}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily EACCESS} or {\ttfamily EPERM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14601}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14601}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14602}{}\doxysection{\texorpdfstring{Sync methods}{Sync methods}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14602}
...
This is a known limitation, not a bug.\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14603}{}\doxysection{\texorpdfstring{Global Patching}{Global Patching}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14603}
...
This should only ever be done at the top-\/level application layer, in order to delay on EMFILE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14604}{}\doxysection{\texorpdfstring{Changes}{Changes}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14604}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of Node from 0.\+8 through 7.\+0.\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14605}{}\doxysubsection{\texorpdfstring{v4}{v4}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14605}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14606}{}\doxysubsection{\texorpdfstring{v3}{v3}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14606}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14607}{}\doxysubsection{\texorpdfstring{v2.\+1.\+0}{v2.1.0}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14607}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14608}{}\doxysubsection{\texorpdfstring{v2.\+0}{v2.0}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14608}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14609}{}\doxysubsection{\texorpdfstring{v1.\+1}{v1.1}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14609}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2graceful-fs_2README_autotoc_md14610}{}\doxysubsection{\texorpdfstring{1.\+0}{1.0}}\label{md_node__modules_2graceful-fs_2README_autotoc_md14610}
