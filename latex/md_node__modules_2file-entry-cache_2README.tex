...
\hypertarget{md_node__modules_2file-entry-cache_2README}{}\label{md_node__modules_2file-entry-cache_2README}\index{file-\/entry-\/cache@{file-\/entry-\/cache}}
\label{md_node__modules_2file-entry-cache_2README_autotoc_md13364}%
\Hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13364}%
\begin{quote}
...
\href{https://npmjs.org/package/file-entry-cache}{\texttt{ }} \href{https://travis-ci.org/royriojas/file-entry-cache}{\texttt{ }}\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13365}{}\doxysection{\texorpdfstring{install}{install}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13365}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ file-\/entry-\/cache}

\end{DoxyCode}
\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13366}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13366}
The module exposes two functions {\ttfamily create} and {\ttfamily create\+From\+File}.\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13367}{}\doxysection{\texorpdfstring{$<$tt$>$create(cache\+Name, \mbox{[}directory, use\+Check\+Sum\mbox{]})$<$/tt$>$}{<tt>create(cacheName, [directory, useCheckSum])</tt>}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13367}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13368}{}\doxysection{\texorpdfstring{$<$tt$>$create\+From\+File(path\+To\+Cache, \mbox{[}use\+Check\+Sum\mbox{]})$<$/tt$>$}{<tt>createFromFile(pathToCache, [useCheckSum])</tt>}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13368}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13369}{}\doxysection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13369}
...
In the worst case scenario all the files will be processed. In the best case scenario only a few of them will be processed.\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13370}{}\doxysection{\texorpdfstring{Important notes}{Important notes}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13370}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2file-entry-cache_2README_autotoc_md13371}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2file-entry-cache_2README_autotoc_md13371}
MIT 