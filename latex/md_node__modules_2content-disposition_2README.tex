...
\hypertarget{md_node__modules_2content-disposition_2README}{}\label{md_node__modules_2content-disposition_2README}\index{content-\/disposition@{content-\/disposition}}
\label{md_node__modules_2content-disposition_2README_autotoc_md8173}%
\Hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8173}%
...
Create and parse HTTP {\ttfamily Content-\/\+Disposition} header\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8174}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2content-disposition_2README_autotoc_md8174}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ content-\/disposition}

\end{DoxyCode}
\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8175}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2content-disposition_2README_autotoc_md8175}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ contentDisposition\ =\ require('content-\/disposition')}

\end{DoxyCode}
\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8176}{}\doxysubsection{\texorpdfstring{content\+Disposition(filename, options)}{contentDisposition(filename, options)}}\label{md_node__modules_2content-disposition_2README_autotoc_md8176}
...
{\bfseries{note}} HTTP headers are of the ISO-\/8859-\/1 character set. If you are writing this header through a means different from {\ttfamily set\+Header} in Node.\+js, you\textquotesingle{}ll want to specify the `\textquotesingle{}binary'\`{} encoding in Node.\+js.\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8177}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2content-disposition_2README_autotoc_md8177}
{\ttfamily content\+Disposition} accepts these properties in the options object.\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8178}{}\doxyparagraph{\texorpdfstring{fallback}{fallback}}\label{md_node__modules_2content-disposition_2README_autotoc_md8178}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8181}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2content-disposition_2README_autotoc_md8181}
\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8182}{}\doxysubsection{\texorpdfstring{Send a file for download}{Send a file for download}}\label{md_node__modules_2content-disposition_2README_autotoc_md8182}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8183}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2content-disposition_2README_autotoc_md8183}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8184}{}\doxysection{\texorpdfstring{References}{References}}\label{md_node__modules_2content-disposition_2README_autotoc_md8184}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2content-disposition_2README_autotoc_md8185}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2content-disposition_2README_autotoc_md8185}
