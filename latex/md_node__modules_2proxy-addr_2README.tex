\chapter{proxy-\/addr}
\hypertarget{md_node__modules_2proxy-addr_2README}{}\label{md_node__modules_2proxy-addr_2README}\index{proxy-\/addr@{proxy-\/addr}}
\label{md_node__modules_2proxy-addr_2README_autotoc_md22413}%
\Hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22413}%
...
Determine address of proxied request\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22414}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22414}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22415}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22415}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ proxyaddr\ =\ require('proxy-\/addr')}

\end{DoxyCode}
\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22416}{}\doxysubsection{\texorpdfstring{proxyaddr(req, trust)}{proxyaddr(req, trust)}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22416}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22418}{}\doxysubsection{\texorpdfstring{proxyaddr.\+compile(val)}{proxyaddr.compile(val)}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22418}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22419}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22419}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22420}{}\doxysection{\texorpdfstring{Benchmarks}{Benchmarks}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22420}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ run-\/script\ bench}

\end{DoxyCode}
\hypertarget{md_node__modules_2proxy-addr_2README_autotoc_md22421}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2proxy-addr_2README_autotoc_md22421}
