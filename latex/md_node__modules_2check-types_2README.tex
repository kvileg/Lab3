...
\hypertarget{md_node__modules_2check-types_2README}{}\label{md_node__modules_2check-types_2README}\index{check-\/types.js@{check-\/types.js}}
\label{md_node__modules_2check-types_2README_autotoc_md7098}%
\Hypertarget{md_node__modules_2check-types_2README_autotoc_md7098}%
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7099}{}\doxysection{\texorpdfstring{Why would I want that?}{Why would I want that?}}\label{md_node__modules_2check-types_2README_autotoc_md7099}
...
The purpose of check-\/types.\+js is to remove this burden from Java\+Script application developers in an efficient and robust manner, abstracted by a simple API.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7100}{}\doxysection{\texorpdfstring{How little is it?}{How little is it?}}\label{md_node__modules_2check-types_2README_autotoc_md7100}
25 kb unminified with comments, 7.\+4 kb minified, 2.\+5 kb minified + gzipped.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7101}{}\doxysection{\texorpdfstring{How do I install it?}{How do I install it?}}\label{md_node__modules_2check-types_2README_autotoc_md7101}
Via npm\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2check-types_2README_autotoc_md7102}{}\doxysection{\texorpdfstring{How do I use it?}{How do I use it?}}\label{md_node__modules_2check-types_2README_autotoc_md7102}
\hypertarget{md_node__modules_2check-types_2README_autotoc_md7103}{}\doxysubsection{\texorpdfstring{Loading the library}{Loading the library}}\label{md_node__modules_2check-types_2README_autotoc_md7103}
...
If you are including check-\/types.\+js with an HTML {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tag, or neither of the above environments are detected, it will export the interface globally as {\ttfamily check}.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7104}{}\doxysubsection{\texorpdfstring{Calling the exported functions}{Calling the exported functions}}\label{md_node__modules_2check-types_2README_autotoc_md7104}
...
Additionally, there are some batch operations to help you apply predicates to each value of an array or object. These are implemented by {\ttfamily check.\+map}, {\ttfamily check.\+any} and {\ttfamily check.\+all}.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7105}{}\doxysubsubsection{\texorpdfstring{General predicates}{General predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7105}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7106}{}\doxysubsubsection{\texorpdfstring{String predicates}{String predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7106}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7107}{}\doxysubsubsection{\texorpdfstring{Number predicates}{Number predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7107}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7108}{}\doxysubsubsection{\texorpdfstring{Boolean predicates}{Boolean predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7108}

\begin{DoxyItemize}
\item {\ttfamily check.\+boolean(thing)}\+: Returns {\ttfamily true} if {\ttfamily thing} is a boolean, {\ttfamily false} otherwise.
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7109}{}\doxysubsubsection{\texorpdfstring{Object predicates}{Object predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7109}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7110}{}\doxysubsubsection{\texorpdfstring{Array predicates}{Array predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7110}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7111}{}\doxysubsubsection{\texorpdfstring{Date predicates}{Date predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7111}

\begin{DoxyItemize}
\item {\ttfamily check.\+date(thing)}\+: Returns {\ttfamily true} if {\ttfamily thing} is a valid date, {\ttfamily false} otherwise.
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7112}{}\doxysubsubsection{\texorpdfstring{Function predicates}{Function predicates}}\label{md_node__modules_2check-types_2README_autotoc_md7112}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7113}{}\doxysubsubsection{\texorpdfstring{Modifiers}{Modifiers}}\label{md_node__modules_2check-types_2README_autotoc_md7113}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7114}{}\doxysubsubsection{\texorpdfstring{Batch operations}{Batch operations}}\label{md_node__modules_2check-types_2README_autotoc_md7114}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2check-types_2README_autotoc_md7115}{}\doxysubsection{\texorpdfstring{Some examples}{Some examples}}\label{md_node__modules_2check-types_2README_autotoc_md7115}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2check-types_2README_autotoc_md7116}{}\doxysection{\texorpdfstring{Are there Type\+Script definitions?}{Are there TypeScript definitions?}}\label{md_node__modules_2check-types_2README_autotoc_md7116}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2check-types_2README_autotoc_md7117}{}\doxysection{\texorpdfstring{Where can I use it?}{Where can I use it?}}\label{md_node__modules_2check-types_2README_autotoc_md7117}
...
See the \href{https://gitlab.com/philbooth/check-types.js/tags}{\texttt{ releases}} for more information.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7118}{}\doxysection{\texorpdfstring{What changed from 10.\+x to 11.\+x?}{What changed from 10.x to 11.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7118}
...
See the \href{HISTORY.md\#anchor-1100}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7119}{}\doxysection{\texorpdfstring{What changed from 9.\+x to 10.\+x?}{What changed from 9.x to 10.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7119}
...
See the \href{HISTORY.md\#anchor-1000}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7120}{}\doxysection{\texorpdfstring{What changed from 8.\+x to 9.\+x?}{What changed from 8.x to 9.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7120}
...
See the \href{HISTORY.md\#anchor-900}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7121}{}\doxysection{\texorpdfstring{What changed from 7.\+x to 8.\+x?}{What changed from 7.x to 8.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7121}
...
See the \href{HISTORY.md\#anchor-800}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7122}{}\doxysection{\texorpdfstring{What changed from 6.\+x to 7.\+x?}{What changed from 6.x to 7.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7122}
...
See the \href{HISTORY.md\#anchor-70}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7123}{}\doxysection{\texorpdfstring{What changed from 5.\+x to 6.\+x?}{What changed from 5.x to 6.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7123}
...
See the \href{HISTORY.md\#anchor-60}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7124}{}\doxysection{\texorpdfstring{What changed from 4.\+x to 5.\+x?}{What changed from 4.x to 5.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7124}
...
See the \href{HISTORY.md\#anchor-50}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7125}{}\doxysection{\texorpdfstring{What changed from 3.\+x to 4.\+x?}{What changed from 3.x to 4.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7125}
...
See the \href{HISTORY.md\#anchor-40}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7126}{}\doxysection{\texorpdfstring{What changed from 2.\+x to 3.\+x?}{What changed from 2.x to 3.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7126}
...
See the \href{HISTORY.md\#anchor-30}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7127}{}\doxysection{\texorpdfstring{What changed from 1.\+x to 2.\+x?}{What changed from 1.x to 2.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7127}
...
See the \href{HISTORY.md\#anchor-20}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7128}{}\doxysection{\texorpdfstring{What changed from 0.\+x to 1.\+x?}{What changed from 0.x to 1.x?}}\label{md_node__modules_2check-types_2README_autotoc_md7128}
...
See the \href{HISTORY.md\#anchor-10}{\texttt{ history}} for more details.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7129}{}\doxysection{\texorpdfstring{How do I set up the build environment?}{How do I set up the build environment?}}\label{md_node__modules_2check-types_2README_autotoc_md7129}
...
The unit tests are in {\ttfamily test/check-\/types.\+js}. You can run them with the command {\ttfamily npm test}. To run the tests in a web browser, open {\ttfamily test/check-\/types.\+html}.\hypertarget{md_node__modules_2check-types_2README_autotoc_md7130}{}\doxysection{\texorpdfstring{What license is it released under?}{What license is it released under?}}\label{md_node__modules_2check-types_2README_autotoc_md7130}
