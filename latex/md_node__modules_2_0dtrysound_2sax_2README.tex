\chapter{svg/sax}
\hypertarget{md_node__modules_2_0dtrysound_2sax_2README}{}\label{md_node__modules_2_0dtrysound_2sax_2README}\index{svg/sax@{svg/sax}}
\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3192}%
\Hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3192}%
 A maintained fork of \href{https://github.com/isaacs/sax-js}{\texttt{ sax-\/js}} sax-\/style parser for XML and HTML.

Designed with \href{http://nodejs.org/}{\texttt{ node}} in mind, but should work fine in the browser or other Common\+JS implementations.\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3193}{}\doxysection{\texorpdfstring{What This Is}{What This Is}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3193}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3194}{}\doxysection{\texorpdfstring{What This Is (probably) Not}{What This Is (probably) Not}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3194}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3195}{}\doxysection{\texorpdfstring{Regarding $<$tt$>$$<$!\+DOCTYPE$<$/tt$>$s and $<$tt$>$$<$!\+ENTITY$<$/tt$>$s}{Regarding <tt><!DOCTYPE</tt>s and <tt><!ENTITY</tt>s}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3195}
...
Unknown entities will fail in strict mode, and in loose mode, will pass through unmolested.\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3196}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3196}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3197}{}\doxysection{\texorpdfstring{Arguments}{Arguments}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3197}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3198}{}\doxysection{\texorpdfstring{Methods}{Methods}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3198}
...
{\ttfamily resume} -\/ To gracefully handle errors, assign a listener to the {\ttfamily error} event. Then, when the error is taken care of, you can call {\ttfamily resume} to continue parsing. Otherwise, the parser will not continue while in an error state.\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3199}{}\doxysection{\texorpdfstring{Members}{Members}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3199}
...
And a bunch of other stuff that you probably shouldn\textquotesingle{}t touch.\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3200}{}\doxysection{\texorpdfstring{Events}{Events}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3200}
...
{\ttfamily noscript} -\/ In non-\/strict mode, {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tags trigger a {\ttfamily "{}script"{}} event, and their contents are not checked for special xml characters. If you pass {\ttfamily noscript\+: true}, then this behavior is suppressed.\hypertarget{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3201}{}\doxysection{\texorpdfstring{Reporting Problems}{Reporting Problems}}\label{md_node__modules_2_0dtrysound_2sax_2README_autotoc_md3201}
