...
\hypertarget{md_node__modules_2js-tokens_2README}{}\label{md_node__modules_2js-tokens_2README}\index{Overview $<$a href="{}https://travis-\/ci.org/lydell/js-\/tokens"{} $>$$<$img src="{}https://travis-\/ci.org/lydell/js-\/tokens.svg?branch=master"{} alt="{}Build Status"{}/$>$$<$/a$>$@{Overview $<$a href=""https://travis-\/ci.org/lydell/js-\/tokens"" $>$$<$img src=""https://travis-\/ci.org/lydell/js-\/tokens.svg?branch=master"" alt=""Build Status""/$>$$<$/a$>$}}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2js-tokens_2README_autotoc_md18091}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2js-tokens_2README_autotoc_md18091}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2js-tokens_2README_autotoc_md18092}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2js-tokens_2README_autotoc_md18092}
\hypertarget{md_node__modules_2js-tokens_2README_autotoc_md18093}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$js\+Tokens$<$/tt$>$}{<tt>jsTokens</tt>}}\label{md_node__modules_2js-tokens_2README_autotoc_md18093}
...
The next match is always directly after the previous.\hypertarget{md_node__modules_2js-tokens_2README_autotoc_md18094}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$var token = match\+To\+Token(match)$<$/tt$>$}{<tt>var token = matchToToken(match)</tt>}}\label{md_node__modules_2js-tokens_2README_autotoc_md18094}
