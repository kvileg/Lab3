...
\hypertarget{md_node__modules_2json-schema-traverse_2README}{}\label{md_node__modules_2json-schema-traverse_2README}\index{json-\/schema-\/traverse@{json-\/schema-\/traverse}}
\label{md_node__modules_2json-schema-traverse_2README_autotoc_md18352}%
\Hypertarget{md_node__modules_2json-schema-traverse_2README_autotoc_md18352}%
Traverse JSON Schema passing each schema object to callback

\href{https://travis-ci.org/epoberezkin/json-schema-traverse}{\texttt{ }} \href{https://www.npmjs.com/package/json-schema-traverse}{\texttt{ }} \href{https://coveralls.io/github/epoberezkin/json-schema-traverse?branch=master}{\texttt{ }}\hypertarget{md_node__modules_2json-schema-traverse_2README_autotoc_md18353}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2json-schema-traverse_2README_autotoc_md18353}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ install\ json-\/schema-\/traverse}

\end{DoxyCode}
\hypertarget{md_node__modules_2json-schema-traverse_2README_autotoc_md18354}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2json-schema-traverse_2README_autotoc_md18354}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2json-schema-traverse_2README_autotoc_md18355}{}\doxysection{\texorpdfstring{Traverse objects in all unknown keywords}{Traverse objects in all unknown keywords}}\label{md_node__modules_2json-schema-traverse_2README_autotoc_md18355}
...
Without option {\ttfamily all\+Keys\+: true} callback will be called only with root schema.\hypertarget{md_node__modules_2json-schema-traverse_2README_autotoc_md18356}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2json-schema-traverse_2README_autotoc_md18356}
