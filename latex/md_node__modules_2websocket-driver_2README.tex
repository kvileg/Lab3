...
\hypertarget{md_node__modules_2websocket-driver_2README}{}\label{md_node__modules_2websocket-driver_2README}\index{websocket-\/driver $<$a href="{}https://travis-\/ci.org/faye/websocket-\/driver-\/node"{} $>$$<$img src="{}https://travis-\/ci.org/faye/websocket-\/driver-\/node.svg"{} alt="{}Build Status"{}/$>$$<$/a$>$@{websocket-\/driver $<$a href=""https://travis-\/ci.org/faye/websocket-\/driver-\/node"" $>$$<$img src=""https://travis-\/ci.org/faye/websocket-\/driver-\/node.svg"" alt=""Build Status""/$>$$<$/a$>$}}
\label{md_node__modules_2websocket-driver_2README_autotoc_md29802}%
\Hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29802}%
...
This library was originally extracted from the \href{http://faye.jcoglan.com}{\texttt{ Faye}} project but now aims to provide simple Web\+Socket support for any Node-\/based project.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29803}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29803}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ websocket-\/driver}

\end{DoxyCode}
\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29804}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29804}
This module provides protocol drivers that have the same interface on the server and on the client. A Web\+Socket driver is an object with two duplex streams attached; one for incoming/outgoing messages and one for managing the wire protocol over an I/O stream. The full API is described below.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29805}{}\doxysubsection{\texorpdfstring{Server-\/side with HTTP}{Server-side with HTTP}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29805}
...
Note the line {\ttfamily driver.\+io.\+write(body)} -\/ you must pass the {\ttfamily body} buffer to the socket driver in order to make certain versions of the protocol work.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29806}{}\doxysubsection{\texorpdfstring{Server-\/side with TCP}{Server-side with TCP}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29806}
...
If the request has a body, it will be in the {\ttfamily driver.\+body} buffer, but only as much of the body as has been piped into the driver when the {\ttfamily connect} event fires.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29807}{}\doxysubsection{\texorpdfstring{Client-\/side}{Client-side}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29807}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29808}{}\doxysubsection{\texorpdfstring{HTTP Proxies}{HTTP Proxies}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29808}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29809}{}\doxysubsection{\texorpdfstring{Driver API}{Driver API}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29809}
...
Note that most of these methods are commands\+: if they produce data that should be sent over the socket, they will give this to you by emitting {\ttfamily data} events on the {\ttfamily driver.\+io} stream.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29810}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}open’, function(event) \{\})\`{}}{‘driver.on('open’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29810}
Adds a callback to execute when the socket becomes open.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29811}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}message’, function(event) \{\})\`{}}{‘driver.on('message’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29811}
...
You can also listen for messages using the `driver.\+messages.\+on(\textquotesingle{}data')\`{} event, which emits strings for text messages and buffers for binary messages.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29812}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}error’, function(event) \{\})\`{}}{‘driver.on('error’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29812}
Adds a callback to execute when a protocol error occurs due to the other peer sending an invalid byte sequence. {\ttfamily event} will have a {\ttfamily message} attribute describing the error.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29813}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}close’, function(event) \{\})\`{}}{‘driver.on('close’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29813}
Adds a callback to execute when the socket becomes closed. The {\ttfamily event} object has {\ttfamily code} and {\ttfamily reason} attributes.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29814}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}ping’, function(event) \{\})\`{}}{‘driver.on('ping’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29814}
Adds a callback block to execute when a ping is received. You do not need to handle this by sending a pong frame yourself; the driver handles this for you.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29815}{}\doxysubsubsection{\texorpdfstring{‘driver.\+on(\textquotesingle{}pong’, function(event) \{\})\`{}}{‘driver.on('pong’, function(event) \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29815}
Adds a callback block to execute when a pong is received. If this was in response to a ping you sent, you can also handle this event via the {\ttfamily driver.\+ping(message, function() \{ ... \})} callback.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29816}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+add\+Extension(extension)$<$/tt$>$}{<tt>driver.addExtension(extension)</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29816}
Registers a protocol extension whose operation will be negotiated via the {\ttfamily Sec-\/\+Web\+Socket-\/\+Extensions} header. {\ttfamily extension} is any extension compatible with the \href{https://github.com/faye/websocket-extensions-node}{\texttt{ websocket-\/extensions}} framework.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29817}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+set\+Header(name, value)$<$/tt$>$}{<tt>driver.setHeader(name, value)</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29817}
Sets a custom header to be sent as part of the handshake response, either from the server or from the client. Must be called before {\ttfamily start()}, since this is when the headers are serialized and sent.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29818}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+start()$<$/tt$>$}{<tt>driver.start()</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29818}
Initiates the protocol by sending the handshake -\/ either the response for a server-\/side driver or the request for a client-\/side one. This should be the first method you invoke. Returns {\ttfamily true} if and only if a handshake was sent.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29819}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+parse(string)$<$/tt$>$}{<tt>driver.parse(string)</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29819}
Takes a string and parses it, potentially resulting in message events being emitted (see `on(\textquotesingle{}message'){\ttfamily above) or in data being sent to}driver.\+io{\ttfamily . You should send all data you receive via I/O to this method by piping a stream into }driver.\+io\`{}.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29820}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+text(string)$<$/tt$>$}{<tt>driver.text(string)</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29820}
...
This method is equivalent to {\ttfamily driver.\+messages.\+write(string)}.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29821}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+binary(buffer)$<$/tt$>$}{<tt>driver.binary(buffer)</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29821}
...
This method is equivalent to {\ttfamily driver.\+messages.\+write(buffer)}.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29822}{}\doxysubsubsection{\texorpdfstring{‘driver.\+ping(string = ’\textquotesingle{}, function() \{\})\`{}}{‘driver.ping(string = ’', function() \{\})`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29822}
Sends a ping frame over the socket, queueing it if necessary. {\ttfamily string} and the callback are both optional. If a callback is given, it will be invoked when the socket receives a pong frame whose content matches {\ttfamily string}. Returns {\ttfamily false} if frames can no longer be sent, or if the driver does not support ping/pong.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29823}{}\doxysubsubsection{\texorpdfstring{‘driver.\+pong(string = ’\textquotesingle{})\`{}}{‘driver.pong(string = ’')`}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29823}
...
You don\textquotesingle{}t need to call this when a ping frame is received; pings are replied to automatically by the driver. This method is for sending unsolicited pongs.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29824}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+close()$<$/tt$>$}{<tt>driver.close()</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29824}
Initiates the closing handshake if the socket is still open. For drivers with no closing handshake, this will result in the immediate execution of the `on(\textquotesingle{}close'){\ttfamily driver. For drivers with a closing handshake, this sends a closing frame and}emit(\textquotesingle{}close\textquotesingle{})\`{} will execute when a response is received or a protocol error occurs.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29825}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+version$<$/tt$>$}{<tt>driver.version</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29825}
Returns the Web\+Socket version in use as a string. Will either be {\ttfamily hixie-\/75}, {\ttfamily hixie-\/76} or {\ttfamily hybi-\/\$version}.\hypertarget{md_node__modules_2websocket-driver_2README_autotoc_md29826}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$driver.\+protocol$<$/tt$>$}{<tt>driver.protocol</tt>}}\label{md_node__modules_2websocket-driver_2README_autotoc_md29826}
