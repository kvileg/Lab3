...
\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features}{}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features}\index{Advanced Features@{Advanced Features}}
\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23280}%
\Hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23280}%
...
\end{DoxyItemize}\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23281}{}\doxysection{\texorpdfstring{What is the "{}join"{} function?}{What is the "join" function?}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23281}
...
A custom {\ttfamily join} function from scratch is possible but we\textquotesingle{}ve provided some building blocks to make the task easier.\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23282}{}\doxysection{\texorpdfstring{Building blocks}{Building blocks}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23282}
...
Don\textquotesingle{}t worry, you don\textquotesingle{}t need to use {\ttfamily function\texorpdfstring{$\ast$}{*}} semantics for the {\ttfamily generator} unless you want to.\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23283}{}\doxysection{\texorpdfstring{Simple customisation}{Simple customisation}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23283}
...
See the reference or jump directly to the examples.\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23284}{}\doxysubsection{\texorpdfstring{Reference}{Reference}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23284}
...
\end{DoxyItemize}\end{adjustwidth}
\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23285}{}\doxysubsection{\texorpdfstring{How to\+: change precedence of source locations}{How to: change precedence of source locations}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23285}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23286}{}\doxysubsection{\texorpdfstring{How to\+: fallback to a theme or other global directory}{How to: fallback to a theme or other global directory}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23286}
...
\item The {\ttfamily as\+Generator} utility allows us to return simple {\ttfamily Array\texorpdfstring{$<$}{<}string\texorpdfstring{$>$}{>}} of potential base paths.
\end{DoxyItemize}\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23287}{}\doxysubsection{\texorpdfstring{How to\+: fallback to some other asset file}{How to: fallback to some other asset file}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23287}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23288}{}\doxysubsection{\texorpdfstring{How to\+: perform a file-\/system search for an asset}{How to: perform a file-system search for an asset}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23288}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23289}{}\doxysection{\texorpdfstring{Full customisation}{Full customisation}}\label{md_node__modules_2resolve-url-loader_2docs_2advanced-features_autotoc_md23289}
