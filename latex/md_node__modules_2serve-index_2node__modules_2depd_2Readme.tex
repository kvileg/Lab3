\chapter{depd}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme}{}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme}\index{depd@{depd}}
\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25731}%
\Hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25731}%
...
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25732}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25732}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25733}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25733}
...
{\bfseries{NOTE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25734}{}\doxysubsection{\texorpdfstring{depd(namespace)}{depd(namespace)}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25734}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25735}{}\doxysubsection{\texorpdfstring{deprecate(message)}{deprecate(message)}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25735}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25736}{}\doxysubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.function(fn, message)}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25736}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25737}{}\doxysubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.property(obj, prop, message)}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25737}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25738}{}\doxysubsection{\texorpdfstring{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}{process.on('deprecation', fn)}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25738}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25739}{}\doxysubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.env.NO\_DEPRECATION}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25739}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25740}{}\doxysubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.env.TRACE\_DEPRECATION}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25740}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25741}{}\doxysection{\texorpdfstring{Display}{Display}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25741}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25742}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25742}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25743}{}\doxysubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25743}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25744}{}\doxysubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25744}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25745}{}\doxysubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25745}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25746}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2serve-index_2node__modules_2depd_2Readme_autotoc_md25746}
