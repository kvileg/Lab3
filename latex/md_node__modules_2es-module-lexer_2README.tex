...
\hypertarget{md_node__modules_2es-module-lexer_2README}{}\label{md_node__modules_2es-module-lexer_2README}\index{ES Module Lexer@{ES Module Lexer}}
\label{md_node__modules_2es-module-lexer_2README_autotoc_md10084}%
\Hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10084}%
...
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10085}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10085}
...
See \href{types/lexer.d.ts}{\texttt{ types/lexer.\+d.\+ts}} for the type definitions.
...
\end{DoxyCode}
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10086}{}\doxysubsection{\texorpdfstring{CSP asm.\+js Build}{CSP asm.js Build}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10086}
...
Instead of Web Assembly, this uses an asm.\+js build which is almost as fast as the Wasm version (see benchmarks below).\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10087}{}\doxysubsection{\texorpdfstring{Escape Sequences}{Escape Sequences}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10087}
...
For dynamic import expressions, this field will be empty if not a valid JS string.\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10088}{}\doxysubsection{\texorpdfstring{Facade Detection}{Facade Detection}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10088}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10089}{}\doxysubsection{\texorpdfstring{ESM Detection}{ESM Detection}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10089}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10090}{}\doxysubsection{\texorpdfstring{Environment Support}{Environment Support}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10090}
Node.\+js 10+, and \href{https://caniuse.com/\#feat=wasm}{\texttt{ all browsers with Web Assembly support}}.\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10091}{}\doxysubsection{\texorpdfstring{Grammar Support}{Grammar Support}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10091}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10092}{}\doxysubsection{\texorpdfstring{Limitations}{Limitations}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10092}
...
The above cases are handled gracefully in that the lexer will keep going fine, it will just not properly detect the export names above.\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10093}{}\doxysubsection{\texorpdfstring{Benchmarks}{Benchmarks}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10093}
Benchmarks can be run with {\ttfamily npm run bench}.

Current results for a high spec machine\+:\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10094}{}\doxysubsubsection{\texorpdfstring{Wasm Build}{Wasm Build}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10094}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10095}{}\doxysubsubsection{\texorpdfstring{JS Build (asm.\+js)}{JS Build (asm.js)}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10095}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10096}{}\doxysubsection{\texorpdfstring{Building}{Building}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10096}
...
For the {\ttfamily asm.\+js} build, git clone {\ttfamily emsdk} from is assumed to be a sibling folder as well.\hypertarget{md_node__modules_2es-module-lexer_2README_autotoc_md10097}{}\doxysubsection{\texorpdfstring{License}{License}}\label{md_node__modules_2es-module-lexer_2README_autotoc_md10097}
MIT 