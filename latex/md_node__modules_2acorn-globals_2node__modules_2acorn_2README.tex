\chapter{Acorn}
\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README}{}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README}\index{Acorn@{Acorn}}
\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5142}%
\Hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5142}%
 A tiny, fast Java\+Script parser written in Java\+Script.\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5143}{}\doxysection{\texorpdfstring{Community}{Community}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5143}
...
You are welcome to \href{https://github.com/acornjs/acorn/issues}{\texttt{ report bugs}} or create pull requests on \href{https://github.com/acornjs/acorn}{\texttt{ github}}. For questions and discussion, please use the \href{https://discuss.ternjs.net}{\texttt{ Tern discussion forum}}.\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5144}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5144}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5145}{}\doxysection{\texorpdfstring{Interface}{Interface}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5145}
...
{\bfseries{get\+Line\+Info}}{\ttfamily (input, offset)} can be used to get a {\ttfamily \{line, column\}} object for a given program string and offset.\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5146}{}\doxysubsection{\texorpdfstring{The $<$tt$>$\+Parser$<$/tt$>$ class}{The <tt>Parser</tt> class}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5146}
...
The {\ttfamily extend} method takes any number of plugin values, and returns a new {\ttfamily Parser} class that includes the extra parser logic provided by the plugins.\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5147}{}\doxysection{\texorpdfstring{Command line interface}{Command line interface}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5147}
...
The utility spits out the syntax tree as JSON data.\hypertarget{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5148}{}\doxysection{\texorpdfstring{Existing plugins}{Existing plugins}}\label{md_node__modules_2acorn-globals_2node__modules_2acorn_2README_autotoc_md5148}
