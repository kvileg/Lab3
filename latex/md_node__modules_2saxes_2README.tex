\chapter{saxes}
\hypertarget{md_node__modules_2saxes_2README}{}\label{md_node__modules_2saxes_2README}\index{saxes@{saxes}}
\label{md_node__modules_2saxes_2README_autotoc_md25321}%
\Hypertarget{md_node__modules_2saxes_2README_autotoc_md25321}%
...
Saxes does not support Node versions older than 10.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25322}{}\doxysection{\texorpdfstring{Notable Differences from Sax.}{Notable Differences from Sax.}}\label{md_node__modules_2saxes_2README_autotoc_md25322}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2saxes_2README_autotoc_md25323}{}\doxysection{\texorpdfstring{Conformance}{Conformance}}\label{md_node__modules_2saxes_2README_autotoc_md25323}
Saxes supports\+:
...
\end{DoxyItemize}\hypertarget{md_node__modules_2saxes_2README_autotoc_md25324}{}\doxysection{\texorpdfstring{Limitations}{Limitations}}\label{md_node__modules_2saxes_2README_autotoc_md25324}
This is a non-\/validating parser so it only verifies whether the document is well-\/formed. We do aim to raise errors for all malformed constructs encountered. However, this parser does not thorougly parse the contents of DTDs. So most malformedness errors caused by errors {\bfseries{in DTDs}} cannot be reported.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25325}{}\doxysection{\texorpdfstring{Regarding $<$tt$>$$<$!\+DOCTYPE$<$/tt$>$ and $<$tt$>$$<$!\+ENTITY$<$/tt$>$}{Regarding <tt><!DOCTYPE</tt> and <tt><!ENTITY</tt>}}\label{md_node__modules_2saxes_2README_autotoc_md25325}
The parser will handle the basic XML entities in text nodes and attribute values\+: {\ttfamily \&amp; \&lt; \&gt; \&apos; \&quot;}. It\textquotesingle{}s possible to define additional entities in XML by putting them in the DTD. This parser doesn\textquotesingle{}t do anything with that. If you want to listen to the {\ttfamily doctype} event, and then fetch the doctypes, and read the entities and add them to {\ttfamily parser.\+ENTITIES}, then be my guest.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25326}{}\doxysection{\texorpdfstring{Documentation}{Documentation}}\label{md_node__modules_2saxes_2README_autotoc_md25326}
...
If there\textquotesingle{}s a mistake in the documentation, raise an issue. If you just assume, you may assume incorrectly.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25327}{}\doxysection{\texorpdfstring{Summary Usage Information}{Summary Usage Information}}\label{md_node__modules_2saxes_2README_autotoc_md25327}
\hypertarget{md_node__modules_2saxes_2README_autotoc_md25328}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{md_node__modules_2saxes_2README_autotoc_md25328}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2saxes_2README_autotoc_md25329}{}\doxysubsection{\texorpdfstring{Constructor Arguments}{Constructor Arguments}}\label{md_node__modules_2saxes_2README_autotoc_md25329}
Settings supported\+:
...
\end{DoxyItemize}\hypertarget{md_node__modules_2saxes_2README_autotoc_md25330}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_node__modules_2saxes_2README_autotoc_md25330}
...
{\ttfamily close} -\/ Close the stream. Once closed, no more data may be written until it is done processing the buffer, which is signaled by the {\ttfamily end} event.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25331}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_node__modules_2saxes_2README_autotoc_md25331}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2saxes_2README_autotoc_md25333}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_node__modules_2saxes_2README_autotoc_md25333}
...
See the JSDOC comments in the source code for a description of each supported event.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25334}{}\doxysubsection{\texorpdfstring{Parsing XML Fragments}{Parsing XML Fragments}}\label{md_node__modules_2saxes_2README_autotoc_md25334}
...
Of course, {\ttfamily additional\+Namespaces} and {\ttfamily resolve\+Prefix} are used only if {\ttfamily xmlns} is {\ttfamily true}. If you are parsing a fragment that does not use namespaces, there\textquotesingle{}s no point in setting these options.\hypertarget{md_node__modules_2saxes_2README_autotoc_md25335}{}\doxysubsection{\texorpdfstring{Performance Tips}{Performance Tips}}\label{md_node__modules_2saxes_2README_autotoc_md25335}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2saxes_2README_autotoc_md25336}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_node__modules_2saxes_2README_autotoc_md25336}
