\chapter{flat-\/cache}
\hypertarget{md_node__modules_2flat-cache_2README}{}\label{md_node__modules_2flat-cache_2README}\index{flat-\/cache@{flat-\/cache}}
\label{md_node__modules_2flat-cache_2README_autotoc_md13742}%
\Hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13742}%
\begin{quote}
A stupidly simple key/value storage using files to persist the data \end{quote}
\href{https://npmjs.org/package/flat-cache}{\texttt{ }} \href{https://github.com/jaredwray/flat-cache/actions/workflows/tests.yaml}{\texttt{ }} \href{https://codecov.io/github/jaredwray/flat-cache}{\texttt{ }} \href{https://npmjs.com/package/flat-cache}{\texttt{ }}\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13743}{}\doxysection{\texorpdfstring{install}{install}}\label{md_node__modules_2flat-cache_2README_autotoc_md13743}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ flat-\/cache}

\end{DoxyCode}
\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13744}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2flat-cache_2README_autotoc_md13744}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13745}{}\doxysection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{md_node__modules_2flat-cache_2README_autotoc_md13745}
I needed a super simple and dumb {\bfseries{in-\/memory cache}} with optional disk persistance in order to make a script that will beutify files with {\ttfamily esformatter} only execute on the files that were changed since the last run. To make that possible we need to store the {\ttfamily file\+Size} and {\ttfamily modification\+Time} of the files. So a simple {\ttfamily key/value} storage was needed and Bam! this module was born.\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13746}{}\doxysection{\texorpdfstring{Important notes}{Important notes}}\label{md_node__modules_2flat-cache_2README_autotoc_md13746}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13747}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2flat-cache_2README_autotoc_md13747}
MIT\hypertarget{md_node__modules_2flat-cache_2README_autotoc_md13748}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2flat-cache_2README_autotoc_md13748}
