\chapter{Sucrase}
\hypertarget{md_node__modules_2sucrase_2README}{}\label{md_node__modules_2sucrase_2README}\index{Sucrase@{Sucrase}}
\label{md_node__modules_2sucrase_2README_autotoc_md27138}%
\Hypertarget{md_node__modules_2sucrase_2README_autotoc_md27138}%
 \href{https://github.com/alangpierce/sucrase/actions}{\texttt{ }} \href{https://www.npmjs.com/package/sucrase}{\texttt{ }} \href{https://packagephobia.now.sh/result?p=sucrase}{\texttt{ }} \mbox{[}\mbox{]}(LICENSE) \href{https://gitter.im/sucrasejs/Lobby}{\texttt{ }}\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27139}{}\doxysection{\texorpdfstring{$<$a href="{}https\+://sucrase.\+io"{} $>$\+Try it out$<$/a$>$}{<a href="https://sucrase.io" >Try it out</a>}}\label{md_node__modules_2sucrase_2README_autotoc_md27139}
\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27140}{}\doxysection{\texorpdfstring{Quick usage}{Quick usage}}\label{md_node__modules_2sucrase_2README_autotoc_md27140}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27141}{}\doxysection{\texorpdfstring{Project overview}{Project overview}}\label{md_node__modules_2sucrase_2README_autotoc_md27141}
...
Details\+: Measured on July 2022. Tools run in single-\/threaded mode without warm-\/up. See the \href{https://github.com/alangpierce/sucrase/blob/main/benchmark/benchmark.ts}{\texttt{ benchmark code}} for methodology and caveats.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27142}{}\doxysection{\texorpdfstring{Transforms}{Transforms}}\label{md_node__modules_2sucrase_2README_autotoc_md27142}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27144}{}\doxysubsection{\texorpdfstring{JSX Options}{JSX Options}}\label{md_node__modules_2sucrase_2README_autotoc_md27144}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27145}{}\doxysubsection{\texorpdfstring{Legacy Common\+JS interop}{Legacy CommonJS interop}}\label{md_node__modules_2sucrase_2README_autotoc_md27145}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27146}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2sucrase_2README_autotoc_md27146}
\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27147}{}\doxysubsection{\texorpdfstring{Tool integrations}{Tool integrations}}\label{md_node__modules_2sucrase_2README_autotoc_md27147}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27148}{}\doxysubsection{\texorpdfstring{Usage in Node}{Usage in Node}}\label{md_node__modules_2sucrase_2README_autotoc_md27148}
...
Options can be passed to the require hook via a {\ttfamily SUCRASE\+\_\+\+OPTIONS} environment variable holding a JSON string of options.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27149}{}\doxysubsection{\texorpdfstring{Compiling a project to JS}{Compiling a project to JS}}\label{md_node__modules_2sucrase_2README_autotoc_md27149}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27150}{}\doxysubsection{\texorpdfstring{Usage from code}{Usage from code}}\label{md_node__modules_2sucrase_2README_autotoc_md27150}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27151}{}\doxysection{\texorpdfstring{What Sucrase is not}{What Sucrase is not}}\label{md_node__modules_2sucrase_2README_autotoc_md27151}
...
See the Project Vision document for more details on the philosophy behind Sucrase.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27152}{}\doxysection{\texorpdfstring{Motivation}{Motivation}}\label{md_node__modules_2sucrase_2README_autotoc_md27152}
...
Because Sucrase works on a lower level and uses a custom parser for its use case, it is much faster than Babel.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27153}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{md_node__modules_2sucrase_2README_autotoc_md27153}
Contributions are welcome, whether they be bug reports, PRs, docs, tests, or anything else! Please take a look through the \doxylink{uuid_2CONTRIBUTING_8md}{Contributing Guide} to learn how to get started.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27154}{}\doxysection{\texorpdfstring{License and attribution}{License and attribution}}\label{md_node__modules_2sucrase_2README_autotoc_md27154}
Sucrase is MIT-\/licensed. A large part of Sucrase is based on a fork of the \href{https://github.com/babel/babel/tree/main/packages/babel-parser}{\texttt{ Babel parser}}, which is also MIT-\/licensed.\hypertarget{md_node__modules_2sucrase_2README_autotoc_md27155}{}\doxysection{\texorpdfstring{Why the name?}{Why the name?}}\label{md_node__modules_2sucrase_2README_autotoc_md27155}
