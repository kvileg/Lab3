...
Feel free to fork if you see possible improvements!\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23172}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23172}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23173}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23173}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23174}{}\doxysubsection{\texorpdfstring{$<$tt$>$jsesc(value, options)$<$/tt$>$}{<tt>jsesc(value, options)</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23174}
...
The optional {\ttfamily options} argument accepts an object with the following options\+:\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23175}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$quotes$<$/tt$>$}{<tt>quotes</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23175}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23176}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$wrap$<$/tt$>$}{<tt>wrap</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23176}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23177}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$es6$<$/tt$>$}{<tt>es6</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23177}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23178}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$escape\+Everything$<$/tt$>$}{<tt>escapeEverything</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23178}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23179}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$compact$<$/tt$>$}{<tt>compact</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23179}
...
This setting has no effect on the output for strings.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23180}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$indent$<$/tt$>$}{<tt>indent</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23180}
...
This setting has no effect on the output for strings.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23181}{}\doxysubsubsection{\texorpdfstring{$<$tt$>$json$<$/tt$>$}{<tt>json</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23181}
...
{\bfseries{Note\+:}} Using this option on objects or arrays that contain non-\/string values relies on {\ttfamily JSON.\+stringify()}. For legacy environments like IE ≤ 7, use \href{http://bestiejs.github.io/json3/}{\texttt{ a {\ttfamily JSON} polyfill}}.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23182}{}\doxysubsection{\texorpdfstring{$<$tt$>$jsesc.\+version$<$/tt$>$}{<tt>jsesc.version</tt>}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23182}
A string representing the semantic version number.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23183}{}\doxysubsection{\texorpdfstring{Using the $<$tt$>$jsesc$<$/tt$>$ binary}{Using the <tt>jsesc</tt> binary}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23183}
...
See {\ttfamily jsesc -\/-\/help} for the full list of options.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23184}{}\doxysection{\texorpdfstring{Support}{Support}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23184}
...
{\bfseries{Note\+:}} Using the {\ttfamily json} option on objects or arrays that contain non-\/string values relies on {\ttfamily JSON.\+parse()}. For legacy environments like IE ≤ 7, use \href{http://bestiejs.github.io/json3/}{\texttt{ a {\ttfamily JSON} polyfill}}.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23185}{}\doxysection{\texorpdfstring{Unit tests \& code coverage}{Unit tests \& code coverage}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23185}
...
To generate the code coverage report, use {\ttfamily grunt cover}.\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23186}{}\doxysection{\texorpdfstring{Author}{Author}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23186}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23187}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2regjsparser_2node__modules_2jsesc_2README_autotoc_md23187}
