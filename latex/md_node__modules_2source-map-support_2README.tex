...
\hypertarget{md_node__modules_2source-map-support_2README}{}\label{md_node__modules_2source-map-support_2README}\index{Source Map Support@{Source Map Support}}
\label{md_node__modules_2source-map-support_2README_autotoc_md26235}%
\Hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26235}%
\href{https://travis-ci.org/evanw/node-source-map-support}{\texttt{ }}

This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{ V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{ source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26236}{}\doxysection{\texorpdfstring{Installation and Usage}{Installation and Usage}}\label{md_node__modules_2source-map-support_2README_autotoc_md26236}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26237}{}\doxysubsubsection{\texorpdfstring{Node support}{Node support}}\label{md_node__modules_2source-map-support_2README_autotoc_md26237}
...
From here you have two options.\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26238}{}\doxyparagraph{\texorpdfstring{CLI Usage}{CLI Usage}}\label{md_node__modules_2source-map-support_2README_autotoc_md26238}

\begin{DoxyCode}{0}
\DoxyCodeLine{node\ -\/r\ source-\/map-\/support/register\ compiled.js}

\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26239}{}\doxyparagraph{\texorpdfstring{Programmatic Usage}{Programmatic Usage}}\label{md_node__modules_2source-map-support_2README_autotoc_md26239}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26240}{}\doxysubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{md_node__modules_2source-map-support_2README_autotoc_md26240}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26241}{}\doxysection{\texorpdfstring{Options}{Options}}\label{md_node__modules_2source-map-support_2README_autotoc_md26241}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26242}{}\doxysection{\texorpdfstring{Demos}{Demos}}\label{md_node__modules_2source-map-support_2README_autotoc_md26242}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26243}{}\doxysubsubsection{\texorpdfstring{Basic Demo}{Basic Demo}}\label{md_node__modules_2source-map-support_2README_autotoc_md26243}
original.\+js\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26244}{}\doxysubsubsection{\texorpdfstring{Type\+Script Demo}{TypeScript Demo}}\label{md_node__modules_2source-map-support_2README_autotoc_md26244}
demo.\+ts\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26245}{}\doxysubsubsection{\texorpdfstring{Coffee\+Script Demo}{CoffeeScript Demo}}\label{md_node__modules_2source-map-support_2README_autotoc_md26245}
demo.\+coffee\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26246}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_node__modules_2source-map-support_2README_autotoc_md26246}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2source-map-support_2README_autotoc_md26247}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2source-map-support_2README_autotoc_md26247}
