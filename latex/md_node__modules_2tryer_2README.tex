\chapter{tryer}
\hypertarget{md_node__modules_2tryer_2README}{}\label{md_node__modules_2tryer_2README}\index{tryer@{tryer}}
\label{md_node__modules_2tryer_2README_autotoc_md28486}%
\Hypertarget{md_node__modules_2tryer_2README_autotoc_md28486}%
...
\end{DoxyItemize}\hypertarget{md_node__modules_2tryer_2README_autotoc_md28487}{}\doxysection{\texorpdfstring{Say what?}{Say what?}}\label{md_node__modules_2tryer_2README_autotoc_md28487}
...
Additionally, it allows you to easily specify retry intervals and limits, so that your code doesn\textquotesingle{}t hog the CPU. It also supports exponential backoff of retry intervals, which can be useful when handling indefinite error states such as network failure.\hypertarget{md_node__modules_2tryer_2README_autotoc_md28488}{}\doxysection{\texorpdfstring{What size is it?}{What size is it?}}\label{md_node__modules_2tryer_2README_autotoc_md28488}
5.\+6 kb unminified with comments, 1.\+1 kb minified, 0.\+5 kb minified + gzipped.\hypertarget{md_node__modules_2tryer_2README_autotoc_md28489}{}\doxysection{\texorpdfstring{How do I install it?}{How do I install it?}}\label{md_node__modules_2tryer_2README_autotoc_md28489}
Via npm\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2tryer_2README_autotoc_md28490}{}\doxysection{\texorpdfstring{How do I use it?}{How do I use it?}}\label{md_node__modules_2tryer_2README_autotoc_md28490}
\hypertarget{md_node__modules_2tryer_2README_autotoc_md28491}{}\doxysubsection{\texorpdfstring{Loading the library}{Loading the library}}\label{md_node__modules_2tryer_2README_autotoc_md28491}
...
If you are including {\ttfamily tryer} with an HTML {\ttfamily \texorpdfstring{$<$}{<}script\texorpdfstring{$>$}{>}} tag, or neither of the above environments are detected, it will be exported globally as {\ttfamily tryer}.\hypertarget{md_node__modules_2tryer_2README_autotoc_md28492}{}\doxysubsection{\texorpdfstring{Calling the exported function}{Calling the exported function}}\label{md_node__modules_2tryer_2README_autotoc_md28492}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2tryer_2README_autotoc_md28493}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2tryer_2README_autotoc_md28493}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2tryer_2README_autotoc_md28494}{}\doxysection{\texorpdfstring{How do I set up the dev environment?}{How do I set up the dev environment?}}\label{md_node__modules_2tryer_2README_autotoc_md28494}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2tryer_2README_autotoc_md28495}{}\doxysection{\texorpdfstring{What license is it released under?}{What license is it released under?}}\label{md_node__modules_2tryer_2README_autotoc_md28495}
