\chapter{minipass}
\hypertarget{md_node__modules_2minipass_2README}{}\label{md_node__modules_2minipass_2README}\index{minipass@{minipass}}
\label{md_node__modules_2minipass_2README_autotoc_md19364}%
\Hypertarget{md_node__modules_2minipass_2README_autotoc_md19364}%
...
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19365}{}\doxysection{\texorpdfstring{Usage in Type\+Script}{Usage in TypeScript}}\label{md_node__modules_2minipass_2README_autotoc_md19365}
...
Emitting/handling events that aren\textquotesingle{}t declared in this way is fine, but the arguments will be typed as {\ttfamily unknown}.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19366}{}\doxysection{\texorpdfstring{Differences from Node.\+js Streams}{Differences from Node.js Streams}}\label{md_node__modules_2minipass_2README_autotoc_md19366}
...
You can avoid most of these differences entirely (for a very small performance penalty) by setting {\ttfamily \{async\+: true\}} in the constructor options.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19367}{}\doxysubsection{\texorpdfstring{Timing}{Timing}}\label{md_node__modules_2minipass_2README_autotoc_md19367}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19368}{}\doxysubsection{\texorpdfstring{Exception\+: Async Opt-\/\+In}{Exception: Async Opt-In}}\label{md_node__modules_2minipass_2README_autotoc_md19368}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19369}{}\doxysubsection{\texorpdfstring{No High/\+Low Water Marks}{No High/Low Water Marks}}\label{md_node__modules_2minipass_2README_autotoc_md19369}
...
Since nothing is ever buffered unnecessarily, there is much less copying data, and less bookkeeping about buffer capacity levels.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19370}{}\doxysubsection{\texorpdfstring{Hazards of Buffering (or\+: Why Minipass Is So Fast)}{Hazards of Buffering (or: Why Minipass Is So Fast)}}\label{md_node__modules_2minipass_2README_autotoc_md19370}
...
As always, the faster implementation is the one that does less stuff and waits less time to do it.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19371}{}\doxysubsection{\texorpdfstring{Immediately emit $<$tt$>$end$<$/tt$>$ for empty streams (when not paused)}{Immediately emit <tt>end</tt> for empty streams (when not paused)}}\label{md_node__modules_2minipass_2README_autotoc_md19371}
...
However, this is {\itshape usually} not a problem because\+:\hypertarget{md_node__modules_2minipass_2README_autotoc_md19372}{}\doxysubsection{\texorpdfstring{Emit $<$tt$>$end$<$/tt$>$ When Asked}{Emit <tt>end</tt> When Asked}}\label{md_node__modules_2minipass_2README_autotoc_md19372}
...
To prevent calling handlers multiple times who would not expect multiple ends to occur, all listeners are removed from the `\textquotesingle{}end'\`{} event whenever it is emitted.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19373}{}\doxysubsection{\texorpdfstring{Emit $<$tt$>$error$<$/tt$>$ When Asked}{Emit <tt>error</tt> When Asked}}\label{md_node__modules_2minipass_2README_autotoc_md19373}
...
This makes it much more difficult to end up trying to interact with a broken stream, if the error handler is added after an error was previously emitted.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19374}{}\doxysubsection{\texorpdfstring{Impact of "{}immediate flow"{} on Tee-\/streams}{Impact of "immediate flow" on Tee-streams}}\label{md_node__modules_2minipass_2README_autotoc_md19374}
...
All of the hazards in this section are avoided by setting {\ttfamily \{ async\+: true \}} in the Minipass constructor, or by setting {\ttfamily stream.\+async = true} afterwards. Note that this does add some overhead, so should only be done in cases where you are willing to lose a bit of performance in order to avoid having to refactor program logic.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19375}{}\doxysection{\texorpdfstring{USAGE}{USAGE}}\label{md_node__modules_2minipass_2README_autotoc_md19375}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19376}{}\doxysubsection{\texorpdfstring{OPTIONS}{OPTIONS}}\label{md_node__modules_2minipass_2README_autotoc_md19376}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19377}{}\doxysubsection{\texorpdfstring{API}{API}}\label{md_node__modules_2minipass_2README_autotoc_md19377}
Implements the user-\/facing portions of Node.\+js\textquotesingle{}s {\ttfamily Readable} and {\ttfamily Writable} streams.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19378}{}\doxysubsection{\texorpdfstring{Methods}{Methods}}\label{md_node__modules_2minipass_2README_autotoc_md19378}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19379}{}\doxysubsection{\texorpdfstring{Properties}{Properties}}\label{md_node__modules_2minipass_2README_autotoc_md19379}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19380}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_node__modules_2minipass_2README_autotoc_md19380}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19381}{}\doxysubsection{\texorpdfstring{Static Methods}{Static Methods}}\label{md_node__modules_2minipass_2README_autotoc_md19381}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2minipass_2README_autotoc_md19382}{}\doxysection{\texorpdfstring{EXAMPLES}{EXAMPLES}}\label{md_node__modules_2minipass_2README_autotoc_md19382}
Here are some examples of things you can do with Minipass streams.\hypertarget{md_node__modules_2minipass_2README_autotoc_md19383}{}\doxysubsection{\texorpdfstring{simple "{}are you done yet"{} promise}{simple "are you done yet" promise}}\label{md_node__modules_2minipass_2README_autotoc_md19383}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19384}{}\doxysubsection{\texorpdfstring{collecting}{collecting}}\label{md_node__modules_2minipass_2README_autotoc_md19384}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19385}{}\doxysubsection{\texorpdfstring{collecting into a single blob}{collecting into a single blob}}\label{md_node__modules_2minipass_2README_autotoc_md19385}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19386}{}\doxysubsection{\texorpdfstring{iteration}{iteration}}\label{md_node__modules_2minipass_2README_autotoc_md19386}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19387}{}\doxysubsection{\texorpdfstring{subclass that $<$tt$>$console.\+log()$<$/tt$>$s everything written into it}{subclass that <tt>console.log()</tt>s everything written into it}}\label{md_node__modules_2minipass_2README_autotoc_md19387}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19388}{}\doxysubsection{\texorpdfstring{same thing, but using an inline anonymous class}{same thing, but using an inline anonymous class}}\label{md_node__modules_2minipass_2README_autotoc_md19388}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19389}{}\doxysubsection{\texorpdfstring{subclass that defers \textquotesingle{}end\textquotesingle{} for some reason}{subclass that defers 'end' for some reason}}\label{md_node__modules_2minipass_2README_autotoc_md19389}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19390}{}\doxysubsection{\texorpdfstring{transform that creates newline-\/delimited JSON}{transform that creates newline-delimited JSON}}\label{md_node__modules_2minipass_2README_autotoc_md19390}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2minipass_2README_autotoc_md19391}{}\doxysubsection{\texorpdfstring{transform that parses newline-\/delimited JSON}{transform that parses newline-delimited JSON}}\label{md_node__modules_2minipass_2README_autotoc_md19391}
