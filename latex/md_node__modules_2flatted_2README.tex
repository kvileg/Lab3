\chapter{flatted}
\hypertarget{md_node__modules_2flatted_2README}{}\label{md_node__modules_2flatted_2README}\index{flatted@{flatted}}
\label{md_node__modules_2flatted_2README_autotoc_md13749}%
\Hypertarget{md_node__modules_2flatted_2README_autotoc_md13749}%
...
\DoxyHorRuler{0}
\hypertarget{md_node__modules_2flatted_2README_autotoc_md13750}{}\doxysection{\texorpdfstring{Announcement 📣}{Announcement 📣}}\label{md_node__modules_2flatted_2README_autotoc_md13750}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2flatted_2README_autotoc_md13751}{}\doxysection{\texorpdfstring{to\+JSON and from\+JSON}{toJSON and fromJSON}}\label{md_node__modules_2flatted_2README_autotoc_md13751}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2flatted_2README_autotoc_md13752}{}\doxysection{\texorpdfstring{Flatted VS JSON}{Flatted VS JSON}}\label{md_node__modules_2flatted_2README_autotoc_md13752}
As it is for every other specialized format capable of serializing and deserializing circular data, you should never {\ttfamily JSON.\+parse(Flatted.\+stringify(data))}, and you should never {\ttfamily \doxylink{classFlatted_abda2f205b4a05f941504857868aa4435}{Flatted.\+parse}(JSON.\+stringify(data))}.

The only way this could work is to {\ttfamily \doxylink{classFlatted_abda2f205b4a05f941504857868aa4435}{Flatted.\+parse}(Flatted.\+stringify(data))}, as it is also for {\itshape Circular\+JSON} or any other, otherwise there\textquotesingle{}s no granted data integrity.

Also please note this project serializes and deserializes only data compatible with JSON, so that sockets, or anything else with internal classes different from those allowed by JSON standard, won\textquotesingle{}t be serialized and unserialized as expected.\hypertarget{md_node__modules_2flatted_2README_autotoc_md13753}{}\doxysubsection{\texorpdfstring{New in V1\+: Exact same JSON API}{New in V1: Exact same JSON API}}\label{md_node__modules_2flatted_2README_autotoc_md13753}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2flatted_2README_autotoc_md13754}{}\doxysubsection{\texorpdfstring{Compatibility}{Compatibility}}\label{md_node__modules_2flatted_2README_autotoc_md13754}
All ECMAScript engines compatible with {\ttfamily Map}, {\ttfamily Set}, {\ttfamily Object.\+keys}, and {\ttfamily Array.\+prototype.\+reduce} will work, even if polyfilled.\hypertarget{md_node__modules_2flatted_2README_autotoc_md13755}{}\doxysubsection{\texorpdfstring{How does it work ?}{How does it work ?}}\label{md_node__modules_2flatted_2README_autotoc_md13755}
