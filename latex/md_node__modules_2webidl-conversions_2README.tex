...
\hypertarget{md_node__modules_2webidl-conversions_2README}{}\label{md_node__modules_2webidl-conversions_2README}\index{Web IDL Type Conversions on JavaScript Values@{Web IDL Type Conversions on JavaScript Values}}
\label{md_node__modules_2webidl-conversions_2README_autotoc_md29360}%
\Hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29360}%
...
\end{DoxyCode}
\hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29361}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2webidl-conversions_2README_autotoc_md29361}
...
Specific conversions may also accept other options, the details of which can be found below.\hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29362}{}\doxysection{\texorpdfstring{Conversions implemented}{Conversions implemented}}\label{md_node__modules_2webidl-conversions_2README_autotoc_md29362}
...
Derived types, such as nullable types, promise types, sequences, records, etc. are not handled by this library. You may wish to investigate the \href{https://github.com/jsdom/webidl2js}{\texttt{ webidl2js}} project.\hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29363}{}\doxysubsection{\texorpdfstring{A note on the $<$tt$>$long long$<$/tt$>$ types}{A note on the <tt>long long</tt> types}}\label{md_node__modules_2webidl-conversions_2README_autotoc_md29363}
...
On the other hand, {\ttfamily long long} conversion is always accurate, since the input value can never be more precise than the output value.\hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29364}{}\doxysubsection{\texorpdfstring{A note on $<$tt$>$\+Buffer\+Source$<$/tt$>$ types}{A note on <tt>BufferSource</tt> types}}\label{md_node__modules_2webidl-conversions_2README_autotoc_md29364}
All of the {\ttfamily Buffer\+Source} types will throw when the relevant {\ttfamily Array\+Buffer} has been detached. This technically is not part of the \href{https://heycam.github.io/webidl/\#es-buffer-source-types}{\texttt{ specified conversion algorithm}}, but instead part of the \href{https://heycam.github.io/webidl/\#ref-for-dfn-get-buffer-source-reference\%E2\%91\%A0}{\texttt{ getting a reference/getting a copy}} algorithms. We\textquotesingle{}ve consolidated them here for convenience and ease of implementation, but if there is a need to separate them in the future, please open an issue so we can investigate.\hypertarget{md_node__modules_2webidl-conversions_2README_autotoc_md29365}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_node__modules_2webidl-conversions_2README_autotoc_md29365}
