\chapter{cross-\/spawn}
\hypertarget{md_node__modules_2cross-spawn_2README}{}\label{md_node__modules_2cross-spawn_2README}\index{cross-\/spawn@{cross-\/spawn}}
\label{md_node__modules_2cross-spawn_2README_autotoc_md8356}%
\Hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8356}%
...
A cross platform solution to node\textquotesingle{}s spawn and spawn\+Sync.\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8357}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8357}
Node.\+js version 8 and up\+: {\ttfamily \$ npm install cross-\/spawn}

Node.\+js version 7 and under\+: {\ttfamily \$ npm install cross-\/spawn@6}\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8358}{}\doxysection{\texorpdfstring{Why}{Why}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8358}
...
All these issues are handled correctly by {\ttfamily cross-\/spawn}. There are some known modules, such as \href{https://github.com/ForbesLindesay/win-spawn}{\texttt{ win-\/spawn}}, that try to solve this but they are either broken or provide faulty escaping of shell arguments.\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8359}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8359}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8360}{}\doxysection{\texorpdfstring{Caveats}{Caveats}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8360}
\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8361}{}\doxysubsection{\texorpdfstring{Using $<$tt$>$options.\+shell$<$/tt$>$ as an alternative to $<$tt$>$cross-\/spawn$<$/tt$>$}{Using <tt>options.shell</tt> as an alternative to <tt>cross-spawn</tt>}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8361}
...
If you are using the {\ttfamily shell} option to spawn a command in a cross platform way, consider using {\ttfamily cross-\/spawn} instead. You have been warned.\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8362}{}\doxysubsection{\texorpdfstring{$<$tt$>$options.\+shell$<$/tt$>$ support}{<tt>options.shell</tt> support}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8362}
...
This mimics the Node.\+js behavior. More specifically, the command and its arguments will not be automatically escaped nor shebang support will be offered. This is by design because if you are using {\ttfamily options.\+shell} you are probably targeting a specific platform anyway and you don\textquotesingle{}t want things to get into your way.\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8363}{}\doxysubsection{\texorpdfstring{Shebangs support}{Shebangs support}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8363}
...
Remember to always test your code on Windows!\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8364}{}\doxysection{\texorpdfstring{Tests}{Tests}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8364}
{\ttfamily \$ npm test} ~\newline
 {\ttfamily \$ npm test -\/-\/ -\/-\/watch} during development\hypertarget{md_node__modules_2cross-spawn_2README_autotoc_md8365}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2cross-spawn_2README_autotoc_md8365}
