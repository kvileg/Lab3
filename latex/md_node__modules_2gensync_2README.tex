\chapter{gensync}
\hypertarget{md_node__modules_2gensync_2README}{}\label{md_node__modules_2gensync_2README}\index{gensync@{gensync}}
\label{md_node__modules_2gensync_2README_autotoc_md14395}%
\Hypertarget{md_node__modules_2gensync_2README_autotoc_md14395}%
...
Take for example {\ttfamily fs.\+read\+File} and {\ttfamily fs.\+read\+File\+Sync}, if you\textquotesingle{}re writing an API that loads a file and then performs a synchronous operation on the data, it can be frustrating to maintain two parallel functions.\hypertarget{md_node__modules_2gensync_2README_autotoc_md14396}{}\doxysection{\texorpdfstring{Example}{Example}}\label{md_node__modules_2gensync_2README_autotoc_md14396}
