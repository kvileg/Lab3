...
\hypertarget{md_node__modules_2chokidar_2README}{}\label{md_node__modules_2chokidar_2README}\index{Chokidar $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dw/chokidar.svg"{} alt="{}Weekly downloads"{}/$>$$<$/a$>$ $<$a href="{}https://github.com/paulmillr/chokidar"{} $>$$<$img src="{}https://img.shields.io/npm/dy/chokidar.svg"{} alt="{}Yearly downloads"{}/$>$$<$/a$>$@{Chokidar $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dw/chokidar.svg"" alt=""Weekly downloads""/$>$$<$/a$>$ $<$a href=""https://github.com/paulmillr/chokidar"" $>$$<$img src=""https://img.shields.io/npm/dy/chokidar.svg"" alt=""Yearly downloads""/$>$$<$/a$>$}}
\label{md_node__modules_2chokidar_2README_autotoc_md7170}%
\Hypertarget{md_node__modules_2chokidar_2README_autotoc_md7170}%
 \begin{quote}
Minimal and efficient cross-\/platform file watching library \end{quote}
\href{https://www.npmjs.com/package/chokidar}{\texttt{ }}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7171}{}\doxysection{\texorpdfstring{Why?}{Why?}}\label{md_node__modules_2chokidar_2README_autotoc_md7171}
...
Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7172}{}\doxysection{\texorpdfstring{How?}{How?}}\label{md_node__modules_2chokidar_2README_autotoc_md7172}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7174}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2chokidar_2README_autotoc_md7174}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7175}{}\doxysubsubsection{\texorpdfstring{Persistence}{Persistence}}\label{md_node__modules_2chokidar_2README_autotoc_md7175}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7176}{}\doxysubsubsection{\texorpdfstring{Path filtering}{Path filtering}}\label{md_node__modules_2chokidar_2README_autotoc_md7176}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7177}{}\doxysubsubsection{\texorpdfstring{Performance}{Performance}}\label{md_node__modules_2chokidar_2README_autotoc_md7177}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7178}{}\doxysubsubsection{\texorpdfstring{Errors}{Errors}}\label{md_node__modules_2chokidar_2README_autotoc_md7178}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7179}{}\doxysubsection{\texorpdfstring{Methods \& Events}{Methods \& Events}}\label{md_node__modules_2chokidar_2README_autotoc_md7179}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7180}{}\doxysection{\texorpdfstring{CLI}{CLI}}\label{md_node__modules_2chokidar_2README_autotoc_md7180}
If you need a CLI interface for your file watching, check out \href{https://github.com/open-cli-tools/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7181}{}\doxysection{\texorpdfstring{Install Troubleshooting}{Install Troubleshooting}}\label{md_node__modules_2chokidar_2README_autotoc_md7181}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7182}{}\doxysection{\texorpdfstring{Changelog}{Changelog}}\label{md_node__modules_2chokidar_2README_autotoc_md7182}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7183}{}\doxysection{\texorpdfstring{Also}{Also}}\label{md_node__modules_2chokidar_2README_autotoc_md7183}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

\texorpdfstring{$>$}{>}Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four). This word is also used in other languages like Urdu as (چوکیدار) which is widely used in Pakistan and India.\hypertarget{md_node__modules_2chokidar_2README_autotoc_md7184}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2chokidar_2README_autotoc_md7184}
