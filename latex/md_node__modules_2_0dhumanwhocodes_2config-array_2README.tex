...
\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README}{}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README}\index{Config Array@{Config Array}}
\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1094}%
\Hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1094}%
 by \href{https://humanwhocodes.com}{\texttt{ Nicholas C. Zakas}}

If you find this useful, please consider supporting my work with a \href{https://humanwhocodes.com/donate}{\texttt{ donation}}.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1095}{}\doxysection{\texorpdfstring{Description}{Description}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1095}
A config array is a way of managing configurations that are based on glob pattern matching of filenames. Each config array contains the information needed to determine the correct configuration for any file based on the filename.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1096}{}\doxysection{\texorpdfstring{Background}{Background}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1096}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1098}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1098}
...
This example reads in an object or array from {\ttfamily my.\+config.\+js} and passes it into the {\ttfamily Config\+Array} constructor as the first argument. The second argument is an object specifying the {\ttfamily base\+Path} (the directory in which {\ttfamily my.\+config.\+js} is found) and a {\ttfamily schema} to define the additional properties of a config object beyond {\ttfamily files}, {\ttfamily ignores}, and {\ttfamily name}.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1099}{}\doxysubsection{\texorpdfstring{Specifying a Schema}{Specifying a Schema}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1099}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1100}{}\doxysubsection{\texorpdfstring{Config Arrays}{Config Arrays}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1100}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1101}{}\doxysubsection{\texorpdfstring{Config Functions}{Config Functions}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1101}
...
{\bfseries{Note\+:}} Config functions can also be async.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1102}{}\doxysubsection{\texorpdfstring{Normalizing Config Arrays}{Normalizing Config Arrays}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1102}
...
{\bfseries{Important\+:}} Once a {\ttfamily Config\+Array} is normalized, it cannot be changed further. You can, however, create a new {\ttfamily Config\+Array} and pass in the normalized instance to create an unnormalized copy.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1103}{}\doxysubsection{\texorpdfstring{Getting Config for a File}{Getting Config for a File}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1103}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1104}{}\doxysection{\texorpdfstring{Determining Ignored Paths}{Determining Ignored Paths}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1104}
...
{\bfseries{Important\+:}} A pattern such as {\ttfamily foo/\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}} means that {\ttfamily foo} and {\ttfamily foo/} are {\itshape not} ignored whereas {\ttfamily foo/bar} is ignored. If you want to ignore {\ttfamily foo} and all of its subdirectories, use the pattern {\ttfamily foo} or {\ttfamily foo/} in {\ttfamily ignores}.\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1105}{}\doxysection{\texorpdfstring{Caching Mechanisms}{Caching Mechanisms}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1105}
...
\end{DoxyEnumerate}\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1106}{}\doxysection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1106}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1107}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2_0dhumanwhocodes_2config-array_2README_autotoc_md1107}
Apache 2.\+0 