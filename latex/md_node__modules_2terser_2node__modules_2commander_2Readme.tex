...
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme}{}\label{md_node__modules_2terser_2node__modules_2commander_2Readme}\index{Commander.js@{Commander.js}}
\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28180}%
\Hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28180}%
...
The complete solution for \href{http://nodejs.org}{\texttt{ node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{ commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{ API documentation}}\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28181}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28181}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
 \hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28182}{}\doxysection{\texorpdfstring{Option parsing}{Option parsing}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28182}
...
{\bfseries{NOTE}}\+: If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28183}{}\doxysection{\texorpdfstring{Version option}{Version option}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28183}
...
The version flags can be named anything, but the long option is required.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28184}{}\doxysection{\texorpdfstring{Command-\/specific options}{Command-specific options}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28184}
...
A command\textquotesingle{}s options are validated when the command is used. Any unknown options will be reported as an error. However, if an action-\/based command does not define an action, then the options are not validated.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28185}{}\doxysection{\texorpdfstring{Coercion}{Coercion}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28185}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28186}{}\doxysection{\texorpdfstring{Regular Expression}{Regular Expression}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28186}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28187}{}\doxysection{\texorpdfstring{Variadic arguments}{Variadic arguments}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28187}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}cmd\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \mbox{[}env\mbox{]}}) indicate optional input.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28189}{}\doxysection{\texorpdfstring{Git-\/style sub-\/commands}{Git-style sub-commands}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28189}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28190}{}\doxysubsection{\texorpdfstring{$<$tt$>$-\/-\/harmony$<$/tt$>$}{<tt>--harmony</tt>}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28190}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28191}{}\doxysection{\texorpdfstring{Automated –help}{Automated –help}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28191}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28192}{}\doxysection{\texorpdfstring{Custom help}{Custom help}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28192}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28193}{}\doxysection{\texorpdfstring{.\+output\+Help(cb)}{.outputHelp(cb)}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28193}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28194}{}\doxysection{\texorpdfstring{.\+help(cb)}{.help(cb)}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28194}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28195}{}\doxysection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28195}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28196}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28196}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28197}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2terser_2node__modules_2commander_2Readme_autotoc_md28197}
