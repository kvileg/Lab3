...
\hypertarget{md_node__modules_2_0dungap_2structured-clone_2README}{}\label{md_node__modules_2_0dungap_2structured-clone_2README}\index{structuredClone polyfill@{structuredClone polyfill}}
\label{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4899}%
\Hypertarget{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4899}%
...
Serialized values can be safely stringified as {\itshape JSON} too, and deserialization resurrect all values, even recursive, or more complex than what {\itshape JSON} allows.\hypertarget{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4900}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4900}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4901}{}\doxysubsubsection{\texorpdfstring{Global Polyfill}{Global Polyfill}}\label{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4901}
...
The behavior is the same found in {\itshape JSON} when it comes to {\itshape Array}, so that unsupported values will result as {\ttfamily null} placeholders instead.\hypertarget{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4903}{}\doxysubsubsection{\texorpdfstring{to\+JSON}{toJSON}}\label{md_node__modules_2_0dungap_2structured-clone_2README_autotoc_md4903}
