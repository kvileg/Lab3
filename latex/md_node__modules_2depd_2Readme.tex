\chapter{depd}
\hypertarget{md_node__modules_2depd_2Readme}{}\label{md_node__modules_2depd_2Readme}\index{depd@{depd}}
\label{md_node__modules_2depd_2Readme_autotoc_md9408}%
\Hypertarget{md_node__modules_2depd_2Readme_autotoc_md9408}%
...
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9409}{}\doxysection{\texorpdfstring{Install}{Install}}\label{md_node__modules_2depd_2Readme_autotoc_md9409}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9410}{}\doxysection{\texorpdfstring{API}{API}}\label{md_node__modules_2depd_2Readme_autotoc_md9410}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9413}{}\doxysubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.function(fn, message)}}\label{md_node__modules_2depd_2Readme_autotoc_md9413}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9414}{}\doxysubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.property(obj, prop, message)}}\label{md_node__modules_2depd_2Readme_autotoc_md9414}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9416}{}\doxysubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.env.NO\_DEPRECATION}}\label{md_node__modules_2depd_2Readme_autotoc_md9416}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9417}{}\doxysubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.env.TRACE\_DEPRECATION}}\label{md_node__modules_2depd_2Readme_autotoc_md9417}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9418}{}\doxysection{\texorpdfstring{Display}{Display}}\label{md_node__modules_2depd_2Readme_autotoc_md9418}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9419}{}\doxysection{\texorpdfstring{Examples}{Examples}}\label{md_node__modules_2depd_2Readme_autotoc_md9419}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9420}{}\doxysubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{md_node__modules_2depd_2Readme_autotoc_md9420}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9421}{}\doxysubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{md_node__modules_2depd_2Readme_autotoc_md9421}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9422}{}\doxysubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{md_node__modules_2depd_2Readme_autotoc_md9422}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2depd_2Readme_autotoc_md9423}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2depd_2Readme_autotoc_md9423}
