\chapter{url-\/parse}
\hypertarget{md_node__modules_2url-parse_2README}{}\label{md_node__modules_2url-parse_2README}\index{url-\/parse@{url-\/parse}}
\label{md_node__modules_2url-parse_2README_autotoc_md29051}%
\Hypertarget{md_node__modules_2url-parse_2README_autotoc_md29051}%
...
In addition to URL parsing we also expose the bundled {\ttfamily querystringify} module.\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29052}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{md_node__modules_2url-parse_2README_autotoc_md29052}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29053}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{md_node__modules_2url-parse_2README_autotoc_md29053}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29054}{}\doxysubsection{\texorpdfstring{Url.\+set(key, value)}{Url.set(key, value)}}\label{md_node__modules_2url-parse_2README_autotoc_md29054}
...
It\textquotesingle{}s aware of default ports so you cannot set a port 80 on an URL which has {\ttfamily http} as protocol.\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29055}{}\doxysubsection{\texorpdfstring{Url.\+to\+String()}{Url.toString()}}\label{md_node__modules_2url-parse_2README_autotoc_md29055}
...
You would rarely need to use this method as the full URL is also available as {\ttfamily href} property. If you are using the {\ttfamily URL.\+set} method to make changes, this will automatically update.\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29056}{}\doxysection{\texorpdfstring{Testing}{Testing}}\label{md_node__modules_2url-parse_2README_autotoc_md29056}
...
\end{DoxyEnumerate}\hypertarget{md_node__modules_2url-parse_2README_autotoc_md29057}{}\doxysection{\texorpdfstring{License}{License}}\label{md_node__modules_2url-parse_2README_autotoc_md29057}
